...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08907470;
	constexpr int32 AppendString      = 0x00CA9680;
	constexpr int32 GNames            = 0x08861080;
	constexpr int32 GWorld            = 0x08A74418;
	constexpr int32 ProcessEvent      = 0x00E64870;

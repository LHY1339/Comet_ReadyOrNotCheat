...
static_assert(sizeof(UW_Hotkeys_C) == 0x000340, "Wrong size on UW_Hotkeys_C");
static_assert(offsetof(UW_Hotkeys_C, UberGraphFrame) == 0x000338, "Member 'UW_Hotkeys_C::UberGraphFrame' has a wrong offset!");

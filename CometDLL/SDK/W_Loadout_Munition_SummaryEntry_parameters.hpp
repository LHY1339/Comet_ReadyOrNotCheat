...
public:
	...
	class UW_LoadoutSlot_C*                       K2Node_Event_CurrentSlot;                          // 0x0008(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FSavedLoadout                          K2Node_Event_ActiveLoadout;                        // 0x0088(0x02E8)()
	class UW_Loadout_C*                           K2Node_Event_LoadoutWidget;                        // 0x0370(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 K2Node_CustomEvent_Weapon;                         // 0x0378(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FName                                   K2Node_CustomEvent_AmmoType;                       // 0x0380(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_CustomEvent_Count_1;                        // 0x0388(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UTexture2D*                             CallFunc_GetItemIcon_ReturnValue;                  // 0x0398(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x03A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3A1[0x7];                                      // 0x03A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UClass*                                 K2Node_CustomEvent_ItemData;                       // 0x03A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_CustomEvent_Count;                          // 0x03B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry) == 0x000440, "Wrong size on W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry");
...
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Event_Delay) == 0x000070, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Event_Delay' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Event_Collapse) == 0x000078, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Event_Collapse' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Event_IsGamepad) == 0x000079, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Event_IsGamepad' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Event_PageName) == 0x00007C, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Event_PageName' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Event_IsDesignTime) == 0x000084, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Event_ActiveLoadout) == 0x000088, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Event_ActiveLoadout' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Event_LoadoutWidget) == 0x000370, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Event_LoadoutWidget' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_CustomEvent_Weapon) == 0x000378, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_CustomEvent_Weapon' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_CustomEvent_AmmoType) == 0x000380, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_CustomEvent_AmmoType' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_CustomEvent_Count_1) == 0x000388, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_CustomEvent_Count_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, Temp_int_Variable) == 0x00038C, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, CallFunc_Add_IntInt_ReturnValue) == 0x000390, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000394, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, CallFunc_GetItemIcon_ReturnValue) == 0x000398, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::CallFunc_GetItemIcon_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, Temp_bool_Variable) == 0x0003A0, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_CustomEvent_ItemData) == 0x0003A8, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_CustomEvent_ItemData' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_CustomEvent_Count) == 0x0003B0, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_CustomEvent_Count' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, CallFunc_Conv_IntToInt64_ReturnValue) == 0x0003B8, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_MakeStruct_FormatArgumentData) == 0x0003C0, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_MakeArray_Array) == 0x000410, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, CallFunc_Format_ReturnValue) == 0x000420, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry, K2Node_Select_Default) == 0x000438, "Member 'W_Loadout_Munition_SummaryEntry_C_ExecuteUbergraph_W_Loadout_Munition_SummaryEntry::K2Node_Select_Default' has a wrong offset!");
...
public:
	...
	struct FAmmoTypeData                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0008(0x0170)()
...
static_assert(sizeof(W_Loadout_Munition_SummaryEntry_C_GetAmmoInfo) == 0x000180, "Wrong size on W_Loadout_Munition_SummaryEntry_C_GetAmmoInfo");
...
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_GetAmmoInfo, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000178, "Member 'W_Loadout_Munition_SummaryEntry_C_GetAmmoInfo::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FAmmoTypeData                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0020(0x0170)()
...
static_assert(sizeof(W_Loadout_Munition_SummaryEntry_C_GetAmmoName) == 0x000198, "Wrong size on W_Loadout_Munition_SummaryEntry_C_GetAmmoName");
...
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_GetAmmoName, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000190, "Member 'W_Loadout_Munition_SummaryEntry_C_GetAmmoName::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_Munition_SummaryEntry_C_SetLoadoutWidget, LoadoutWidget_0) == 0x000000, "Member 'W_Loadout_Munition_SummaryEntry_C_SetLoadoutWidget::LoadoutWidget_0' has a wrong offset!");

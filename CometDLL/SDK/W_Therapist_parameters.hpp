...
public:
	...
	class UCanvasPanelSlot*                       CallFunc_AddChildToCanvas_ReturnValue;             // 0x0178(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UStandardModal* CallingModal)> K2Node_CreateDelegate_OutputDelegate_1;      // 0x01A8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_Therapist_C_ExecuteUbergraph_W_Therapist) == 0x0001B8, "Wrong size on W_Therapist_C_ExecuteUbergraph_W_Therapist");
...
static_assert(offsetof(W_Therapist_C_ExecuteUbergraph_W_Therapist, K2Node_MakeStruct_FormatArgumentData) == 0x0000D8, "Member 'W_Therapist_C_ExecuteUbergraph_W_Therapist::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_ExecuteUbergraph_W_Therapist, K2Node_MakeStruct_FormatArgumentData_1) == 0x000128, "Member 'W_Therapist_C_ExecuteUbergraph_W_Therapist::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_ExecuteUbergraph_W_Therapist, CallFunc_AddChildToCanvas_ReturnValue) == 0x000178, "Member 'W_Therapist_C_ExecuteUbergraph_W_Therapist::CallFunc_AddChildToCanvas_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_ExecuteUbergraph_W_Therapist, K2Node_MakeArray_Array) == 0x000180, "Member 'W_Therapist_C_ExecuteUbergraph_W_Therapist::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_ExecuteUbergraph_W_Therapist, CallFunc_Format_ReturnValue) == 0x000190, "Member 'W_Therapist_C_ExecuteUbergraph_W_Therapist::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_ExecuteUbergraph_W_Therapist, K2Node_CreateDelegate_OutputDelegate_1) == 0x0001A8, "Member 'W_Therapist_C_ExecuteUbergraph_W_Therapist::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
...
public:
	...
	TArray<class URosterCharacter*>               CallFunc_GetCharactersInTherapy_ReturnValue;       // 0x00C0(0x0010)(ReferenceParm)
	...
	class URosterCharacter*                       CallFunc_Array_Get_Item;                           // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_Therapist_C_UpdateTherapyScreen) == 0x0000E8, "Wrong size on W_Therapist_C_UpdateTherapyScreen");
...
static_assert(offsetof(W_Therapist_C_UpdateTherapyScreen, K2Node_MakeArray_Array) == 0x000098, "Member 'W_Therapist_C_UpdateTherapyScreen::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_UpdateTherapyScreen, CallFunc_Format_ReturnValue) == 0x0000A8, "Member 'W_Therapist_C_UpdateTherapyScreen::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_UpdateTherapyScreen, CallFunc_GetCharactersInTherapy_ReturnValue) == 0x0000C0, "Member 'W_Therapist_C_UpdateTherapyScreen::CallFunc_GetCharactersInTherapy_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_UpdateTherapyScreen, CallFunc_IsValid_ReturnValue) == 0x0000D0, "Member 'W_Therapist_C_UpdateTherapyScreen::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_UpdateTherapyScreen, CallFunc_Array_Get_Item) == 0x0000D8, "Member 'W_Therapist_C_UpdateTherapyScreen::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_Therapist_C_UpdateTherapyScreen, CallFunc_Array_IsValidIndex_ReturnValue) == 0x0000E0, "Member 'W_Therapist_C_UpdateTherapyScreen::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");

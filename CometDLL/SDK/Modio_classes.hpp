...
static_assert(sizeof(UModioPopupBase) == 0x0002C0, "Wrong size on UModioPopupBase");
...
{
public:
	TArray<class UModioPopupBase*>                PopupStack;                                        // 0x02C0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UModioPopupBase*>                PopupCache;                                        // 0x02D0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UModioPopupContainer) == 0x0002E0, "Wrong size on UModioPopupContainer");
static_assert(offsetof(UModioPopupContainer, PopupStack) == 0x0002C0, "Member 'UModioPopupContainer::PopupStack' has a wrong offset!");
static_assert(offsetof(UModioPopupContainer, PopupCache) == 0x0002D0, "Member 'UModioPopupContainer::PopupCache' has a wrong offset!");
...
static_assert(sizeof(UModioSubsystem) == 0x0003C0, "Wrong size on UModioSubsystem");
static_assert(offsetof(UModioSubsystem, UserSubscriptionsDefaultValue) == 0x000280, "Member 'UModioSubsystem::UserSubscriptionsDefaultValue' has a wrong offset!");
static_assert(offsetof(UModioSubsystem, QueryUserInstallationsDefaultValue) == 0x0002D0, "Member 'UModioSubsystem::QueryUserInstallationsDefaultValue' has a wrong offset!");

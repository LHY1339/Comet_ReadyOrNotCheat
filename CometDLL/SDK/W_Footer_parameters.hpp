...
static_assert(sizeof(W_Footer_C_ExecuteUbergraph_W_Footer) == 0x000050, "Wrong size on W_Footer_C_ExecuteUbergraph_W_Footer");
...
static_assert(offsetof(W_Footer_C_ExecuteUbergraph_W_Footer, CallFunc_MakeVector2D_ReturnValue) == 0x000038, "Member 'W_Footer_C_ExecuteUbergraph_W_Footer::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Footer_C_ExecuteUbergraph_W_Footer, CallFunc_MakeVector2D_X_ImplicitCast) == 0x000048, "Member 'W_Footer_C_ExecuteUbergraph_W_Footer::CallFunc_MakeVector2D_X_ImplicitCast' has a wrong offset!");

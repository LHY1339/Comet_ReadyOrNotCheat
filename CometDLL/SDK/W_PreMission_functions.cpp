...
void UW_PreMission_C::BndEvt__PlanningMap_K2Node_ComponentBoundEvent_17_OnZoomUpdated__DelegateSignature(double ZoomValue)
{
	static class UFunction* Func = nullptr;
...
bool UW_PreMission_C::EnteringQuartermasterMenu() const
{
	static class UFunction* Func = nullptr;

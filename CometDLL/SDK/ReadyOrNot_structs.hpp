...
enum class EAchievement : uint8
{
	...
	PINE_PAINBRINGER                         = 19,
	WALNUT_WARRIOR                           = 20,
	MAHOGANY_MASOCHIST                       = 21,
	ARREST_WARRANT                           = 22,
	POWERS_OF_ARREST                         = 23,
	REST_FOR_THE_WICKED                      = 24,
	SILLY_STRING                             = 25,
	HERES_JOHNNY                             = 26,
	PEEPING_TOM                              = 27,
	SAY_HELLO                                = 28,
	...
	CUT_TO_PIECES                            = 37,
	BEAT_COP                                 = 38,
	HIDDEN_AND_DANGEROUS                     = 39,
	MELDONIN                                 = 40,
	AFTER_THE_STORM                          = 41,
	FROM_HOUSE_TO_HOME                       = 42,
	THE_DOG_HEADS                            = 43,
	THE_MEEK_AND_THE_EARTH                   = 44,
	THE_MARGAY                               = 45,
	FROM_LAND_TO_SEA                         = 46,
	PARTY_CRASHER                            = 47,
	BIG_SHELL_SPECIALIST                     = 48,
	SLEEPER_AGENT                            = 49,
	SMILE_YOUR_ON_CAMERA                     = 50,
	JUSTICE_UNCOVERS_DEPTHS_GHOSTS_IN_ELYSIUM = 51,
	GETTING_YOUR_SEA_LEGS                    = 52,
	PRACTICE_MAKES_PERFECT                   = 53,
	EAchievement_MAX                         = 54,
};
...
enum class EStandaloneEvent : uint8
{
	...
	E_LockPlayerGamepadCommandWheel          = 9,
	E_UnlockPlayerGamepadCommandWheel        = 10,
	E_HidePlayerCommandMenu                  = 11,
	E_UnhidePlayerCommandMenu                = 12,
	E_LockPlayerItemMenu                     = 13,
	E_UnlockPlayerItemMenu                   = 14,
	E_LockWeaponAttachments                  = 15,
	E_UnlockWeaponAttachments                = 16,
	E_LockCantedSights                       = 17,
	E_UnlockCantedSights                     = 18,
	E_SetPlayerLowReady                      = 19,
	E_SetPlayerNotLowReady                   = 20,
	E_SpawnPolice                            = 21,
	E_SpawnPoliceAtPlayer                    = 22,
	E_RefreshPoliceLoadouts                  = 23,
	E_HidePlayerWeapon                       = 24,
	E_EquipTrainingLoadout                   = 25,
	E_RemoveAmmoFromLoadout                  = 26,
	E_AddAmmoToLoadout                       = 27,
	E_AddGrenadesToLoadout                   = 28,
	E_AddChemlightsToLoadout                 = 29,
	E_AddEmptyMagPrimary                     = 30,
	E_LockTablet                             = 31,
	E_UnlockTablet                           = 32,
	E_HideConsoleHotkeys                     = 33,
	E_ShowConsoleHotkeys                     = 34,
	E_HideConsoleHotkeysItemWheel            = 35,
	E_ShowConsoleHotkeysItemWheel            = 36,
	E_LockOptiwand                           = 37,
	E_UnlockOptiwand                         = 38,
	E_LockChemlight                          = 39,
	E_UnlockChemlight                        = 40,
	E_LockGamepadTeamCamera                  = 41,
	E_UnlockGamepadTeamCamera                = 42,
	E_MAX                                    = 43,
};
...
// NumValues: 0x0004
enum class ERadialTrackingState : uint8
{
	Idle                                     = 0,
	Waiting                                  = 1,
	MovingToTarget                           = 2,
...
// NumValues: 0x0003
enum class ETrackingSpotlightMode : uint8
{
	AlwaysEnabled                            = 0,
...
static_assert(sizeof(FPersonnelMapPoint) == 0x000088, "Wrong size on FPersonnelMapPoint");
...
static_assert(offsetof(FPersonnelMapPoint, MapShiftPosition) == 0x000048, "Member 'FPersonnelMapPoint::MapShiftPosition' has a wrong offset!");
static_assert(offsetof(FPersonnelMapPoint, MapShiftZoom) == 0x000058, "Member 'FPersonnelMapPoint::MapShiftZoom' has a wrong offset!");
static_assert(offsetof(FPersonnelMapPoint, MapCoordinates) == 0x000060, "Member 'FPersonnelMapPoint::MapCoordinates' has a wrong offset!");
static_assert(offsetof(FPersonnelMapPoint, bMapZone) == 0x000070, "Member 'FPersonnelMapPoint::bMapZone' has a wrong offset!");
static_assert(offsetof(FPersonnelMapPoint, MapZoneSize) == 0x000078, "Member 'FPersonnelMapPoint::MapZoneSize' has a wrong offset!");
...
static_assert(sizeof(FExitRoute) == 0x000040, "Wrong size on FExitRoute");
...
static_assert(offsetof(FExitRoute, Location) == 0x000028, "Member 'FExitRoute::Location' has a wrong offset!");
...
static_assert(alignof(FTableTennisGame) == 0x000008, "Wrong alignment on FTableTennisGame");
static_assert(sizeof(FTableTennisGame) == 0x000048, "Wrong size on FTableTennisGame");
...
static_assert(offsetof(FTableTennisGame, BallVelocity) == 0x000020, "Member 'FTableTennisGame::BallVelocity' has a wrong offset!");
static_assert(offsetof(FTableTennisGame, LeftScore) == 0x000030, "Member 'FTableTennisGame::LeftScore' has a wrong offset!");
static_assert(offsetof(FTableTennisGame, RightScore) == 0x000034, "Member 'FTableTennisGame::RightScore' has a wrong offset!");
...
static_assert(sizeof(FClearPoint) == 0x000050, "Wrong size on FClearPoint");
static_assert(offsetof(FClearPoint, Location_Relative) == 0x000000, "Member 'FClearPoint::Location_Relative' has a wrong offset!");
static_assert(offsetof(FClearPoint, Location) == 0x000018, "Member 'FClearPoint::Location' has a wrong offset!");
static_assert(offsetof(FClearPoint, Stage) == 0x000030, "Member 'FClearPoint::Stage' has a wrong offset!");
static_assert(offsetof(FClearPoint, Direction) == 0x000031, "Member 'FClearPoint::Direction' has a wrong offset!");
static_assert(offsetof(FClearPoint, CoverLandmarks) == 0x000038, "Member 'FClearPoint::CoverLandmarks' has a wrong offset!");
static_assert(offsetof(FClearPoint, bHasLineOfSightToDoor) == 0x000048, "Member 'FClearPoint::bHasLineOfSightToDoor' has a wrong offset!");
...
static_assert(sizeof(FExitData) == 0x000028, "Wrong size on FExitData");
...
static_assert(alignof(FCompliantActionAnimationArray) == 0x000008, "Wrong alignment on FCompliantActionAnimationArray");
static_assert(sizeof(FCompliantActionAnimationArray) == 0x000010, "Wrong size on FCompliantActionAnimationArray");
static_assert(offsetof(FCompliantActionAnimationArray, Animations) == 0x000000, "Member 'FCompliantActionAnimationArray::Animations' has a wrong offset!");
...
public:
	...
	float                                         HeadDamageMultiplier;                              // 0x0140(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         UpperBodyDamageMultiplier;                         // 0x0144(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LowerBodyDamageMultiplier;                         // 0x0148(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ArmDamageMultiplier;                               // 0x014C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HandDamageMultiplier;                              // 0x0150(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LegDamageMultiplier;                               // 0x0154(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FootDamageMultiplier;                              // 0x0158(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultRagdollImpulseStrength;                     // 0x015C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HeadRagdollImpulseStrength;                        // 0x0160(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ArmRagdollImpulseStrength;                         // 0x0164(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LegRagdollImpulseStrength;                         // 0x0168(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TorsoRagdollImpulseStrength;                       // 0x016C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAmmoTypeData) == 0x000008, "Wrong alignment on FAmmoTypeData");
static_assert(sizeof(FAmmoTypeData) == 0x000170, "Wrong size on FAmmoTypeData");
...
static_assert(offsetof(FAmmoTypeData, SpreadPattern) == 0x0000E8, "Member 'FAmmoTypeData::SpreadPattern' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, DurabilityDamage) == 0x0000FC, "Member 'FAmmoTypeData::DurabilityDamage' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, PenetrationLevel) == 0x000100, "Member 'FAmmoTypeData::PenetrationLevel' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, PenetrationDistance) == 0x000104, "Member 'FAmmoTypeData::PenetrationDistance' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, RicochetChance) == 0x000108, "Member 'FAmmoTypeData::RicochetChance' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, SpallingDamage) == 0x00010C, "Member 'FAmmoTypeData::SpallingDamage' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, SpallingRadius) == 0x000110, "Member 'FAmmoTypeData::SpallingRadius' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, DismembermentDamage) == 0x000114, "Member 'FAmmoTypeData::DismembermentDamage' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, ArteryHitChance) == 0x000118, "Member 'FAmmoTypeData::ArteryHitChance' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, HitsChance) == 0x00011C, "Member 'FAmmoTypeData::HitsChance' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, ArmouredHitsChance) == 0x000120, "Member 'FAmmoTypeData::ArmouredHitsChance' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, WoundSize) == 0x000124, "Member 'FAmmoTypeData::WoundSize' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, LoadoutIcon) == 0x000130, "Member 'FAmmoTypeData::LoadoutIcon' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, SmallIcon) == 0x000138, "Member 'FAmmoTypeData::SmallIcon' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, HeadDamageMultiplier) == 0x000140, "Member 'FAmmoTypeData::HeadDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, UpperBodyDamageMultiplier) == 0x000144, "Member 'FAmmoTypeData::UpperBodyDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, LowerBodyDamageMultiplier) == 0x000148, "Member 'FAmmoTypeData::LowerBodyDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, ArmDamageMultiplier) == 0x00014C, "Member 'FAmmoTypeData::ArmDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, HandDamageMultiplier) == 0x000150, "Member 'FAmmoTypeData::HandDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, LegDamageMultiplier) == 0x000154, "Member 'FAmmoTypeData::LegDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, FootDamageMultiplier) == 0x000158, "Member 'FAmmoTypeData::FootDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, DefaultRagdollImpulseStrength) == 0x00015C, "Member 'FAmmoTypeData::DefaultRagdollImpulseStrength' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, HeadRagdollImpulseStrength) == 0x000160, "Member 'FAmmoTypeData::HeadRagdollImpulseStrength' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, ArmRagdollImpulseStrength) == 0x000164, "Member 'FAmmoTypeData::ArmRagdollImpulseStrength' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, LegRagdollImpulseStrength) == 0x000168, "Member 'FAmmoTypeData::LegRagdollImpulseStrength' has a wrong offset!");
static_assert(offsetof(FAmmoTypeData, TorsoRagdollImpulseStrength) == 0x00016C, "Member 'FAmmoTypeData::TorsoRagdollImpulseStrength' has a wrong offset!");
...
static_assert(sizeof(FOptimizationAttachmentData) == 0x000070, "Wrong size on FOptimizationAttachmentData");
...
static_assert(sizeof(FRChatMessage) == 0x000078, "Wrong size on FRChatMessage");
...
static_assert(offsetof(FRChatMessage, UniqueNetIdStr) == 0x000068, "Member 'FRChatMessage::UniqueNetIdStr' has a wrong offset!");
...
static_assert(alignof(FHitscanShot) == 0x000008, "Wrong alignment on FHitscanShot");
static_assert(sizeof(FHitscanShot) == 0x000038, "Wrong size on FHitscanShot");
static_assert(offsetof(FHitscanShot, Location) == 0x000000, "Member 'FHitscanShot::Location' has a wrong offset!");
static_assert(offsetof(FHitscanShot, Direction) == 0x000018, "Member 'FHitscanShot::Direction' has a wrong offset!");
static_assert(offsetof(FHitscanShot, Seed) == 0x000030, "Member 'FHitscanShot::Seed' has a wrong offset!");
...
static_assert(sizeof(FItemLookupTable) == 0x0006D0, "Wrong size on FItemLookupTable");
...
static_assert(offsetof(FItemLookupTable, SpreadReturnRate) == 0x000248, "Member 'FItemLookupTable::SpreadReturnRate' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, ADSSpreadMultiplier) == 0x00024C, "Member 'FItemLookupTable::ADSSpreadMultiplier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilPattern) == 0x000250, "Member 'FItemLookupTable::RecoilPattern' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilReturnRate) == 0x000260, "Member 'FItemLookupTable::RecoilReturnRate' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilInterpSpeed) == 0x000264, "Member 'FItemLookupTable::RecoilInterpSpeed' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, ADSRecoilMultiplier) == 0x000268, "Member 'FItemLookupTable::ADSRecoilMultiplier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, LockIntegrityMinDamage) == 0x00026C, "Member 'FItemLookupTable::LockIntegrityMinDamage' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, LockIntegrityMaxDamage) == 0x000270, "Member 'FItemLookupTable::LockIntegrityMaxDamage' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, BulletDrag) == 0x000274, "Member 'FItemLookupTable::BulletDrag' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bHitScan) == 0x000278, "Member 'FItemLookupTable::bHitScan' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bSpawnTracer) == 0x000279, "Member 'FItemLookupTable::bSpawnTracer' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bNoSpawnTracerForFiringPlayer) == 0x00027A, "Member 'FItemLookupTable::bNoSpawnTracerForFiringPlayer' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, SpawnProjectileCount) == 0x00027C, "Member 'FItemLookupTable::SpawnProjectileCount' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, Wobble) == 0x000280, "Member 'FItemLookupTable::Wobble' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, InitialWobbleDelay) == 0x000284, "Member 'FItemLookupTable::InitialWobbleDelay' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FireCameraShake) == 0x000288, "Member 'FItemLookupTable::FireCameraShake' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FirstShotRecoil) == 0x000290, "Member 'FItemLookupTable::FirstShotRecoil' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FirstShotSpread) == 0x000294, "Member 'FItemLookupTable::FirstShotSpread' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FirstShotResetTime) == 0x000298, "Member 'FItemLookupTable::FirstShotResetTime' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilReturnInterpSpeed) == 0x00029C, "Member 'FItemLookupTable::RecoilReturnInterpSpeed' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilReturnPercentage) == 0x0002A0, "Member 'FItemLookupTable::RecoilReturnPercentage' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, VelocitySpreadMultiplier) == 0x0002A4, "Member 'FItemLookupTable::VelocitySpreadMultiplier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, VelocityRecoilMultiplier) == 0x0002A8, "Member 'FItemLookupTable::VelocityRecoilMultiplier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilMultiplierPitch) == 0x0002AC, "Member 'FItemLookupTable::RecoilMultiplierPitch' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilMultiplierYaw) == 0x0002B0, "Member 'FItemLookupTable::RecoilMultiplierYaw' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RefireDelay) == 0x0002B4, "Member 'FItemLookupTable::RefireDelay' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, ItemStats) == 0x0002B8, "Member 'FItemLookupTable::ItemStats' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AttachmentPoints) == 0x0002C8, "Member 'FItemLookupTable::AttachmentPoints' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsScopeAttachments) == 0x0002CC, "Member 'FItemLookupTable::bAcceptsScopeAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableScopeAttachments) == 0x0002D0, "Member 'FItemLookupTable::AvailableScopeAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsMuzzleAttachments) == 0x0002E0, "Member 'FItemLookupTable::bAcceptsMuzzleAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableMuzzleAttachments) == 0x0002E8, "Member 'FItemLookupTable::AvailableMuzzleAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsUnderbarrelAttachments) == 0x0002F8, "Member 'FItemLookupTable::bAcceptsUnderbarrelAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableUnderbarrelAttachments) == 0x000300, "Member 'FItemLookupTable::AvailableUnderbarrelAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsOverbarrelAttachments) == 0x000310, "Member 'FItemLookupTable::bAcceptsOverbarrelAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableOverbarrelAttachments) == 0x000318, "Member 'FItemLookupTable::AvailableOverbarrelAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsStockAttachments) == 0x000328, "Member 'FItemLookupTable::bAcceptsStockAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableStockAttachments) == 0x000330, "Member 'FItemLookupTable::AvailableStockAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsGripAttachments) == 0x000340, "Member 'FItemLookupTable::bAcceptsGripAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableGripAttachments) == 0x000348, "Member 'FItemLookupTable::AvailableGripAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsIlluminatorAttachments) == 0x000358, "Member 'FItemLookupTable::bAcceptsIlluminatorAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableIlluminatorAttachments) == 0x000360, "Member 'FItemLookupTable::AvailableIlluminatorAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bAcceptsAmmunitionAttachments) == 0x000370, "Member 'FItemLookupTable::bAcceptsAmmunitionAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, AvailableAmmunitionAttachments) == 0x000378, "Member 'FItemLookupTable::AvailableAmmunitionAttachments' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bCalculateProcRecoil) == 0x000388, "Member 'FItemLookupTable::bCalculateProcRecoil' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilDampStrength) == 0x00038C, "Member 'FItemLookupTable::RecoilDampStrength' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilFireTime) == 0x000390, "Member 'FItemLookupTable::RecoilFireTime' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilFireStrength) == 0x000394, "Member 'FItemLookupTable::RecoilFireStrength' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilFireStrengthFirst) == 0x000398, "Member 'FItemLookupTable::RecoilFireStrengthFirst' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilAngleStrength) == 0x00039C, "Member 'FItemLookupTable::RecoilAngleStrength' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilRandomness) == 0x0003A0, "Member 'FItemLookupTable::RecoilRandomness' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilADSModfier) == 0x0003A4, "Member 'FItemLookupTable::RecoilADSModfier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilAngleADSModifier) == 0x0003A8, "Member 'FItemLookupTable::RecoilAngleADSModifier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilRotationBuildup) == 0x0003B0, "Member 'FItemLookupTable::RecoilRotationBuildup' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilPositionBuildup) == 0x0003C8, "Member 'FItemLookupTable::RecoilPositionBuildup' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilBuildupADSMultiplier) == 0x0003E0, "Member 'FItemLookupTable::RecoilBuildupADSMultiplier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilHasBuildup) == 0x0003E4, "Member 'FItemLookupTable::RecoilHasBuildup' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, RecoilBuildupDampStrength) == 0x0003E8, "Member 'FItemLookupTable::RecoilBuildupDampStrength' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FreeAimLimit) == 0x0003EC, "Member 'FItemLookupTable::FreeAimLimit' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FreeAimLimitADS) == 0x0003F0, "Member 'FItemLookupTable::FreeAimLimitADS' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, LazySpringStrength) == 0x0003F4, "Member 'FItemLookupTable::LazySpringStrength' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, LazySpringStrengthADS) == 0x0003F8, "Member 'FItemLookupTable::LazySpringStrengthADS' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FPADSMotionWeight) == 0x0003FC, "Member 'FItemLookupTable::FPADSMotionWeight' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FreeAimInterpSpeed) == 0x000400, "Member 'FItemLookupTable::FreeAimInterpSpeed' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FreeAimInterpADSModifier) == 0x000404, "Member 'FItemLookupTable::FreeAimInterpADSModifier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FreeAimInterpHipModifier) == 0x000408, "Member 'FItemLookupTable::FreeAimInterpHipModifier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FreeAimSlowMoveModifier) == 0x00040C, "Member 'FItemLookupTable::FreeAimSlowMoveModifier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, FreeAimSlowMoveTolerance) == 0x000410, "Member 'FItemLookupTable::FreeAimSlowMoveTolerance' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, bDisableMeshspaceMovement) == 0x000414, "Member 'FItemLookupTable::bDisableMeshspaceMovement' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MeshspaceTransform_Default) == 0x000420, "Member 'FItemLookupTable::MeshspaceTransform_Default' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MeshspaceTransform_Aiming) == 0x000480, "Member 'FItemLookupTable::MeshspaceTransform_Aiming' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MeshspaceTransform_Back) == 0x0004E0, "Member 'FItemLookupTable::MeshspaceTransform_Back' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MovementSpeedScale) == 0x000540, "Member 'FItemLookupTable::MovementSpeedScale' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MovementSpeedRotationScalePitchYawRoll) == 0x000558, "Member 'FItemLookupTable::MovementSpeedRotationScalePitchYawRoll' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MeshSpaceAimInterp) == 0x000570, "Member 'FItemLookupTable::MeshSpaceAimInterp' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MeshspaceTransform_OnDraw) == 0x000580, "Member 'FItemLookupTable::MeshspaceTransform_OnDraw' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, OnDrawMeshspaceInterp) == 0x0005E0, "Member 'FItemLookupTable::OnDrawMeshspaceInterp' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, MeshspaceTransform_OnHolster) == 0x0005F0, "Member 'FItemLookupTable::MeshspaceTransform_OnHolster' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, OnHolsterMeshspaceInterp) == 0x000650, "Member 'FItemLookupTable::OnHolsterMeshspaceInterp' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, InertiaDragAimRotation) == 0x000654, "Member 'FItemLookupTable::InertiaDragAimRotation' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, InertiaDragAimLocation) == 0x000658, "Member 'FItemLookupTable::InertiaDragAimLocation' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, InertiaDragStrafeRotation) == 0x00065C, "Member 'FItemLookupTable::InertiaDragStrafeRotation' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, InertiaDragStrafeLocation) == 0x000660, "Member 'FItemLookupTable::InertiaDragStrafeLocation' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, BodySocket) == 0x000664, "Member 'FItemLookupTable::BodySocket' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, HandsSocket) == 0x00066C, "Member 'FItemLookupTable::HandsSocket' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobScaleH) == 0x000674, "Member 'FItemLookupTable::CameraBobScaleH' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobScaleV) == 0x000678, "Member 'FItemLookupTable::CameraBobScaleV' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobSpeedScaleH) == 0x00067C, "Member 'FItemLookupTable::CameraBobSpeedScaleH' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobSpeedScaleV) == 0x000680, "Member 'FItemLookupTable::CameraBobSpeedScaleV' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobAmplitudeBaseSpeed) == 0x000684, "Member 'FItemLookupTable::CameraBobAmplitudeBaseSpeed' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobIntensitySprintScale) == 0x000688, "Member 'FItemLookupTable::CameraBobIntensitySprintScale' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobAmplitudeWalkScale) == 0x00068C, "Member 'FItemLookupTable::CameraBobAmplitudeWalkScale' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, CameraBobAmplitudeSprintScale) == 0x000690, "Member 'FItemLookupTable::CameraBobAmplitudeSprintScale' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobScaleH) == 0x000694, "Member 'FItemLookupTable::WeaponBobScaleH' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobScaleV) == 0x000698, "Member 'FItemLookupTable::WeaponBobScaleV' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobScaleInjured) == 0x00069C, "Member 'FItemLookupTable::WeaponBobScaleInjured' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobSpeedScaleH) == 0x0006A0, "Member 'FItemLookupTable::WeaponBobSpeedScaleH' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobSpeedScaleV) == 0x0006A4, "Member 'FItemLookupTable::WeaponBobSpeedScaleV' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobSpeedScaleInjured) == 0x0006A8, "Member 'FItemLookupTable::WeaponBobSpeedScaleInjured' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobCrouchModifier) == 0x0006AC, "Member 'FItemLookupTable::WeaponBobCrouchModifier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobADSModifier) == 0x0006B0, "Member 'FItemLookupTable::WeaponBobADSModifier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobRotPitchScale) == 0x0006B4, "Member 'FItemLookupTable::WeaponBobRotPitchScale' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobRotRollScale) == 0x0006B8, "Member 'FItemLookupTable::WeaponBobRotRollScale' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobRotPitchSpeed) == 0x0006BC, "Member 'FItemLookupTable::WeaponBobRotPitchSpeed' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobRotRollSpeed) == 0x0006C0, "Member 'FItemLookupTable::WeaponBobRotRollSpeed' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobRotCrouchModifier) == 0x0006C4, "Member 'FItemLookupTable::WeaponBobRotCrouchModifier' has a wrong offset!");
static_assert(offsetof(FItemLookupTable, WeaponBobRotADSModifier) == 0x0006C8, "Member 'FItemLookupTable::WeaponBobRotADSModifier' has a wrong offset!");
...
static_assert(alignof(FRoleConditional) == 0x000008, "Wrong alignment on FRoleConditional");
static_assert(sizeof(FRoleConditional) == 0x000010, "Wrong size on FRoleConditional");
static_assert(offsetof(FRoleConditional, SquadMember) == 0x000000, "Member 'FRoleConditional::SquadMember' has a wrong offset!");
static_assert(offsetof(FRoleConditional, RoleName) == 0x000008, "Member 'FRoleConditional::RoleName' has a wrong offset!");
...
static_assert(sizeof(FSavedCustomization) == 0x000140, "Wrong size on FSavedCustomization");
static_assert(offsetof(FSavedCustomization, PresetName) == 0x000000, "Member 'FSavedCustomization::PresetName' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Character) == 0x000010, "Member 'FSavedCustomization::Character' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Voice) == 0x000018, "Member 'FSavedCustomization::Voice' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Helmet) == 0x000020, "Member 'FSavedCustomization::Helmet' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Shirt) == 0x000028, "Member 'FSavedCustomization::Shirt' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Pants) == 0x000030, "Member 'FSavedCustomization::Pants' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Shoes) == 0x000038, "Member 'FSavedCustomization::Shoes' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Eyewear) == 0x000040, "Member 'FSavedCustomization::Eyewear' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Belt) == 0x000048, "Member 'FSavedCustomization::Belt' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Gloves) == 0x000050, "Member 'FSavedCustomization::Gloves' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Watch) == 0x000058, "Member 'FSavedCustomization::Watch' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Tattoo) == 0x000060, "Member 'FSavedCustomization::Tattoo' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, PrimarySkin) == 0x000068, "Member 'FSavedCustomization::PrimarySkin' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, SecondarySkin) == 0x000070, "Member 'FSavedCustomization::SecondarySkin' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, ArmorSkin) == 0x000078, "Member 'FSavedCustomization::ArmorSkin' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, HelmetSkin) == 0x000080, "Member 'FSavedCustomization::HelmetSkin' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, HelmetMountSkin) == 0x000088, "Member 'FSavedCustomization::HelmetMountSkin' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, FacewearSkin) == 0x000090, "Member 'FSavedCustomization::FacewearSkin' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, Flags) == 0x000098, "Member 'FSavedCustomization::Flags' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, PreviousSkinsMap) == 0x0000A0, "Member 'FSavedCustomization::PreviousSkinsMap' has a wrong offset!");
static_assert(offsetof(FSavedCustomization, PreviousHelmetsMap) == 0x0000F0, "Member 'FSavedCustomization::PreviousHelmetsMap' has a wrong offset!");
...
static_assert(sizeof(FSavedLoadout) == 0x0002E8, "Wrong size on FSavedLoadout");
...
static_assert(offsetof(FSavedLoadout, NvgStyle) == 0x000148, "Member 'FSavedLoadout::NvgStyle' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, HelmetMount) == 0x000150, "Member 'FSavedLoadout::HelmetMount' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, Facewear) == 0x000158, "Member 'FSavedLoadout::Facewear' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, RandomGear) == 0x000160, "Member 'FSavedLoadout::RandomGear' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, Miscelaneous) == 0x000168, "Member 'FSavedLoadout::Miscelaneous' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, PlayerSkin) == 0x000178, "Member 'FSavedLoadout::PlayerSkin' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, CharacterLookOverride) == 0x000180, "Member 'FSavedLoadout::CharacterLookOverride' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, ArmourCoverage) == 0x000190, "Member 'FSavedLoadout::ArmourCoverage' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, ArmourMaterial) == 0x000198, "Member 'FSavedLoadout::ArmourMaterial' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, bHasCustomization) == 0x0001A0, "Member 'FSavedLoadout::bHasCustomization' has a wrong offset!");
static_assert(offsetof(FSavedLoadout, SavedCustomization) == 0x0001A8, "Member 'FSavedLoadout::SavedCustomization' has a wrong offset!");
...
static_assert(alignof(FPlayerBanInfo) == 0x000008, "Wrong alignment on FPlayerBanInfo");
static_assert(sizeof(FPlayerBanInfo) == 0x000028, "Wrong size on FPlayerBanInfo");
static_assert(offsetof(FPlayerBanInfo, PlayerId) == 0x000000, "Member 'FPlayerBanInfo::PlayerId' has a wrong offset!");
static_assert(offsetof(FPlayerBanInfo, DisplayName) == 0x000010, "Member 'FPlayerBanInfo::DisplayName' has a wrong offset!");
static_assert(offsetof(FPlayerBanInfo, BanType) == 0x000020, "Member 'FPlayerBanInfo::BanType' has a wrong offset!");
...
static_assert(alignof(FSquadActionDecisionContext) == 0x000008, "Wrong alignment on FSquadActionDecisionContext");
static_assert(sizeof(FSquadActionDecisionContext) == 0x000010, "Wrong size on FSquadActionDecisionContext");
static_assert(offsetof(FSquadActionDecisionContext, SquadManager) == 0x000000, "Member 'FSquadActionDecisionContext::SquadManager' has a wrong offset!");
static_assert(offsetof(FSquadActionDecisionContext, World) == 0x000008, "Member 'FSquadActionDecisionContext::World' has a wrong offset!");
...
static_assert(sizeof(FSuppressionData) == 0x000040, "Wrong size on FSuppressionData");
static_assert(offsetof(FSuppressionData, Origin) == 0x000000, "Member 'FSuppressionData::Origin' has a wrong offset!");
static_assert(offsetof(FSuppressionData, Direction) == 0x000018, "Member 'FSuppressionData::Direction' has a wrong offset!");
static_assert(offsetof(FSuppressionData, Strength) == 0x000030, "Member 'FSuppressionData::Strength' has a wrong offset!");
static_assert(offsetof(FSuppressionData, Distance) == 0x000034, "Member 'FSuppressionData::Distance' has a wrong offset!");
static_assert(offsetof(FSuppressionData, Instigator) == 0x000038, "Member 'FSuppressionData::Instigator' has a wrong offset!");
...
static_assert(sizeof(FAIActionData) == 0x0002F0, "Wrong size on FAIActionData");
...
static_assert(offsetof(FAIActionData, bFireVoiceLineOnActionBegin) == 0x000018, "Member 'FAIActionData::bFireVoiceLineOnActionBegin' has a wrong offset!");
static_assert(offsetof(FAIActionData, VoiceLineOnActionBegin) == 0x000020, "Member 'FAIActionData::VoiceLineOnActionBegin' has a wrong offset!");
static_assert(offsetof(FAIActionData, VoicelineDelay) == 0x000030, "Member 'FAIActionData::VoicelineDelay' has a wrong offset!");
static_assert(offsetof(FAIActionData, VoicelineDelayVariance) == 0x000034, "Member 'FAIActionData::VoicelineDelayVariance' has a wrong offset!");
static_assert(offsetof(FAIActionData, Weight) == 0x000038, "Member 'FAIActionData::Weight' has a wrong offset!");
static_assert(offsetof(FAIActionData, ScoreThreshold) == 0x00003C, "Member 'FAIActionData::ScoreThreshold' has a wrong offset!");
static_assert(offsetof(FAIActionData, DisableActionConsiderCount) == 0x000044, "Member 'FAIActionData::DisableActionConsiderCount' has a wrong offset!");
static_assert(offsetof(FAIActionData, CommitTime) == 0x00004C, "Member 'FAIActionData::CommitTime' has a wrong offset!");
static_assert(offsetof(FAIActionData, CommitTimeConfigKey) == 0x000058, "Member 'FAIActionData::CommitTimeConfigKey' has a wrong offset!");
static_assert(offsetof(FAIActionData, CommitInterrupts) == 0x000070, "Member 'FAIActionData::CommitInterrupts' has a wrong offset!");
static_assert(offsetof(FAIActionData, Cooldown) == 0x000084, "Member 'FAIActionData::Cooldown' has a wrong offset!");
static_assert(offsetof(FAIActionData, CooldownConfigKey) == 0x000090, "Member 'FAIActionData::CooldownConfigKey' has a wrong offset!");
static_assert(offsetof(FAIActionData, Gates) == 0x0000A0, "Member 'FAIActionData::Gates' has a wrong offset!");
static_assert(offsetof(FAIActionData, Considerations) == 0x0000B0, "Member 'FAIActionData::Considerations' has a wrong offset!");
static_assert(offsetof(FAIActionData, Scores) == 0x0000C0, "Member 'FAIActionData::Scores' has a wrong offset!");
static_assert(offsetof(FAIActionData, Cooldowns) == 0x000110, "Member 'FAIActionData::Cooldowns' has a wrong offset!");
static_assert(offsetof(FAIActionData, CommitTimes) == 0x000160, "Member 'FAIActionData::CommitTimes' has a wrong offset!");
static_assert(offsetof(FAIActionData, SuccessConsiderCount) == 0x0001B0, "Member 'FAIActionData::SuccessConsiderCount' has a wrong offset!");
static_assert(offsetof(FAIActionData, FailConsiderCount) == 0x000200, "Member 'FAIActionData::FailConsiderCount' has a wrong offset!");
static_assert(offsetof(FAIActionData, CustomActions) == 0x000250, "Member 'FAIActionData::CustomActions' has a wrong offset!");
static_assert(offsetof(FAIActionData, RunCount) == 0x0002A0, "Member 'FAIActionData::RunCount' has a wrong offset!");
...
static_assert(sizeof(FAIActionDataContainer) == 0x000300, "Wrong size on FAIActionDataContainer");
...
static_assert(offsetof(FAIActionDataContainer, Preset) == 0x0002F8, "Member 'FAIActionDataContainer::Preset' has a wrong offset!");
...
static_assert(alignof(FCharacterSnapshot) == 0x000008, "Wrong alignment on FCharacterSnapshot");
static_assert(sizeof(FCharacterSnapshot) == 0x000040, "Wrong size on FCharacterSnapshot");
static_assert(offsetof(FCharacterSnapshot, Time) == 0x000000, "Member 'FCharacterSnapshot::Time' has a wrong offset!");
static_assert(offsetof(FCharacterSnapshot, BoundingBox) == 0x000008, "Member 'FCharacterSnapshot::BoundingBox' has a wrong offset!");
...
static_assert(alignof(FMissionDateTime) == 0x000004, "Wrong alignment on FMissionDateTime");
static_assert(sizeof(FMissionDateTime) == 0x000018, "Wrong size on FMissionDateTime");
static_assert(offsetof(FMissionDateTime, Year) == 0x000000, "Member 'FMissionDateTime::Year' has a wrong offset!");
static_assert(offsetof(FMissionDateTime, Month) == 0x000004, "Member 'FMissionDateTime::Month' has a wrong offset!");
static_assert(offsetof(FMissionDateTime, Day) == 0x000008, "Member 'FMissionDateTime::Day' has a wrong offset!");
static_assert(offsetof(FMissionDateTime, Hour) == 0x00000C, "Member 'FMissionDateTime::Hour' has a wrong offset!");
static_assert(offsetof(FMissionDateTime, Minute) == 0x000010, "Member 'FMissionDateTime::Minute' has a wrong offset!");
static_assert(offsetof(FMissionDateTime, Second) == 0x000014, "Member 'FMissionDateTime::Second' has a wrong offset!");
...
static_assert(alignof(FMissionWorldInformation) == 0x000008, "Wrong alignment on FMissionWorldInformation");
static_assert(sizeof(FMissionWorldInformation) == 0x000038, "Wrong size on FMissionWorldInformation");
static_assert(offsetof(FMissionWorldInformation, LocalStartTime) == 0x000000, "Member 'FMissionWorldInformation::LocalStartTime' has a wrong offset!");
static_assert(offsetof(FMissionWorldInformation, LocalTimeZoneOffset) == 0x000018, "Member 'FMissionWorldInformation::LocalTimeZoneOffset' has a wrong offset!");
static_assert(offsetof(FMissionWorldInformation, TrueNorthOffsetInDegrees) == 0x00001C, "Member 'FMissionWorldInformation::TrueNorthOffsetInDegrees' has a wrong offset!");
static_assert(offsetof(FMissionWorldInformation, LatitudeAndLongitude) == 0x000020, "Member 'FMissionWorldInformation::LatitudeAndLongitude' has a wrong offset!");
static_assert(offsetof(FMissionWorldInformation, SeaLevelOffsetInCentimeters) == 0x000030, "Member 'FMissionWorldInformation::SeaLevelOffsetInCentimeters' has a wrong offset!");
...
{
public:
	class UStaticMesh*                            StaticMesh;                                        // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UStaticMeshComponent*                   StaticMeshComponent;                               // 0x0010(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	class USkeletalMeshComponent*                 SkeletalMeshComponent;                             // 0x0018(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	class USkeletalMesh*                          Body;                                              // 0x0010(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USkeletalMesh*                          Head;                                              // 0x0018(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPoseAsset*                             FaceROM;                                           // 0x0020(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UFMODEvent*                             Footsteps;                                         // 0x0040(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             MovementFoley;                                     // 0x0048(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FInterestPoint) == 0x000118, "Wrong size on FInterestPoint");
static_assert(offsetof(FInterestPoint, Location) == 0x000000, "Member 'FInterestPoint::Location' has a wrong offset!");
static_assert(offsetof(FInterestPoint, Type) == 0x000018, "Member 'FInterestPoint::Type' has a wrong offset!");
static_assert(offsetof(FInterestPoint, Threat) == 0x000020, "Member 'FInterestPoint::Threat' has a wrong offset!");
static_assert(offsetof(FInterestPoint, Door) == 0x000048, "Member 'FInterestPoint::Door' has a wrong offset!");
static_assert(offsetof(FInterestPoint, Spawner) == 0x000070, "Member 'FInterestPoint::Spawner' has a wrong offset!");
static_assert(offsetof(FInterestPoint, CustomActor) == 0x000098, "Member 'FInterestPoint::CustomActor' has a wrong offset!");
static_assert(offsetof(FInterestPoint, RequiredTimeFocusing) == 0x0000C0, "Member 'FInterestPoint::RequiredTimeFocusing' has a wrong offset!");
static_assert(offsetof(FInterestPoint, TimeFocusing) == 0x0000C8, "Member 'FInterestPoint::TimeFocusing' has a wrong offset!");
...
static_assert(sizeof(FPostProcessSetting_VectorParam) == 0x0002B8, "Wrong size on FPostProcessSetting_VectorParam");
...
static_assert(offsetof(FPostProcessSetting_VectorParam, End) == 0x000098, "Member 'FPostProcessSetting_VectorParam::End' has a wrong offset!");
static_assert(offsetof(FPostProcessSetting_VectorParam, Curve) == 0x0000B0, "Member 'FPostProcessSetting_VectorParam::Curve' has a wrong offset!");
...
static_assert(sizeof(FAIMovementStyleData) == 0x000048, "Wrong size on FAIMovementStyleData");
...
static_assert(offsetof(FAIMovementStyleData, HesitationPistolMoveStyle) == 0x000030, "Member 'FAIMovementStyleData::HesitationPistolMoveStyle' has a wrong offset!");
static_assert(offsetof(FAIMovementStyleData, SurrenderedMoveStyle) == 0x000038, "Member 'FAIMovementStyleData::SurrenderedMoveStyle' has a wrong offset!");
static_assert(offsetof(FAIMovementStyleData, ArrestedMoveStyle) == 0x000040, "Member 'FAIMovementStyleData::ArrestedMoveStyle' has a wrong offset!");
...
static_assert(alignof(FAnimInput_CapsuleLocomotion) == 0x000008, "Wrong alignment on FAnimInput_CapsuleLocomotion");
static_assert(sizeof(FAnimInput_CapsuleLocomotion) == 0x000078, "Wrong size on FAnimInput_CapsuleLocomotion");
...
static_assert(offsetof(FAnimInput_CapsuleLocomotion, LocalVelocity) == 0x000018, "Member 'FAnimInput_CapsuleLocomotion::LocalVelocity' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, WorldAcceleration) == 0x000030, "Member 'FAnimInput_CapsuleLocomotion::WorldAcceleration' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, LocalAcceleration) == 0x000048, "Member 'FAnimInput_CapsuleLocomotion::LocalAcceleration' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, VelocityYawAngle) == 0x000060, "Member 'FAnimInput_CapsuleLocomotion::VelocityYawAngle' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, AccelerationYawAngle) == 0x000064, "Member 'FAnimInput_CapsuleLocomotion::AccelerationYawAngle' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, Speed2D) == 0x000068, "Member 'FAnimInput_CapsuleLocomotion::Speed2D' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, MovingThreshold) == 0x00006C, "Member 'FAnimInput_CapsuleLocomotion::MovingThreshold' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, bIsMoving2D) == 0x000070, "Member 'FAnimInput_CapsuleLocomotion::bIsMoving2D' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, bHasAcceleration2D) == 0x000071, "Member 'FAnimInput_CapsuleLocomotion::bHasAcceleration2D' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, bAccelerationOpposesVelocity) == 0x000072, "Member 'FAnimInput_CapsuleLocomotion::bAccelerationOpposesVelocity' has a wrong offset!");
static_assert(offsetof(FAnimInput_CapsuleLocomotion, bIsOnGround) == 0x000073, "Member 'FAnimInput_CapsuleLocomotion::bIsOnGround' has a wrong offset!");
...
static_assert(sizeof(FExposedToNoise) == 0x000040, "Wrong size on FExposedToNoise");
...
static_assert(offsetof(FExposedToNoise, StimulusLocation) == 0x000018, "Member 'FExposedToNoise::StimulusLocation' has a wrong offset!");
static_assert(offsetof(FExposedToNoise, bAggressive) == 0x000030, "Member 'FExposedToNoise::bAggressive' has a wrong offset!");
static_assert(offsetof(FExposedToNoise, bFriendly) == 0x000031, "Member 'FExposedToNoise::bFriendly' has a wrong offset!");
static_assert(offsetof(FExposedToNoise, TimeSinceExposed) == 0x000034, "Member 'FExposedToNoise::TimeSinceExposed' has a wrong offset!");
static_assert(offsetof(FExposedToNoise, ExpiryTime) == 0x000038, "Member 'FExposedToNoise::ExpiryTime' has a wrong offset!");
...
static_assert(alignof(FAISquadActionDataContainer) == 0x000008, "Wrong alignment on FAISquadActionDataContainer");
static_assert(sizeof(FAISquadActionDataContainer) == 0x000308, "Wrong size on FAISquadActionDataContainer");
static_assert(offsetof(FAISquadActionDataContainer, ActionTag) == 0x000300, "Member 'FAISquadActionDataContainer::ActionTag' has a wrong offset!");
...
static_assert(alignof(FSquadRolesData) == 0x000008, "Wrong alignment on FSquadRolesData");
static_assert(sizeof(FSquadRolesData) == 0x000020, "Wrong size on FSquadRolesData");
static_assert(offsetof(FSquadRolesData, RoleTag) == 0x000000, "Member 'FSquadRolesData::RoleTag' has a wrong offset!");
static_assert(offsetof(FSquadRolesData, MinRequired) == 0x000008, "Member 'FSquadRolesData::MinRequired' has a wrong offset!");
static_assert(offsetof(FSquadRolesData, MaxAllowed) == 0x00000C, "Member 'FSquadRolesData::MaxAllowed' has a wrong offset!");
static_assert(offsetof(FSquadRolesData, ValidSquadMembersForRole) == 0x000010, "Member 'FSquadRolesData::ValidSquadMembersForRole' has a wrong offset!");
...
static_assert(sizeof(FSpawnPoints) == 0x0000A0, "Wrong size on FSpawnPoints");
...
static_assert(offsetof(FSpawnPoints, PlanningCoordinate) == 0x000080, "Member 'FSpawnPoints::PlanningCoordinate' has a wrong offset!");
static_assert(offsetof(FSpawnPoints, PtsCost) == 0x000090, "Member 'FSpawnPoints::PtsCost' has a wrong offset!");
static_assert(offsetof(FSpawnPoints, bSpawnDisabled) == 0x000094, "Member 'FSpawnPoints::bSpawnDisabled' has a wrong offset!");
static_assert(offsetof(FSpawnPoints, SpawnLabel) == 0x000098, "Member 'FSpawnPoints::SpawnLabel' has a wrong offset!");
...
static_assert(sizeof(FActorSense) == 0x000078, "Wrong size on FActorSense");
...
static_assert(sizeof(FTrapData) == 0x000080, "Wrong size on FTrapData");
...
static_assert(offsetof(FTrapData, TrapClass) == 0x000070, "Member 'FTrapData::TrapClass' has a wrong offset!");
static_assert(offsetof(FTrapData, bAttachToDoor) == 0x000078, "Member 'FTrapData::bAttachToDoor' has a wrong offset!");
static_assert(offsetof(FTrapData, TrapType) == 0x000079, "Member 'FTrapData::TrapType' has a wrong offset!");
static_assert(offsetof(FTrapData, InvertOffset) == 0x00007C, "Member 'FTrapData::InvertOffset' has a wrong offset!");
...
public:
	...
	class UStaticMesh*                            DoorMesh;                                          // 0x0020(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UStaticMesh*                            DoorHandle;                                        // 0x0028(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DoorwayOffset;                                     // 0x0030(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DoorwayOffsetScale;                                // 0x0048(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bLockable : 1;                                     // 0x0060(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCustomLockpickLocation : 1;                       // 0x0060(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LockpickRelativeLocation;                          // 0x0068(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bCustomDoorPeekLocation : 1;                       // 0x0080(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                DoorPeekRelativeLocation;                          // 0x0088(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bDoorHandleFront : 1;                              // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDoorHandleBack : 1;                               // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A1[0xF];                                       // 0x00A1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             DoorHandleFrontRelativeTransform;                  // 0x00B0(0x0060)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             DoorHandleBackRelativeTransform;                   // 0x0110(0x0060)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumSuccessfulKicksToBreakDown;                     // 0x0170(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DoorKickSuccessChance;                             // 0x0174(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_178[0x8];                                      // 0x0178(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             KickParticleTransform;                             // 0x0180(0x0060)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UParticleSystem>         KickedParticleSystem;                              // 0x01E0(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UParticleSystem>         LockBrokenParticleSystem;                          // 0x0208(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                C2PlacementPoint_Front;                            // 0x0230(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                C2PlacementPoint_Back;                             // 0x0248(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UParticleSystem*                        C2ExplosionParticle;                               // 0x0260(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             C2ExplosionEvent;                                  // 0x0268(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             OpenSound;                                         // 0x0270(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             CloseSound;                                        // 0x0278(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             PushOpenSound;                                     // 0x0280(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             PushCloseSound;                                    // 0x0288(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             ManipulateSound;                                   // 0x0290(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             BashSound;                                         // 0x0298(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             LockedSound;                                       // 0x02A0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             RamSound;                                          // 0x02A8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             KickSuccessSound;                                  // 0x02B0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             KickFailSound;                                     // 0x02B8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             AlarmSound;                                        // 0x02C0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             KeycardSound;                                      // 0x02C8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             KeycardDenySound;                                  // 0x02D0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FDoorData) == 0x0002E0, "Wrong size on FDoorData");
...
static_assert(offsetof(FDoorData, DoorwayOffsetScale) == 0x000048, "Member 'FDoorData::DoorwayOffsetScale' has a wrong offset!");
static_assert(offsetof(FDoorData, LockpickRelativeLocation) == 0x000068, "Member 'FDoorData::LockpickRelativeLocation' has a wrong offset!");
static_assert(offsetof(FDoorData, DoorPeekRelativeLocation) == 0x000088, "Member 'FDoorData::DoorPeekRelativeLocation' has a wrong offset!");
static_assert(offsetof(FDoorData, DoorHandleFrontRelativeTransform) == 0x0000B0, "Member 'FDoorData::DoorHandleFrontRelativeTransform' has a wrong offset!");
static_assert(offsetof(FDoorData, DoorHandleBackRelativeTransform) == 0x000110, "Member 'FDoorData::DoorHandleBackRelativeTransform' has a wrong offset!");
static_assert(offsetof(FDoorData, NumSuccessfulKicksToBreakDown) == 0x000170, "Member 'FDoorData::NumSuccessfulKicksToBreakDown' has a wrong offset!");
static_assert(offsetof(FDoorData, DoorKickSuccessChance) == 0x000174, "Member 'FDoorData::DoorKickSuccessChance' has a wrong offset!");
static_assert(offsetof(FDoorData, KickParticleTransform) == 0x000180, "Member 'FDoorData::KickParticleTransform' has a wrong offset!");
static_assert(offsetof(FDoorData, KickedParticleSystem) == 0x0001E0, "Member 'FDoorData::KickedParticleSystem' has a wrong offset!");
static_assert(offsetof(FDoorData, LockBrokenParticleSystem) == 0x000208, "Member 'FDoorData::LockBrokenParticleSystem' has a wrong offset!");
static_assert(offsetof(FDoorData, C2PlacementPoint_Front) == 0x000230, "Member 'FDoorData::C2PlacementPoint_Front' has a wrong offset!");
static_assert(offsetof(FDoorData, C2PlacementPoint_Back) == 0x000248, "Member 'FDoorData::C2PlacementPoint_Back' has a wrong offset!");
static_assert(offsetof(FDoorData, C2ExplosionParticle) == 0x000260, "Member 'FDoorData::C2ExplosionParticle' has a wrong offset!");
static_assert(offsetof(FDoorData, C2ExplosionEvent) == 0x000268, "Member 'FDoorData::C2ExplosionEvent' has a wrong offset!");
static_assert(offsetof(FDoorData, OpenSound) == 0x000270, "Member 'FDoorData::OpenSound' has a wrong offset!");
static_assert(offsetof(FDoorData, CloseSound) == 0x000278, "Member 'FDoorData::CloseSound' has a wrong offset!");
static_assert(offsetof(FDoorData, PushOpenSound) == 0x000280, "Member 'FDoorData::PushOpenSound' has a wrong offset!");
static_assert(offsetof(FDoorData, PushCloseSound) == 0x000288, "Member 'FDoorData::PushCloseSound' has a wrong offset!");
static_assert(offsetof(FDoorData, ManipulateSound) == 0x000290, "Member 'FDoorData::ManipulateSound' has a wrong offset!");
static_assert(offsetof(FDoorData, BashSound) == 0x000298, "Member 'FDoorData::BashSound' has a wrong offset!");
static_assert(offsetof(FDoorData, LockedSound) == 0x0002A0, "Member 'FDoorData::LockedSound' has a wrong offset!");
static_assert(offsetof(FDoorData, RamSound) == 0x0002A8, "Member 'FDoorData::RamSound' has a wrong offset!");
static_assert(offsetof(FDoorData, KickSuccessSound) == 0x0002B0, "Member 'FDoorData::KickSuccessSound' has a wrong offset!");
static_assert(offsetof(FDoorData, KickFailSound) == 0x0002B8, "Member 'FDoorData::KickFailSound' has a wrong offset!");
static_assert(offsetof(FDoorData, AlarmSound) == 0x0002C0, "Member 'FDoorData::AlarmSound' has a wrong offset!");
static_assert(offsetof(FDoorData, KeycardSound) == 0x0002C8, "Member 'FDoorData::KeycardSound' has a wrong offset!");
static_assert(offsetof(FDoorData, KeycardDenySound) == 0x0002D0, "Member 'FDoorData::KeycardDenySound' has a wrong offset!");
...
static_assert(alignof(FSquadActionGateData) == 0x000008, "Wrong alignment on FSquadActionGateData");
static_assert(sizeof(FSquadActionGateData) == 0x000010, "Wrong size on FSquadActionGateData");
static_assert(offsetof(FSquadActionGateData, Type) == 0x000000, "Member 'FSquadActionGateData::Type' has a wrong offset!");
static_assert(offsetof(FSquadActionGateData, bNot) == 0x000008, "Member 'FSquadActionGateData::bNot' has a wrong offset!");
...
public:
	...
	class USkeletalMesh*                          Mesh;                                              // 0x0030(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UParticleSystem*                        HitParticleEffect;                                 // 0x0050(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             BlockedSoundEvent;                                 // 0x0058(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             PenetratedSoundEvent;                              // 0x0060(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFMODEvent*                             Footsteps;                                         // 0x0068(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(alignof(FAchievementStatus) == 0x000001, "Wrong alignment on FAchievementStatus");
static_assert(sizeof(FAchievementStatus) == 0x000002, "Wrong size on FAchievementStatus");
static_assert(offsetof(FAchievementStatus, Achievement) == 0x000000, "Member 'FAchievementStatus::Achievement' has a wrong offset!");
static_assert(offsetof(FAchievementStatus, Unlocked) == 0x000001, "Member 'FAchievementStatus::Unlocked' has a wrong offset!");
...
static_assert(sizeof(FEntryPoint) == 0x0000A8, "Wrong size on FEntryPoint");
...
static_assert(offsetof(FEntryPoint, ExcludedGameModes) == 0x000070, "Member 'FEntryPoint::ExcludedGameModes' has a wrong offset!");
static_assert(offsetof(FEntryPoint, LoadingScene) == 0x000080, "Member 'FEntryPoint::LoadingScene' has a wrong offset!");
...
static_assert(sizeof(FMapLayout) == 0x000090, "Wrong size on FMapLayout");
static_assert(offsetof(FMapLayout, MapOrigin) == 0x000000, "Member 'FMapLayout::MapOrigin' has a wrong offset!");
static_assert(offsetof(FMapLayout, MapSize) == 0x000010, "Member 'FMapLayout::MapSize' has a wrong offset!");
static_assert(offsetof(FMapLayout, MapOverviewTexture) == 0x000018, "Member 'FMapLayout::MapOverviewTexture' has a wrong offset!");
static_assert(offsetof(FMapLayout, MapCells) == 0x000040, "Member 'FMapLayout::MapCells' has a wrong offset!");
...
static_assert(sizeof(FLevelDeployableDepot) == 0x000088, "Wrong size on FLevelDeployableDepot");
...
static_assert(offsetof(FLevelDeployableDepot, MapCoordinates) == 0x000060, "Member 'FLevelDeployableDepot::MapCoordinates' has a wrong offset!");
static_assert(offsetof(FLevelDeployableDepot, MapShiftAmount) == 0x000070, "Member 'FLevelDeployableDepot::MapShiftAmount' has a wrong offset!");
static_assert(offsetof(FLevelDeployableDepot, MapZoomLevel) == 0x000080, "Member 'FLevelDeployableDepot::MapZoomLevel' has a wrong offset!");

// ScriptStruct ReadyOrNot.LevelDataLookupTable
// 0x0810 (0x0818 - 0x0008)
...
public:
	...
	struct FMissionWorldInformation               WorldInformation;                                  // 0x00D8(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         DefaultFloorIndex;                                 // 0x0110(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_114[0x4];                                      // 0x0114(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FLevelFloor>                    Floors;                                            // 0x0118(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	class FName                                   DefaultSpawnTag;                                   // 0x0128(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FEntryPoint>                    EntryPoints;                                       // 0x0130(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         TabletScreenBrightness;                            // 0x0140(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bUseFixedExposureWhenViewingTablet : 1;            // 0x0144(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_145[0x3];                                      // 0x0145(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinEV100;                                          // 0x0148(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxEV100;                                          // 0x014C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<ECOOPMode, class FString>                COOPModesLevelMap;                                 // 0x0150(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<ECOOPMode, struct FLoadAdditionalLevels> COOPModesLevelAdditionalMaps;                      // 0x01A0(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FUnlockRequirements                    UnlockRequirements;                                // 0x01F0(0x0018)(Edit, BlueprintVisible, EditConst, NativeAccessSpecifierPublic)
	struct FMapLayout                             MapLayout;                                         // 0x0208(0x0090)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FLoadingScreenAnimated                 LoadingScreen;                                     // 0x0298(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TArray<TSoftClassPtr<class UClass>>           SupportedGameModes;                                // 0x02E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	class FText                                   Author;                                            // 0x02F8(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                   AuthorContact;                                     // 0x0310(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                   RecommendedPlayerCount;                            // 0x0328(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bIsTestLevel;                                      // 0x0340(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVisible;                                          // 0x0341(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_342[0x6];                                      // 0x0342(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNVGPostProcessSettings                NVG_PostProcessOverride;                           // 0x0348(0x0058)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector                                MVPSequenceLocation;                               // 0x03A0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TSoftClassPtr<class UClass>>           Objectives;                                        // 0x03B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<TSoftClassPtr<class UClass>>           Challenges;                                        // 0x03C8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	class FText                                   LevelLocationText;                                 // 0x03D8(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   LevelMonthNum;                                     // 0x03F0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   LevelDayNum;                                       // 0x0408(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   LevelYearNum;                                      // 0x0420(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FMissionAudio                          TocBriefingAudio;                                  // 0x0438(0x0060)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TArray<struct FMissionAudio>                  MissionAudio;                                      // 0x0498(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FMissionDoc>                    Documents;                                         // 0x04A8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FMissionPhoto>                  Photos;                                            // 0x04B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	class FName                                   MissionStartTocVoiceLine;                          // 0x04C8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FCharacterBio>                  SuspectsBios;                                      // 0x04D0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCharacterBio>                  CiviliansBios;                                     // 0x04E0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FMissionTimeline                       MissionTimeline;                                   // 0x04F0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	int32                                         BaseSquadPts;                                      // 0x0500(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_504[0x4];                                      // 0x0504(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FLevelFloorData>                MapFloors;                                         // 0x0508(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	struct FSpawnPoints                           Spawn_1;                                           // 0x0518(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	struct FSpawnPoints                           Spawn_2;                                           // 0x05B8(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	struct FSpawnPoints                           Spawn_3;                                           // 0x0658(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	struct FSpawnPoints                           Spawn_4;                                           // 0x06F8(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FAIRoster>                      AISpawnRosters;                                    // 0x0798(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FDynamicLevelRoster>            DynamicLevelSpawnRosters;                          // 0x07A8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FTrapRoster>                    TrapRosters;                                       // 0x07B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FPersonnelMapPoint>             AllPersonnelMapPoints;                             // 0x07C8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FPersonnelEntry>                AllPersonnel;                                      // 0x07D8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FLevelDeployableData>           Deployables;                                       // 0x07E8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FLevelDeployableDepot>          DeployableDepots;                                  // 0x07F8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<class UStaticMesh*>                    PropHuntMeshes;                                    // 0x0808(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLevelDataLookupTable) == 0x000008, "Wrong alignment on FLevelDataLookupTable");
static_assert(sizeof(FLevelDataLookupTable) == 0x000818, "Wrong size on FLevelDataLookupTable");
...
static_assert(offsetof(FLevelDataLookupTable, WorldInformation) == 0x0000D8, "Member 'FLevelDataLookupTable::WorldInformation' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, DefaultFloorIndex) == 0x000110, "Member 'FLevelDataLookupTable::DefaultFloorIndex' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Floors) == 0x000118, "Member 'FLevelDataLookupTable::Floors' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, DefaultSpawnTag) == 0x000128, "Member 'FLevelDataLookupTable::DefaultSpawnTag' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, EntryPoints) == 0x000130, "Member 'FLevelDataLookupTable::EntryPoints' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, TabletScreenBrightness) == 0x000140, "Member 'FLevelDataLookupTable::TabletScreenBrightness' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MinEV100) == 0x000148, "Member 'FLevelDataLookupTable::MinEV100' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MaxEV100) == 0x00014C, "Member 'FLevelDataLookupTable::MaxEV100' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, COOPModesLevelMap) == 0x000150, "Member 'FLevelDataLookupTable::COOPModesLevelMap' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, COOPModesLevelAdditionalMaps) == 0x0001A0, "Member 'FLevelDataLookupTable::COOPModesLevelAdditionalMaps' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, UnlockRequirements) == 0x0001F0, "Member 'FLevelDataLookupTable::UnlockRequirements' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MapLayout) == 0x000208, "Member 'FLevelDataLookupTable::MapLayout' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, LoadingScreen) == 0x000298, "Member 'FLevelDataLookupTable::LoadingScreen' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, SupportedGameModes) == 0x0002E8, "Member 'FLevelDataLookupTable::SupportedGameModes' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Author) == 0x0002F8, "Member 'FLevelDataLookupTable::Author' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, AuthorContact) == 0x000310, "Member 'FLevelDataLookupTable::AuthorContact' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, RecommendedPlayerCount) == 0x000328, "Member 'FLevelDataLookupTable::RecommendedPlayerCount' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, bIsTestLevel) == 0x000340, "Member 'FLevelDataLookupTable::bIsTestLevel' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, bVisible) == 0x000341, "Member 'FLevelDataLookupTable::bVisible' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, NVG_PostProcessOverride) == 0x000348, "Member 'FLevelDataLookupTable::NVG_PostProcessOverride' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MVPSequenceLocation) == 0x0003A0, "Member 'FLevelDataLookupTable::MVPSequenceLocation' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Objectives) == 0x0003B8, "Member 'FLevelDataLookupTable::Objectives' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Challenges) == 0x0003C8, "Member 'FLevelDataLookupTable::Challenges' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, LevelLocationText) == 0x0003D8, "Member 'FLevelDataLookupTable::LevelLocationText' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, LevelMonthNum) == 0x0003F0, "Member 'FLevelDataLookupTable::LevelMonthNum' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, LevelDayNum) == 0x000408, "Member 'FLevelDataLookupTable::LevelDayNum' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, LevelYearNum) == 0x000420, "Member 'FLevelDataLookupTable::LevelYearNum' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, TocBriefingAudio) == 0x000438, "Member 'FLevelDataLookupTable::TocBriefingAudio' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MissionAudio) == 0x000498, "Member 'FLevelDataLookupTable::MissionAudio' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Documents) == 0x0004A8, "Member 'FLevelDataLookupTable::Documents' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Photos) == 0x0004B8, "Member 'FLevelDataLookupTable::Photos' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MissionStartTocVoiceLine) == 0x0004C8, "Member 'FLevelDataLookupTable::MissionStartTocVoiceLine' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, SuspectsBios) == 0x0004D0, "Member 'FLevelDataLookupTable::SuspectsBios' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, CiviliansBios) == 0x0004E0, "Member 'FLevelDataLookupTable::CiviliansBios' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MissionTimeline) == 0x0004F0, "Member 'FLevelDataLookupTable::MissionTimeline' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, BaseSquadPts) == 0x000500, "Member 'FLevelDataLookupTable::BaseSquadPts' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, MapFloors) == 0x000508, "Member 'FLevelDataLookupTable::MapFloors' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Spawn_1) == 0x000518, "Member 'FLevelDataLookupTable::Spawn_1' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Spawn_2) == 0x0005B8, "Member 'FLevelDataLookupTable::Spawn_2' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Spawn_3) == 0x000658, "Member 'FLevelDataLookupTable::Spawn_3' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Spawn_4) == 0x0006F8, "Member 'FLevelDataLookupTable::Spawn_4' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, AISpawnRosters) == 0x000798, "Member 'FLevelDataLookupTable::AISpawnRosters' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, DynamicLevelSpawnRosters) == 0x0007A8, "Member 'FLevelDataLookupTable::DynamicLevelSpawnRosters' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, TrapRosters) == 0x0007B8, "Member 'FLevelDataLookupTable::TrapRosters' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, AllPersonnelMapPoints) == 0x0007C8, "Member 'FLevelDataLookupTable::AllPersonnelMapPoints' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, AllPersonnel) == 0x0007D8, "Member 'FLevelDataLookupTable::AllPersonnel' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, Deployables) == 0x0007E8, "Member 'FLevelDataLookupTable::Deployables' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, DeployableDepots) == 0x0007F8, "Member 'FLevelDataLookupTable::DeployableDepots' has a wrong offset!");
static_assert(offsetof(FLevelDataLookupTable, PropHuntMeshes) == 0x000808, "Member 'FLevelDataLookupTable::PropHuntMeshes' has a wrong offset!");
...
static_assert(alignof(FCyberneticCharacterArrayContainer) == 0x000008, "Wrong alignment on FCyberneticCharacterArrayContainer");
static_assert(sizeof(FCyberneticCharacterArrayContainer) == 0x000010, "Wrong size on FCyberneticCharacterArrayContainer");
static_assert(offsetof(FCyberneticCharacterArrayContainer, MemberArray) == 0x000000, "Member 'FCyberneticCharacterArrayContainer::MemberArray' has a wrong offset!");
...
static_assert(sizeof(FSavedClearPoint) == 0x000050, "Wrong size on FSavedClearPoint");
...
static_assert(offsetof(FSavedClearPoint, Location) == 0x000018, "Member 'FSavedClearPoint::Location' has a wrong offset!");
static_assert(offsetof(FSavedClearPoint, Stage) == 0x000030, "Member 'FSavedClearPoint::Stage' has a wrong offset!");
static_assert(offsetof(FSavedClearPoint, Direction) == 0x000031, "Member 'FSavedClearPoint::Direction' has a wrong offset!");
static_assert(offsetof(FSavedClearPoint, CoverLandmarks) == 0x000038, "Member 'FSavedClearPoint::CoverLandmarks' has a wrong offset!");
static_assert(offsetof(FSavedClearPoint, bHasLineOfSightToDoor) == 0x000048, "Member 'FSavedClearPoint::bHasLineOfSightToDoor' has a wrong offset!");
...
static_assert(alignof(FSavedStackUpActor) == 0x000008, "Wrong alignment on FSavedStackUpActor");
static_assert(sizeof(FSavedStackUpActor) == 0x000038, "Wrong size on FSavedStackUpActor");
static_assert(offsetof(FSavedStackUpActor, Location) == 0x000000, "Member 'FSavedStackUpActor::Location' has a wrong offset!");
static_assert(offsetof(FSavedStackUpActor, Depth) == 0x000018, "Member 'FSavedStackUpActor::Depth' has a wrong offset!");
static_assert(offsetof(FSavedStackUpActor, StackUpPosition) == 0x000019, "Member 'FSavedStackUpActor::StackUpPosition' has a wrong offset!");
static_assert(offsetof(FSavedStackUpActor, LinkedDoorID) == 0x000020, "Member 'FSavedStackUpActor::LinkedDoorID' has a wrong offset!");
...
static_assert(sizeof(FSavedDoorActor) == 0x0000F0, "Wrong size on FSavedDoorActor");
static_assert(offsetof(FSavedDoorActor, UniqueID) == 0x000000, "Member 'FSavedDoorActor::UniqueID' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, FrontDoorThreat) == 0x000018, "Member 'FSavedDoorActor::FrontDoorThreat' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, BackDoorThreat) == 0x000030, "Member 'FSavedDoorActor::BackDoorThreat' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, FrontLeftClearPoints) == 0x000048, "Member 'FSavedDoorActor::FrontLeftClearPoints' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, FrontRightClearPoints) == 0x000058, "Member 'FSavedDoorActor::FrontRightClearPoints' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, BackLeftClearPoints) == 0x000068, "Member 'FSavedDoorActor::BackLeftClearPoints' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, BackRightClearPoints) == 0x000078, "Member 'FSavedDoorActor::BackRightClearPoints' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, FrontThreats) == 0x000088, "Member 'FSavedDoorActor::FrontThreats' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, BackThreats) == 0x000098, "Member 'FSavedDoorActor::BackThreats' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, FrontLeftStackups) == 0x0000A8, "Member 'FSavedDoorActor::FrontLeftStackups' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, FrontRightStackups) == 0x0000B8, "Member 'FSavedDoorActor::FrontRightStackups' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, BackLeftStackups) == 0x0000C8, "Member 'FSavedDoorActor::BackLeftStackups' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, BackRightStackups) == 0x0000D8, "Member 'FSavedDoorActor::BackRightStackups' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, FrontRoomPosition) == 0x0000E8, "Member 'FSavedDoorActor::FrontRoomPosition' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, BackRoomPosition) == 0x0000E9, "Member 'FSavedDoorActor::BackRoomPosition' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, bHasFrame) == 0x0000EA, "Member 'FSavedDoorActor::bHasFrame' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, bCanIssueOrdersOnFrontSide) == 0x0000EB, "Member 'FSavedDoorActor::bCanIssueOrdersOnFrontSide' has a wrong offset!");
static_assert(offsetof(FSavedDoorActor, bCanIssueOrdersOnBackSide) == 0x0000EC, "Member 'FSavedDoorActor::bCanIssueOrdersOnBackSide' has a wrong offset!");
...
static_assert(alignof(FPlanningMarker) == 0x000008, "Wrong alignment on FPlanningMarker");
static_assert(sizeof(FPlanningMarker) == 0x000030, "Wrong size on FPlanningMarker");
...
static_assert(offsetof(FPlanningMarker, Floor) == 0x000020, "Member 'FPlanningMarker::Floor' has a wrong offset!");
static_assert(offsetof(FPlanningMarker, Style) == 0x000024, "Member 'FPlanningMarker::Style' has a wrong offset!");
static_assert(offsetof(FPlanningMarker, Rotation) == 0x00002C, "Member 'FPlanningMarker::Rotation' has a wrong offset!");
...
static_assert(alignof(FPingData) == 0x000010, "Wrong alignment on FPingData");
static_assert(sizeof(FPingData) == 0x0000F0, "Wrong size on FPingData");
static_assert(offsetof(FPingData, IconBrush) == 0x000000, "Member 'FPingData::IconBrush' has a wrong offset!");
static_assert(offsetof(FPingData, PingText) == 0x0000D0, "Member 'FPingData::PingText' has a wrong offset!");
static_assert(offsetof(FPingData, Duration) == 0x0000E8, "Member 'FPingData::Duration' has a wrong offset!");
...
static_assert(sizeof(FScriptedLookAt) == 0x000028, "Wrong size on FScriptedLookAt");
...
static_assert(offsetof(FScriptedLookAt, TimeRemaining) == 0x000020, "Member 'FScriptedLookAt::TimeRemaining' has a wrong offset!");
...
public:
	...
	EItemWheelCategory                            SubOptionCategory;                                 // 0x000C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EItemWheelCategory                            SubOptionOf;                                       // 0x000D(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateBrush                            Icon;                                              // 0x0010(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(alignof(FItemWheelOption) == 0x000010, "Wrong alignment on FItemWheelOption");
static_assert(sizeof(FItemWheelOption) == 0x0000F0, "Wrong size on FItemWheelOption");
static_assert(offsetof(FItemWheelOption, ItemID) == 0x000000, "Member 'FItemWheelOption::ItemID' has a wrong offset!");
static_assert(offsetof(FItemWheelOption, OptionID) == 0x000001, "Member 'FItemWheelOption::OptionID' has a wrong offset!");
static_assert(offsetof(FItemWheelOption, Name) == 0x000004, "Member 'FItemWheelOption::Name' has a wrong offset!");
static_assert(offsetof(FItemWheelOption, SubOptionCategory) == 0x00000C, "Member 'FItemWheelOption::SubOptionCategory' has a wrong offset!");
static_assert(offsetof(FItemWheelOption, SubOptionOf) == 0x00000D, "Member 'FItemWheelOption::SubOptionOf' has a wrong offset!");
static_assert(offsetof(FItemWheelOption, Icon) == 0x000010, "Member 'FItemWheelOption::Icon' has a wrong offset!");
static_assert(offsetof(FItemWheelOption, bEnabled) == 0x0000E0, "Member 'FItemWheelOption::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FScriptedFireAt) == 0x000038, "Wrong size on FScriptedFireAt");
...
static_assert(offsetof(FScriptedFireAt, TimeRemaining) == 0x000020, "Member 'FScriptedFireAt::TimeRemaining' has a wrong offset!");
static_assert(offsetof(FScriptedFireAt, bOverrideTargetedEnemy) == 0x000024, "Member 'FScriptedFireAt::bOverrideTargetedEnemy' has a wrong offset!");
static_assert(offsetof(FScriptedFireAt, AccuracyPenaltyMultiplier) == 0x000028, "Member 'FScriptedFireAt::AccuracyPenaltyMultiplier' has a wrong offset!");
static_assert(offsetof(FScriptedFireAt, FireAngleThreshold) == 0x00002C, "Member 'FScriptedFireAt::FireAngleThreshold' has a wrong offset!");
static_assert(offsetof(FScriptedFireAt, bInfiniteAmmo) == 0x000030, "Member 'FScriptedFireAt::bInfiniteAmmo' has a wrong offset!");
...
static_assert(alignof(FCompatibleItemsArray) == 0x000008, "Wrong alignment on FCompatibleItemsArray");
static_assert(sizeof(FCompatibleItemsArray) == 0x000010, "Wrong size on FCompatibleItemsArray");
static_assert(offsetof(FCompatibleItemsArray, CompatibleItems) == 0x000000, "Member 'FCompatibleItemsArray::CompatibleItems' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 UniqueNetIdStr;                                    // 0x0048(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_58[0x10];                                      // 0x0058(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bRunningSameGame;                                  // 0x0068(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasVoice;                                         // 0x0069(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bJoinable;                                         // 0x006A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B[0x5];                                       // 0x006B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AvatarUrl;                                         // 0x0070(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFriend) == 0x0001A0, "Wrong size on FFriend");
...
static_assert(offsetof(FFriend, UniqueNetIdStr) == 0x000048, "Member 'FFriend::UniqueNetIdStr' has a wrong offset!");
static_assert(offsetof(FFriend, bRunningSameGame) == 0x000068, "Member 'FFriend::bRunningSameGame' has a wrong offset!");
static_assert(offsetof(FFriend, bHasVoice) == 0x000069, "Member 'FFriend::bHasVoice' has a wrong offset!");
static_assert(offsetof(FFriend, bJoinable) == 0x00006A, "Member 'FFriend::bJoinable' has a wrong offset!");
static_assert(offsetof(FFriend, AvatarUrl) == 0x000070, "Member 'FFriend::AvatarUrl' has a wrong offset!");
...
static_assert(alignof(FSharedTeamData) == 0x000008, "Wrong alignment on FSharedTeamData");
static_assert(sizeof(FSharedTeamData) == 0x000048, "Wrong size on FSharedTeamData");
...
static_assert(offsetof(FSharedTeamData, PreviousCommandLocation) == 0x000028, "Member 'FSharedTeamData::PreviousCommandLocation' has a wrong offset!");
static_assert(offsetof(FSharedTeamData, CommandTeam) == 0x000040, "Member 'FSharedTeamData::CommandTeam' has a wrong offset!");
static_assert(offsetof(FSharedTeamData, NumInTeam) == 0x000041, "Member 'FSharedTeamData::NumInTeam' has a wrong offset!");
...
static_assert(sizeof(FRoNStyleTurnData) == 0x000050, "Wrong size on FRoNStyleTurnData");
static_assert(offsetof(FRoNStyleTurnData, AimOffset) == 0x000000, "Member 'FRoNStyleTurnData::AimOffset' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, AO_BS) == 0x000008, "Member 'FRoNStyleTurnData::AO_BS' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn45_Left) == 0x000010, "Member 'FRoNStyleTurnData::Turn45_Left' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn45_Right) == 0x000018, "Member 'FRoNStyleTurnData::Turn45_Right' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn90_Left) == 0x000020, "Member 'FRoNStyleTurnData::Turn90_Left' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn90_Right) == 0x000028, "Member 'FRoNStyleTurnData::Turn90_Right' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn180_Left) == 0x000030, "Member 'FRoNStyleTurnData::Turn180_Left' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn180_Right) == 0x000038, "Member 'FRoNStyleTurnData::Turn180_Right' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn135_Left) == 0x000040, "Member 'FRoNStyleTurnData::Turn135_Left' has a wrong offset!");
static_assert(offsetof(FRoNStyleTurnData, Turn135_Right) == 0x000048, "Member 'FRoNStyleTurnData::Turn135_Right' has a wrong offset!");
...
static_assert(sizeof(FRoNStyleSlotData) == 0x000258, "Wrong size on FRoNStyleSlotData");
...
static_assert(offsetof(FRoNStyleSlotData, TransitionData) == 0x000060, "Member 'FRoNStyleSlotData::TransitionData' has a wrong offset!");
static_assert(offsetof(FRoNStyleSlotData, LocomotionData) == 0x000180, "Member 'FRoNStyleSlotData::LocomotionData' has a wrong offset!");
static_assert(offsetof(FRoNStyleSlotData, IdleReference) == 0x000240, "Member 'FRoNStyleSlotData::IdleReference' has a wrong offset!");
static_assert(offsetof(FRoNStyleSlotData, StrafeBSData) == 0x000248, "Member 'FRoNStyleSlotData::StrafeBSData' has a wrong offset!");
static_assert(offsetof(FRoNStyleSlotData, NonStrafeBSData) == 0x000250, "Member 'FRoNStyleSlotData::NonStrafeBSData' has a wrong offset!");
...
static_assert(sizeof(FCoverInstigatorStimulus) == 0x000080, "Wrong size on FCoverInstigatorStimulus");
...
static_assert(sizeof(FSavedExitRoute) == 0x000040, "Wrong size on FSavedExitRoute");
static_assert(offsetof(FSavedExitRoute, Location) == 0x000000, "Member 'FSavedExitRoute::Location' has a wrong offset!");
static_assert(offsetof(FSavedExitRoute, PathCost) == 0x000018, "Member 'FSavedExitRoute::PathCost' has a wrong offset!");
static_assert(offsetof(FSavedExitRoute, Doors) == 0x000020, "Member 'FSavedExitRoute::Doors' has a wrong offset!");
static_assert(offsetof(FSavedExitRoute, ThreatsOnRoute) == 0x000030, "Member 'FSavedExitRoute::ThreatsOnRoute' has a wrong offset!");
...
static_assert(sizeof(FSavedExitData) == 0x000028, "Wrong size on FSavedExitData");
static_assert(offsetof(FSavedExitData, Location) == 0x000000, "Member 'FSavedExitData::Location' has a wrong offset!");
static_assert(offsetof(FSavedExitData, PossibleRoutes) == 0x000018, "Member 'FSavedExitData::PossibleRoutes' has a wrong offset!");
...
static_assert(alignof(FSavedSwatLookAtPoint) == 0x000008, "Wrong alignment on FSavedSwatLookAtPoint");
static_assert(sizeof(FSavedSwatLookAtPoint) == 0x000028, "Wrong size on FSavedSwatLookAtPoint");
static_assert(offsetof(FSavedSwatLookAtPoint, Location) == 0x000000, "Member 'FSavedSwatLookAtPoint::Location' has a wrong offset!");
static_assert(offsetof(FSavedSwatLookAtPoint, LinkedDoorID) == 0x000010, "Member 'FSavedSwatLookAtPoint::LinkedDoorID' has a wrong offset!");
...
static_assert(sizeof(FSavedThreatAwarenessActor) == 0x0000A8, "Wrong size on FSavedThreatAwarenessActor");
...
static_assert(offsetof(FSavedThreatAwarenessActor, Location) == 0x000018, "Member 'FSavedThreatAwarenessActor::Location' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, ThreatLevel) == 0x000030, "Member 'FSavedThreatAwarenessActor::ThreatLevel' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, Exits) == 0x000038, "Member 'FSavedThreatAwarenessActor::Exits' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, UniqueExits) == 0x000048, "Member 'FSavedThreatAwarenessActor::UniqueExits' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, OwningRoom) == 0x000058, "Member 'FSavedThreatAwarenessActor::OwningRoom' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, Door) == 0x000068, "Member 'FSavedThreatAwarenessActor::Door' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, bFrontDoorThreat) == 0x000080, "Member 'FSavedThreatAwarenessActor::bFrontDoorThreat' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, bIsOutside) == 0x000081, "Member 'FSavedThreatAwarenessActor::bIsOutside' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, SwatLookAtPoints) == 0x000088, "Member 'FSavedThreatAwarenessActor::SwatLookAtPoints' has a wrong offset!");
static_assert(offsetof(FSavedThreatAwarenessActor, PathableThreats) == 0x000098, "Member 'FSavedThreatAwarenessActor::PathableThreats' has a wrong offset!");
...
static_assert(sizeof(FBuildingFloor) == 0x000050, "Wrong size on FBuildingFloor");
...
static_assert(offsetof(FBuildingFloor, Extent) == 0x000020, "Member 'FBuildingFloor::Extent' has a wrong offset!");
static_assert(offsetof(FBuildingFloor, Name) == 0x000038, "Member 'FBuildingFloor::Name' has a wrong offset!");
...
static_assert(sizeof(FItemChangeRequest) == 0x000038, "Wrong size on FItemChangeRequest");
...
static_assert(offsetof(FItemChangeRequest, FromItemName) == 0x000018, "Member 'FItemChangeRequest::FromItemName' has a wrong offset!");
static_assert(offsetof(FItemChangeRequest, ToItem) == 0x000020, "Member 'FItemChangeRequest::ToItem' has a wrong offset!");
static_assert(offsetof(FItemChangeRequest, ToItemName) == 0x000028, "Member 'FItemChangeRequest::ToItemName' has a wrong offset!");
static_assert(offsetof(FItemChangeRequest, bInstant) == 0x000030, "Member 'FItemChangeRequest::bInstant' has a wrong offset!");
static_assert(offsetof(FItemChangeRequest, bNoDraw) == 0x000031, "Member 'FItemChangeRequest::bNoDraw' has a wrong offset!");
static_assert(offsetof(FItemChangeRequest, bIsComplete) == 0x000032, "Member 'FItemChangeRequest::bIsComplete' has a wrong offset!");
...
static_assert(sizeof(FSpawnedGear) == 0x000088, "Wrong size on FSpawnedGear");
...
static_assert(offsetof(FSpawnedGear, HelmetMount) == 0x000030, "Member 'FSpawnedGear::HelmetMount' has a wrong offset!");
static_assert(offsetof(FSpawnedGear, Facewear) == 0x000038, "Member 'FSpawnedGear::Facewear' has a wrong offset!");
static_assert(offsetof(FSpawnedGear, RandomGear) == 0x000040, "Member 'FSpawnedGear::RandomGear' has a wrong offset!");
static_assert(offsetof(FSpawnedGear, Character) == 0x000048, "Member 'FSpawnedGear::Character' has a wrong offset!");
static_assert(offsetof(FSpawnedGear, LongTactical) == 0x000050, "Member 'FSpawnedGear::LongTactical' has a wrong offset!");
static_assert(offsetof(FSpawnedGear, Grenades) == 0x000058, "Member 'FSpawnedGear::Grenades' has a wrong offset!");
static_assert(offsetof(FSpawnedGear, TacticalDevices) == 0x000068, "Member 'FSpawnedGear::TacticalDevices' has a wrong offset!");
static_assert(offsetof(FSpawnedGear, Miscelaneous) == 0x000078, "Member 'FSpawnedGear::Miscelaneous' has a wrong offset!");
...
public:
	...
	class UObject*                                Object;                                            // 0x0038(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGraphNode) == 0x000070, "Wrong size on FGraphNode");
static_assert(offsetof(FGraphNode, Object) == 0x000038, "Member 'FGraphNode::Object' has a wrong offset!");
...
static_assert(sizeof(FLobbyPlayer) == 0x000070, "Wrong size on FLobbyPlayer");
...
static_assert(offsetof(FLobbyPlayer, AvatarUrl) == 0x000058, "Member 'FLobbyPlayer::AvatarUrl' has a wrong offset!");
static_assert(offsetof(FLobbyPlayer, bIsLeader) == 0x000068, "Member 'FLobbyPlayer::bIsLeader' has a wrong offset!");
...
static_assert(sizeof(FLoadoutPreset) == 0x0002F0, "Wrong size on FLoadoutPreset");
...
static_assert(sizeof(FQueuedSwatCommand) == 0x000148, "Wrong size on FQueuedSwatCommand");
...
static_assert(sizeof(FReplayEvent) == 0x000038, "Wrong size on FReplayEvent");
static_assert(offsetof(FReplayEvent, EventType) == 0x000000, "Member 'FReplayEvent::EventType' has a wrong offset!");
static_assert(offsetof(FReplayEvent, Location) == 0x000008, "Member 'FReplayEvent::Location' has a wrong offset!");
static_assert(offsetof(FReplayEvent, AdditionalInformation) == 0x000020, "Member 'FReplayEvent::AdditionalInformation' has a wrong offset!");
static_assert(offsetof(FReplayEvent, Timestamp) == 0x000030, "Member 'FReplayEvent::Timestamp' has a wrong offset!");
...
static_assert(alignof(FTrackingCameraInitStruct) == 0x000004, "Wrong alignment on FTrackingCameraInitStruct");
static_assert(sizeof(FTrackingCameraInitStruct) == 0x00000C, "Wrong size on FTrackingCameraInitStruct");
static_assert(offsetof(FTrackingCameraInitStruct, bCameraEnabled) == 0x000000, "Member 'FTrackingCameraInitStruct::bCameraEnabled' has a wrong offset!");
static_assert(offsetof(FTrackingCameraInitStruct, bZoomWhenTracking) == 0x000001, "Member 'FTrackingCameraInitStruct::bZoomWhenTracking' has a wrong offset!");
static_assert(offsetof(FTrackingCameraInitStruct, DefaultFOV) == 0x000004, "Member 'FTrackingCameraInitStruct::DefaultFOV' has a wrong offset!");
static_assert(offsetof(FTrackingCameraInitStruct, ZoomedFOV) == 0x000008, "Member 'FTrackingCameraInitStruct::ZoomedFOV' has a wrong offset!");
...
{
public:
	TSubclassOf<class ABaseItem>                  Primary;                                           // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          PrimaryScope;                                      // 0x0008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          PrimaryMuzzle;                                     // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          PrimaryUnderbarrel;                                // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          PrimaryOverbarrel;                                 // 0x0020(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          PrimaryStock;                                      // 0x0028(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          PrimaryGrip;                                       // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          PrimaryIlluminator;                                // 0x0038(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PrimaryAmmoSlotsCount;                             // 0x0040(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   PrimaryAmmoType;                                   // 0x0044(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class ABaseItem>                  Secondary;                                         // 0x0050(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          SecondaryScope;                                    // 0x0058(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          SecondaryMuzzle;                                   // 0x0060(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          SecondaryUnderbarrel;                              // 0x0068(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          SecondaryOverbarrel;                               // 0x0070(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          SecondaryStock;                                    // 0x0078(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          SecondaryGrip;                                     // 0x0080(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWeaponAttachment>          SecondaryIlluminator;                              // 0x0088(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SecondaryAmmoSlotsCount;                           // 0x0090(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SecondaryAmmoType;                                 // 0x0094(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class ABaseItem>                  MeleeWeapon;                                       // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSavedWeaponLoadout) == 0x000008, "Wrong alignment on FSavedWeaponLoadout");
static_assert(sizeof(FSavedWeaponLoadout) == 0x0000A8, "Wrong size on FSavedWeaponLoadout");
static_assert(offsetof(FSavedWeaponLoadout, Primary) == 0x000000, "Member 'FSavedWeaponLoadout::Primary' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryScope) == 0x000008, "Member 'FSavedWeaponLoadout::PrimaryScope' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryMuzzle) == 0x000010, "Member 'FSavedWeaponLoadout::PrimaryMuzzle' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryUnderbarrel) == 0x000018, "Member 'FSavedWeaponLoadout::PrimaryUnderbarrel' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryOverbarrel) == 0x000020, "Member 'FSavedWeaponLoadout::PrimaryOverbarrel' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryStock) == 0x000028, "Member 'FSavedWeaponLoadout::PrimaryStock' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryGrip) == 0x000030, "Member 'FSavedWeaponLoadout::PrimaryGrip' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryIlluminator) == 0x000038, "Member 'FSavedWeaponLoadout::PrimaryIlluminator' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryAmmoSlotsCount) == 0x000040, "Member 'FSavedWeaponLoadout::PrimaryAmmoSlotsCount' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, PrimaryAmmoType) == 0x000044, "Member 'FSavedWeaponLoadout::PrimaryAmmoType' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, Secondary) == 0x000050, "Member 'FSavedWeaponLoadout::Secondary' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryScope) == 0x000058, "Member 'FSavedWeaponLoadout::SecondaryScope' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryMuzzle) == 0x000060, "Member 'FSavedWeaponLoadout::SecondaryMuzzle' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryUnderbarrel) == 0x000068, "Member 'FSavedWeaponLoadout::SecondaryUnderbarrel' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryOverbarrel) == 0x000070, "Member 'FSavedWeaponLoadout::SecondaryOverbarrel' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryStock) == 0x000078, "Member 'FSavedWeaponLoadout::SecondaryStock' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryGrip) == 0x000080, "Member 'FSavedWeaponLoadout::SecondaryGrip' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryIlluminator) == 0x000088, "Member 'FSavedWeaponLoadout::SecondaryIlluminator' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryAmmoSlotsCount) == 0x000090, "Member 'FSavedWeaponLoadout::SecondaryAmmoSlotsCount' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, SecondaryAmmoType) == 0x000094, "Member 'FSavedWeaponLoadout::SecondaryAmmoType' has a wrong offset!");
static_assert(offsetof(FSavedWeaponLoadout, MeleeWeapon) == 0x0000A0, "Member 'FSavedWeaponLoadout::MeleeWeapon' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  AllowedSquadsActivityRoles;                        // 0x0078(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FAIMoveDataBlock                       DefaultMoveData;                                   // 0x0098(0x0098)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FAIMovementStyleData                   MovementStyle;                                     // 0x0130(0x0048)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FSavedWeaponLoadout>            WeaponLoadouts;                                    // 0x0178(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bUseRandomLoadout;                                 // 0x0188(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_189[0x7];                                      // 0x0189(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class ABaseItem>>          AIWeaponSelection;                                 // 0x0190(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class FName>                           AIAmmoTypeSelection;                               // 0x01A0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         ChanceToFireGunOnDeath;                            // 0x01B0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           AIBodyArmourSelection;                             // 0x01B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           AIHelmetSelection;                                 // 0x01C8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TSubclassOf<class ASuspectArmour>             AIBodyArmourOverride;                              // 0x01D8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSavedLoadout                          DefaultLoadout;                                    // 0x01E0(0x02E8)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	ETeamType                                     SpawningTeamType;                                  // 0x04C8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C9[0x7];                                      // 0x04C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class ACyberneticCharacter>       CharacterClass;                                    // 0x04D0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FCharacterMesh>                 RandomCharacterMesh;                               // 0x04D8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         bOverrideControllerClass : 1;                      // 0x04E8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_4E9[0x7];                                      // 0x04E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class AAIController>              ControllerClass;                                   // 0x04F0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           Tags;                                              // 0x04F8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bChanceToSurrenderWithItem : 1;                    // 0x0508(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideSurrenderWithItemChance : 1;              // 0x0508(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_509[0x3];                                      // 0x0509(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SurrenderWithItemChance;                           // 0x050C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         SurrenderItems;                                    // 0x0510(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bCanEverSuicide;                                   // 0x0520(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideSuicideChance;                            // 0x0521(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_522[0x2];                                      // 0x0522(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SuicideChance;                                     // 0x0524(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bImmuneToGas;                                      // 0x0528(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideHealth;                                   // 0x0529(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_52A[0x2];                                      // 0x052A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Health;                                            // 0x052C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideSuspectAccuracy;                          // 0x0530(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_531[0x3];                                      // 0x0531(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SuspectAccuracy;                                   // 0x0534(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideShrinkAccuracyConeAtRangeScale;           // 0x0538(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_539[0x3];                                      // 0x0539(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ShrinkAccuracyConeAtRangeScale;                    // 0x053C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideStressUntilWeaponRaise;                   // 0x0540(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_541[0x3];                                      // 0x0541(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StressUntilWeaponRaise;                            // 0x0544(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAIDataLookupTable) == 0x000008, "Wrong alignment on FAIDataLookupTable");
static_assert(sizeof(FAIDataLookupTable) == 0x000548, "Wrong size on FAIDataLookupTable");
...
static_assert(offsetof(FAIDataLookupTable, AllowedSquadsActivityRoles) == 0x000078, "Member 'FAIDataLookupTable::AllowedSquadsActivityRoles' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, DefaultMoveData) == 0x000098, "Member 'FAIDataLookupTable::DefaultMoveData' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, MovementStyle) == 0x000130, "Member 'FAIDataLookupTable::MovementStyle' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, WeaponLoadouts) == 0x000178, "Member 'FAIDataLookupTable::WeaponLoadouts' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bUseRandomLoadout) == 0x000188, "Member 'FAIDataLookupTable::bUseRandomLoadout' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, AIWeaponSelection) == 0x000190, "Member 'FAIDataLookupTable::AIWeaponSelection' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, AIAmmoTypeSelection) == 0x0001A0, "Member 'FAIDataLookupTable::AIAmmoTypeSelection' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, ChanceToFireGunOnDeath) == 0x0001B0, "Member 'FAIDataLookupTable::ChanceToFireGunOnDeath' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, AIBodyArmourSelection) == 0x0001B8, "Member 'FAIDataLookupTable::AIBodyArmourSelection' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, AIHelmetSelection) == 0x0001C8, "Member 'FAIDataLookupTable::AIHelmetSelection' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, AIBodyArmourOverride) == 0x0001D8, "Member 'FAIDataLookupTable::AIBodyArmourOverride' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, DefaultLoadout) == 0x0001E0, "Member 'FAIDataLookupTable::DefaultLoadout' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, SpawningTeamType) == 0x0004C8, "Member 'FAIDataLookupTable::SpawningTeamType' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, CharacterClass) == 0x0004D0, "Member 'FAIDataLookupTable::CharacterClass' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, RandomCharacterMesh) == 0x0004D8, "Member 'FAIDataLookupTable::RandomCharacterMesh' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, ControllerClass) == 0x0004F0, "Member 'FAIDataLookupTable::ControllerClass' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, Tags) == 0x0004F8, "Member 'FAIDataLookupTable::Tags' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, SurrenderWithItemChance) == 0x00050C, "Member 'FAIDataLookupTable::SurrenderWithItemChance' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, SurrenderItems) == 0x000510, "Member 'FAIDataLookupTable::SurrenderItems' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bCanEverSuicide) == 0x000520, "Member 'FAIDataLookupTable::bCanEverSuicide' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bOverrideSuicideChance) == 0x000521, "Member 'FAIDataLookupTable::bOverrideSuicideChance' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, SuicideChance) == 0x000524, "Member 'FAIDataLookupTable::SuicideChance' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bImmuneToGas) == 0x000528, "Member 'FAIDataLookupTable::bImmuneToGas' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bOverrideHealth) == 0x000529, "Member 'FAIDataLookupTable::bOverrideHealth' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, Health) == 0x00052C, "Member 'FAIDataLookupTable::Health' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bOverrideSuspectAccuracy) == 0x000530, "Member 'FAIDataLookupTable::bOverrideSuspectAccuracy' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, SuspectAccuracy) == 0x000534, "Member 'FAIDataLookupTable::SuspectAccuracy' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bOverrideShrinkAccuracyConeAtRangeScale) == 0x000538, "Member 'FAIDataLookupTable::bOverrideShrinkAccuracyConeAtRangeScale' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, ShrinkAccuracyConeAtRangeScale) == 0x00053C, "Member 'FAIDataLookupTable::ShrinkAccuracyConeAtRangeScale' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, bOverrideStressUntilWeaponRaise) == 0x000540, "Member 'FAIDataLookupTable::bOverrideStressUntilWeaponRaise' has a wrong offset!");
static_assert(offsetof(FAIDataLookupTable, StressUntilWeaponRaise) == 0x000544, "Member 'FAIDataLookupTable::StressUntilWeaponRaise' has a wrong offset!");
...
static_assert(sizeof(FSpawnData) == 0x000098, "Wrong size on FSpawnData");
...
static_assert(offsetof(FSpawnData, SquadName) == 0x000018, "Member 'FSpawnData::SquadName' has a wrong offset!");
static_assert(offsetof(FSpawnData, SquadRules) == 0x000020, "Member 'FSpawnData::SquadRules' has a wrong offset!");
static_assert(offsetof(FSpawnData, bForceNoWeapon) == 0x000028, "Member 'FSpawnData::bForceNoWeapon' has a wrong offset!");
static_assert(offsetof(FSpawnData, bDeactivated) == 0x000029, "Member 'FSpawnData::bDeactivated' has a wrong offset!");
static_assert(offsetof(FSpawnData, ForceWeaponOverride) == 0x000030, "Member 'FSpawnData::ForceWeaponOverride' has a wrong offset!");
static_assert(offsetof(FSpawnData, ForceBodyArmourOverride) == 0x000038, "Member 'FSpawnData::ForceBodyArmourOverride' has a wrong offset!");
static_assert(offsetof(FSpawnData, SpawnWithTags) == 0x000040, "Member 'FSpawnData::SpawnWithTags' has a wrong offset!");
static_assert(offsetof(FSpawnData, ActivityRouteCollection) == 0x000050, "Member 'FSpawnData::ActivityRouteCollection' has a wrong offset!");
static_assert(offsetof(FSpawnData, SpawnInLandmark) == 0x000070, "Member 'FSpawnData::SpawnInLandmark' has a wrong offset!");
...
static_assert(alignof(FWorldActionDescription) == 0x000001, "Wrong alignment on FWorldActionDescription");
static_assert(sizeof(FWorldActionDescription) == 0x000001, "Wrong size on FWorldActionDescription");
...
static_assert(alignof(FPredictionResult) == 0x000008, "Wrong alignment on FPredictionResult");
static_assert(sizeof(FPredictionResult) == 0x000030, "Wrong size on FPredictionResult");
static_assert(offsetof(FPredictionResult, Location) == 0x000000, "Member 'FPredictionResult::Location' has a wrong offset!");
static_assert(offsetof(FPredictionResult, Distance) == 0x000018, "Member 'FPredictionResult::Distance' has a wrong offset!");
static_assert(offsetof(FPredictionResult, DistanceAbsolute) == 0x00001C, "Member 'FPredictionResult::DistanceAbsolute' has a wrong offset!");
static_assert(offsetof(FPredictionResult, Time) == 0x000020, "Member 'FPredictionResult::Time' has a wrong offset!");
static_assert(offsetof(FPredictionResult, Speed) == 0x000024, "Member 'FPredictionResult::Speed' has a wrong offset!");
static_assert(offsetof(FPredictionResult, YawAngle) == 0x000028, "Member 'FPredictionResult::YawAngle' has a wrong offset!");
...
static_assert(alignof(FRonInputKeyGamePadIconTable) == 0x000010, "Wrong alignment on FRonInputKeyGamePadIconTable");
static_assert(sizeof(FRonInputKeyGamePadIconTable) == 0x0001B0, "Wrong size on FRonInputKeyGamePadIconTable");
static_assert(offsetof(FRonInputKeyGamePadIconTable, PS5) == 0x000010, "Member 'FRonInputKeyGamePadIconTable::PS5' has a wrong offset!");
static_assert(offsetof(FRonInputKeyGamePadIconTable, XSX) == 0x0000E0, "Member 'FRonInputKeyGamePadIconTable::XSX' has a wrong offset!");
...
public:
	...
	float                                         VelocityYawDeltaNorth;                             // 0x00CC(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VelocityYawDeltaEast;                              // 0x00D0(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VelocityYawDeltaSouth;                             // 0x00D4(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VelocityYawDeltaWest;                              // 0x00D8(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Distance2DTraveledSinceLastUpdate;                 // 0x00DC(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Speed2D;                                           // 0x00E0(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AccelerationSize2D;                                // 0x00E4(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsOnGround;                                       // 0x00E8(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsMoving;                                         // 0x00E9(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsAccelerating;                                   // 0x00EA(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsMovingAndAccelerating;                          // 0x00EB(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsMovingOrAccelerating;                           // 0x00EC(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsNotMovingOrAccelerating;                        // 0x00ED(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsNotMoving;                                      // 0x00EE(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsNotAccelerating;                                // 0x00EF(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsNotMovingAndAccelerating;                       // 0x00F0(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsMovingAndNotAccelerating;                       // 0x00F1(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAccelerationOpposesVelocity;                      // 0x00F2(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAccelerationEqualsVelocity;                       // 0x00F3(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F4[0x4];                                       // 0x00F4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimCharacterMovementSnapshot) == 0x000008, "Wrong alignment on FAnimCharacterMovementSnapshot");
static_assert(sizeof(FAnimCharacterMovementSnapshot) == 0x0000F8, "Wrong size on FAnimCharacterMovementSnapshot");
...
static_assert(offsetof(FAnimCharacterMovementSnapshot, LastWorldLocation) == 0x000018, "Member 'FAnimCharacterMovementSnapshot::LastWorldLocation' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, WorldVelocity) == 0x000030, "Member 'FAnimCharacterMovementSnapshot::WorldVelocity' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, LocalVelocity) == 0x000048, "Member 'FAnimCharacterMovementSnapshot::LocalVelocity' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, WorldAcceleration) == 0x000060, "Member 'FAnimCharacterMovementSnapshot::WorldAcceleration' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, LocalAcceleration) == 0x000078, "Member 'FAnimCharacterMovementSnapshot::LocalAcceleration' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, LocalVelocityDirection) == 0x000090, "Member 'FAnimCharacterMovementSnapshot::LocalVelocityDirection' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, LocalAccelerationDirection) == 0x0000A8, "Member 'FAnimCharacterMovementSnapshot::LocalAccelerationDirection' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, CurrentCardinalDirection) == 0x0000C0, "Member 'FAnimCharacterMovementSnapshot::CurrentCardinalDirection' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, VelocityYawAngle) == 0x0000C4, "Member 'FAnimCharacterMovementSnapshot::VelocityYawAngle' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, AccelerationYawAngle) == 0x0000C8, "Member 'FAnimCharacterMovementSnapshot::AccelerationYawAngle' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, VelocityYawDeltaNorth) == 0x0000CC, "Member 'FAnimCharacterMovementSnapshot::VelocityYawDeltaNorth' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, VelocityYawDeltaEast) == 0x0000D0, "Member 'FAnimCharacterMovementSnapshot::VelocityYawDeltaEast' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, VelocityYawDeltaSouth) == 0x0000D4, "Member 'FAnimCharacterMovementSnapshot::VelocityYawDeltaSouth' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, VelocityYawDeltaWest) == 0x0000D8, "Member 'FAnimCharacterMovementSnapshot::VelocityYawDeltaWest' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, Distance2DTraveledSinceLastUpdate) == 0x0000DC, "Member 'FAnimCharacterMovementSnapshot::Distance2DTraveledSinceLastUpdate' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, Speed2D) == 0x0000E0, "Member 'FAnimCharacterMovementSnapshot::Speed2D' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, AccelerationSize2D) == 0x0000E4, "Member 'FAnimCharacterMovementSnapshot::AccelerationSize2D' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsOnGround) == 0x0000E8, "Member 'FAnimCharacterMovementSnapshot::bIsOnGround' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsMoving) == 0x0000E9, "Member 'FAnimCharacterMovementSnapshot::bIsMoving' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsAccelerating) == 0x0000EA, "Member 'FAnimCharacterMovementSnapshot::bIsAccelerating' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsMovingAndAccelerating) == 0x0000EB, "Member 'FAnimCharacterMovementSnapshot::bIsMovingAndAccelerating' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsMovingOrAccelerating) == 0x0000EC, "Member 'FAnimCharacterMovementSnapshot::bIsMovingOrAccelerating' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsNotMovingOrAccelerating) == 0x0000ED, "Member 'FAnimCharacterMovementSnapshot::bIsNotMovingOrAccelerating' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsNotMoving) == 0x0000EE, "Member 'FAnimCharacterMovementSnapshot::bIsNotMoving' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsNotAccelerating) == 0x0000EF, "Member 'FAnimCharacterMovementSnapshot::bIsNotAccelerating' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsNotMovingAndAccelerating) == 0x0000F0, "Member 'FAnimCharacterMovementSnapshot::bIsNotMovingAndAccelerating' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bIsMovingAndNotAccelerating) == 0x0000F1, "Member 'FAnimCharacterMovementSnapshot::bIsMovingAndNotAccelerating' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bAccelerationOpposesVelocity) == 0x0000F2, "Member 'FAnimCharacterMovementSnapshot::bAccelerationOpposesVelocity' has a wrong offset!");
static_assert(offsetof(FAnimCharacterMovementSnapshot, bAccelerationEqualsVelocity) == 0x0000F3, "Member 'FAnimCharacterMovementSnapshot::bAccelerationEqualsVelocity' has a wrong offset!");
...
static_assert(sizeof(FAnimTurnInPlaceState) == 0x000060, "Wrong size on FAnimTurnInPlaceState");
...
static_assert(alignof(FRicochet) == 0x000008, "Wrong alignment on FRicochet");
static_assert(sizeof(FRicochet) == 0x000050, "Wrong size on FRicochet");
...
static_assert(sizeof(FSavedTransforms) == 0x000070, "Wrong size on FSavedTransforms");
...
static_assert(sizeof(FSavedCoverActor) == 0x000150, "Wrong size on FSavedCoverActor");
...
static_assert(offsetof(FSavedCoverActor, CoverObjectName) == 0x000070, "Member 'FSavedCoverActor::CoverObjectName' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, CoverRail) == 0x000080, "Member 'FSavedCoverActor::CoverRail' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, StandCoverType) == 0x0000D8, "Member 'FSavedCoverActor::StandCoverType' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, CrouchCoverType) == 0x0000D9, "Member 'FSavedCoverActor::CrouchCoverType' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, StandCoverDirection) == 0x0000E0, "Member 'FSavedCoverActor::StandCoverDirection' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, CrouchCoverDirection) == 0x000110, "Member 'FSavedCoverActor::CrouchCoverDirection' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, Index) == 0x000140, "Member 'FSavedCoverActor::Index' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, bIsCrouchOnlyCover) == 0x000144, "Member 'FSavedCoverActor::bIsCrouchOnlyCover' has a wrong offset!");
static_assert(offsetof(FSavedCoverActor, bOverrideCoverType) == 0x000145, "Member 'FSavedCoverActor::bOverrideCoverType' has a wrong offset!");
...
static_assert(sizeof(FLobbySaveData) == 0x000060, "Wrong size on FLobbySaveData");
...
static_assert(offsetof(FLobbySaveData, PlayerLocation) == 0x000018, "Member 'FLobbySaveData::PlayerLocation' has a wrong offset!");
static_assert(offsetof(FLobbySaveData, PlayerRotation) == 0x000030, "Member 'FLobbySaveData::PlayerRotation' has a wrong offset!");
static_assert(offsetof(FLobbySaveData, PlayerCameraRotation) == 0x000048, "Member 'FLobbySaveData::PlayerCameraRotation' has a wrong offset!");
...
static_assert(sizeof(FSharedStackUpData) == 0x0000B8, "Wrong size on FSharedStackUpData");
static_assert(offsetof(FSharedStackUpData, StackUpDoor) == 0x000048, "Member 'FSharedStackUpData::StackUpDoor' has a wrong offset!");
static_assert(offsetof(FSharedStackUpData, DoorChecker) == 0x000050, "Member 'FSharedStackUpData::DoorChecker' has a wrong offset!");
static_assert(offsetof(FSharedStackUpData, StackUpSortedSwat) == 0x000058, "Member 'FSharedStackUpData::StackUpSortedSwat' has a wrong offset!");
static_assert(offsetof(FSharedStackUpData, DoorToClose) == 0x000068, "Member 'FSharedStackUpData::DoorToClose' has a wrong offset!");
...
static_assert(alignof(FGasVolumesContainer) == 0x000008, "Wrong alignment on FGasVolumesContainer");
static_assert(sizeof(FGasVolumesContainer) == 0x000010, "Wrong size on FGasVolumesContainer");
static_assert(offsetof(FGasVolumesContainer, GasVolumeComponents) == 0x000000, "Member 'FGasVolumesContainer::GasVolumeComponents' has a wrong offset!");
...
static_assert(alignof(FCustomizationConditionalMaterial) == 0x000004, "Wrong alignment on FCustomizationConditionalMaterial");
static_assert(sizeof(FCustomizationConditionalMaterial) == 0x000010, "Wrong size on FCustomizationConditionalMaterial");
static_assert(offsetof(FCustomizationConditionalMaterial, Slot) == 0x000000, "Member 'FCustomizationConditionalMaterial::Slot' has a wrong offset!");
static_assert(offsetof(FCustomizationConditionalMaterial, RequiredTag) == 0x000004, "Member 'FCustomizationConditionalMaterial::RequiredTag' has a wrong offset!");
static_assert(offsetof(FCustomizationConditionalMaterial, bInvertCondition) == 0x00000C, "Member 'FCustomizationConditionalMaterial::bInvertCondition' has a wrong offset!");
...
{
public:
	TSubclassOf<class ABaseItem>                  Class;                                             // 0x0000(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTransform                             CharacterTransform;                                // 0x0020(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               ControlRotation;                                   // 0x0080(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         Health;                                            // 0x0098(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class ABaseItem>                  EquippedItemClass;                                 // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FHm_InventoryInformation>       Inventory;                                         // 0x00A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         TotalGrenades;                                     // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TotalDevices;                                      // 0x00BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasBeenReported;                                  // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FHm_PlayerInformation) == 0x0000D0, "Wrong size on FHm_PlayerInformation");
...
static_assert(offsetof(FHm_PlayerInformation, ControlRotation) == 0x000080, "Member 'FHm_PlayerInformation::ControlRotation' has a wrong offset!");
static_assert(offsetof(FHm_PlayerInformation, Health) == 0x000098, "Member 'FHm_PlayerInformation::Health' has a wrong offset!");
static_assert(offsetof(FHm_PlayerInformation, EquippedItemClass) == 0x0000A0, "Member 'FHm_PlayerInformation::EquippedItemClass' has a wrong offset!");
static_assert(offsetof(FHm_PlayerInformation, Inventory) == 0x0000A8, "Member 'FHm_PlayerInformation::Inventory' has a wrong offset!");
static_assert(offsetof(FHm_PlayerInformation, TotalGrenades) == 0x0000B8, "Member 'FHm_PlayerInformation::TotalGrenades' has a wrong offset!");
static_assert(offsetof(FHm_PlayerInformation, TotalDevices) == 0x0000BC, "Member 'FHm_PlayerInformation::TotalDevices' has a wrong offset!");
static_assert(offsetof(FHm_PlayerInformation, bHasBeenReported) == 0x0000C0, "Member 'FHm_PlayerInformation::bHasBeenReported' has a wrong offset!");
...
{
public:
	struct FTransform                             CharacterTransform;                                // 0x0000(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETeamType                                     TeamType;                                          // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Health;                                            // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsArrested;                                       // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsSurrendered;                                    // 0x0069(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasBeenReported;                                  // 0x006A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B[0x5];                                       // 0x006B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           Tags;                                              // 0x0070(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSubclassOf<class ABaseItem>                  EquippedItemClass;                                 // 0x0080(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FCharacterMesh                         CharacterMeshData;                                 // 0x0088(0x0088)(ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHm_CyberneticsInformation) == 0x000010, "Wrong alignment on FHm_CyberneticsInformation");
static_assert(sizeof(FHm_CyberneticsInformation) == 0x000110, "Wrong size on FHm_CyberneticsInformation");
...
static_assert(offsetof(FHm_CyberneticsInformation, TeamType) == 0x000060, "Member 'FHm_CyberneticsInformation::TeamType' has a wrong offset!");
static_assert(offsetof(FHm_CyberneticsInformation, Health) == 0x000064, "Member 'FHm_CyberneticsInformation::Health' has a wrong offset!");
static_assert(offsetof(FHm_CyberneticsInformation, bIsArrested) == 0x000068, "Member 'FHm_CyberneticsInformation::bIsArrested' has a wrong offset!");
static_assert(offsetof(FHm_CyberneticsInformation, bIsSurrendered) == 0x000069, "Member 'FHm_CyberneticsInformation::bIsSurrendered' has a wrong offset!");
static_assert(offsetof(FHm_CyberneticsInformation, bHasBeenReported) == 0x00006A, "Member 'FHm_CyberneticsInformation::bHasBeenReported' has a wrong offset!");
static_assert(offsetof(FHm_CyberneticsInformation, Tags) == 0x000070, "Member 'FHm_CyberneticsInformation::Tags' has a wrong offset!");
static_assert(offsetof(FHm_CyberneticsInformation, EquippedItemClass) == 0x000080, "Member 'FHm_CyberneticsInformation::EquippedItemClass' has a wrong offset!");
static_assert(offsetof(FHm_CyberneticsInformation, CharacterMeshData) == 0x000088, "Member 'FHm_CyberneticsInformation::CharacterMeshData' has a wrong offset!");
...
public:
	...
	bool                                          bIsSimulating;                                     // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FHm_DoorChunkInformation) == 0x000070, "Wrong size on FHm_DoorChunkInformation");
...
static_assert(offsetof(FHm_DoorChunkInformation, bIsSimulating) == 0x000060, "Member 'FHm_DoorChunkInformation::bIsSimulating' has a wrong offset!");
...
public:
	...
	struct FTransform                             DoorMeshTransform;                                 // 0x0020(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsSimulatingPhysics;                              // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FHm_DoorChunkInformation>       DoorChunkInformations;                             // 0x0088(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class FName                                   TrapName;                                          // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHm_DoorInformation) == 0x000010, "Wrong alignment on FHm_DoorInformation");
static_assert(sizeof(FHm_DoorInformation) == 0x0000A0, "Wrong size on FHm_DoorInformation");
...
static_assert(offsetof(FHm_DoorInformation, bIsSimulatingPhysics) == 0x000080, "Member 'FHm_DoorInformation::bIsSimulatingPhysics' has a wrong offset!");
static_assert(offsetof(FHm_DoorInformation, DoorChunkInformations) == 0x000088, "Member 'FHm_DoorInformation::DoorChunkInformations' has a wrong offset!");
static_assert(offsetof(FHm_DoorInformation, TrapName) == 0x000098, "Member 'FHm_DoorInformation::TrapName' has a wrong offset!");
...
static_assert(sizeof(FHm_BaggedEvidence) == 0x000060, "Wrong size on FHm_BaggedEvidence");
...
public:
	struct FTransform                             Transform;                                         // 0x0000(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ABaseItem>                  Class;                                             // 0x0060(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x8];                                       // 0x0068(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FHm_DroppedEvidence) == 0x000010, "Wrong alignment on FHm_DroppedEvidence");
static_assert(sizeof(FHm_DroppedEvidence) == 0x000070, "Wrong size on FHm_DroppedEvidence");
static_assert(offsetof(FHm_DroppedEvidence, Transform) == 0x000000, "Member 'FHm_DroppedEvidence::Transform' has a wrong offset!");
static_assert(offsetof(FHm_DroppedEvidence, Class) == 0x000060, "Member 'FHm_DroppedEvidence::Class' has a wrong offset!");
...
{
public:
	class UParticleSystem*                        ParticleFx;                                        // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundCue*                              SoundFx;                                           // 0x0008(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Decal;                                             // 0x0010(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSubclassOf<class AActor>                     DecalMesh;                                         // 0x0020(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             PaintMaterialTexture;                              // 0x0028(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FInterestStationPoint) == 0x000070, "Wrong size on FInterestStationPoint");
static_assert(offsetof(FInterestStationPoint, Location) == 0x000000, "Member 'FInterestStationPoint::Location' has a wrong offset!");
static_assert(offsetof(FInterestStationPoint, RequiredTimeStationing) == 0x000018, "Member 'FInterestStationPoint::RequiredTimeStationing' has a wrong offset!");
static_assert(offsetof(FInterestStationPoint, TimeStationing) == 0x000020, "Member 'FInterestStationPoint::TimeStationing' has a wrong offset!");
...
static_assert(alignof(FCharacterLipSyncData) == 0x000008, "Wrong alignment on FCharacterLipSyncData");
static_assert(sizeof(FCharacterLipSyncData) == 0x000050, "Wrong size on FCharacterLipSyncData");
static_assert(offsetof(FCharacterLipSyncData, VoiceOverAnimationMap) == 0x000000, "Member 'FCharacterLipSyncData::VoiceOverAnimationMap' has a wrong offset!");
...
static_assert(sizeof(FAnalyticsStatus) == 0x000078, "Wrong size on FAnalyticsStatus");
...
static_assert(alignof(FMissionEventData) == 0x000008, "Wrong alignment on FMissionEventData");
static_assert(sizeof(FMissionEventData) == 0x000038, "Wrong size on FMissionEventData");
static_assert(offsetof(FMissionEventData, Targets) == 0x000000, "Member 'FMissionEventData::Targets' has a wrong offset!");
static_assert(offsetof(FMissionEventData, bAllConditionsRequired) == 0x000020, "Member 'FMissionEventData::bAllConditionsRequired' has a wrong offset!");
static_assert(offsetof(FMissionEventData, Conditions) == 0x000028, "Member 'FMissionEventData::Conditions' has a wrong offset!");
...
static_assert(alignof(FMissionPlanLineColors) == 0x000004, "Wrong alignment on FMissionPlanLineColors");
static_assert(sizeof(FMissionPlanLineColors) == 0x000030, "Wrong size on FMissionPlanLineColors");
static_assert(offsetof(FMissionPlanLineColors, GoldTeamColor) == 0x000000, "Member 'FMissionPlanLineColors::GoldTeamColor' has a wrong offset!");
static_assert(offsetof(FMissionPlanLineColors, BlueTeamColor) == 0x000010, "Member 'FMissionPlanLineColors::BlueTeamColor' has a wrong offset!");
static_assert(offsetof(FMissionPlanLineColors, RedTeamColor) == 0x000020, "Member 'FMissionPlanLineColors::RedTeamColor' has a wrong offset!");
...
static_assert(sizeof(FScreenFooterEntry) == 0x000078, "Wrong size on FScreenFooterEntry");
...
static_assert(offsetof(FScreenFooterEntry, ActionIsVisualOnly) == 0x000003, "Member 'FScreenFooterEntry::ActionIsVisualOnly' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, ButtonLabel) == 0x000008, "Member 'FScreenFooterEntry::ButtonLabel' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, bMultiBind) == 0x000020, "Member 'FScreenFooterEntry::bMultiBind' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, InputAction) == 0x000028, "Member 'FScreenFooterEntry::InputAction' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, InputActions) == 0x000038, "Member 'FScreenFooterEntry::InputActions' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, ActionLabel) == 0x000048, "Member 'FScreenFooterEntry::ActionLabel' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, ComboAction) == 0x000060, "Member 'FScreenFooterEntry::ComboAction' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, InputBindSet) == 0x000061, "Member 'FScreenFooterEntry::InputBindSet' has a wrong offset!");
static_assert(offsetof(FScreenFooterEntry, MultiActions) == 0x000068, "Member 'FScreenFooterEntry::MultiActions' has a wrong offset!");
...
static_assert(sizeof(FTOCData) == 0x000028, "Wrong size on FTOCData");
static_assert(offsetof(FTOCData, TOCLine) == 0x000000, "Member 'FTOCData::TOCLine' has a wrong offset!");
static_assert(offsetof(FTOCData, Speaker) == 0x000010, "Member 'FTOCData::Speaker' has a wrong offset!");
static_assert(offsetof(FTOCData, QueuePriority) == 0x000020, "Member 'FTOCData::QueuePriority' has a wrong offset!");
...
static_assert(alignof(FBoneVelocity) == 0x000008, "Wrong alignment on FBoneVelocity");
static_assert(sizeof(FBoneVelocity) == 0x000028, "Wrong size on FBoneVelocity");
...
static_assert(offsetof(FBoneVelocity, CalculatedSpeed) == 0x000020, "Member 'FBoneVelocity::CalculatedSpeed' has a wrong offset!");
...
static_assert(alignof(FFootIKStruct) == 0x000008, "Wrong alignment on FFootIKStruct");
static_assert(sizeof(FFootIKStruct) == 0x000020, "Wrong size on FFootIKStruct");
static_assert(offsetof(FFootIKStruct, Offset) == 0x000000, "Member 'FFootIKStruct::Offset' has a wrong offset!");
static_assert(offsetof(FFootIKStruct, FootRotation) == 0x000008, "Member 'FFootIKStruct::FootRotation' has a wrong offset!");
...
static_assert(sizeof(FWoundData) == 0x000110, "Wrong size on FWoundData");
static_assert(offsetof(FWoundData, WoundSize) == 0x000000, "Member 'FWoundData::WoundSize' has a wrong offset!");
static_assert(offsetof(FWoundData, WoundOffset) == 0x000008, "Member 'FWoundData::WoundOffset' has a wrong offset!");
static_assert(offsetof(FWoundData, UpperMesh) == 0x000020, "Member 'FWoundData::UpperMesh' has a wrong offset!");
static_assert(offsetof(FWoundData, UpperMeshTranform) == 0x000030, "Member 'FWoundData::UpperMeshTranform' has a wrong offset!");
static_assert(offsetof(FWoundData, LowerMesh) == 0x000090, "Member 'FWoundData::LowerMesh' has a wrong offset!");
static_assert(offsetof(FWoundData, LowerMeshTranform) == 0x0000A0, "Member 'FWoundData::LowerMeshTranform' has a wrong offset!");
static_assert(offsetof(FWoundData, bBreaksBone) == 0x000100, "Member 'FWoundData::bBreaksBone' has a wrong offset!");
...
static_assert(alignof(FRadialTrackingInitStruct) == 0x000008, "Wrong alignment on FRadialTrackingInitStruct");
static_assert(sizeof(FRadialTrackingInitStruct) == 0x000018, "Wrong size on FRadialTrackingInitStruct");
static_assert(offsetof(FRadialTrackingInitStruct, bTrackSuspects) == 0x000000, "Member 'FRadialTrackingInitStruct::bTrackSuspects' has a wrong offset!");
static_assert(offsetof(FRadialTrackingInitStruct, bTrackCivilians) == 0x000001, "Member 'FRadialTrackingInitStruct::bTrackCivilians' has a wrong offset!");
static_assert(offsetof(FRadialTrackingInitStruct, TrackingTargets) == 0x000008, "Member 'FRadialTrackingInitStruct::TrackingTargets' has a wrong offset!");
...
static_assert(sizeof(FPathAwarenessInfo) == 0x000040, "Wrong size on FPathAwarenessInfo");
...
static_assert(offsetof(FPathAwarenessInfo, SensedFrom) == 0x000020, "Member 'FPathAwarenessInfo::SensedFrom' has a wrong offset!");
static_assert(offsetof(FPathAwarenessInfo, Age) == 0x000038, "Member 'FPathAwarenessInfo::Age' has a wrong offset!");
...
static_assert(sizeof(FCoverDirectionalTrans) == 0x000040, "Wrong size on FCoverDirectionalTrans");
...
static_assert(offsetof(FCoverDirectionalTrans, CoverTrans_90) == 0x000020, "Member 'FCoverDirectionalTrans::CoverTrans_90' has a wrong offset!");
static_assert(offsetof(FCoverDirectionalTrans, DistanceOffsetCover_90) == 0x000028, "Member 'FCoverDirectionalTrans::DistanceOffsetCover_90' has a wrong offset!");
...
static_assert(sizeof(FCoverDataMain) == 0x0000F8, "Wrong size on FCoverDataMain");
...
static_assert(offsetof(FCoverDataMain, CoverExitTrans) == 0x000050, "Member 'FCoverDataMain::CoverExitTrans' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, SideSwitchTrans) == 0x000090, "Member 'FCoverDataMain::SideSwitchTrans' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, AimingHTrans) == 0x000098, "Member 'FCoverDataMain::AimingHTrans' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, BlindFireHTrans) == 0x0000A8, "Member 'FCoverDataMain::BlindFireHTrans' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, BlindFireHIdlePose) == 0x0000B8, "Member 'FCoverDataMain::BlindFireHIdlePose' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, AimingHIdlePose) == 0x0000C0, "Member 'FCoverDataMain::AimingHIdlePose' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, AimingVTrans) == 0x0000C8, "Member 'FCoverDataMain::AimingVTrans' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, BlindFireVTrans) == 0x0000D8, "Member 'FCoverDataMain::BlindFireVTrans' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, BlindFireVIdlePose) == 0x0000E8, "Member 'FCoverDataMain::BlindFireVIdlePose' has a wrong offset!");
static_assert(offsetof(FCoverDataMain, AimingVIdlePose) == 0x0000F0, "Member 'FCoverDataMain::AimingVIdlePose' has a wrong offset!");
...
static_assert(alignof(FInputActionMap) == 0x000008, "Wrong alignment on FInputActionMap");
static_assert(sizeof(FInputActionMap) == 0x000010, "Wrong size on FInputActionMap");
static_assert(offsetof(FInputActionMap, InputAction) == 0x000000, "Member 'FInputActionMap::InputAction' has a wrong offset!");
static_assert(offsetof(FInputActionMap, InputTag) == 0x000008, "Member 'FInputActionMap::InputTag' has a wrong offset!");
...
static_assert(sizeof(FReadyOrNotAnimInstanceProxyTP) == 0x000700, "Wrong size on FReadyOrNotAnimInstanceProxyTP");
...
static_assert(sizeof(FRoNMovementStyle) == 0x0000A0, "Wrong size on FRoNMovementStyle");
...
static_assert(offsetof(FRoNMovementStyle, bUseUpperBodyIdleOverride) == 0x00000A, "Member 'FRoNMovementStyle::bUseUpperBodyIdleOverride' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, bTurnOnlyAffectsLowerBody) == 0x00000B, "Member 'FRoNMovementStyle::bTurnOnlyAffectsLowerBody' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, UpperBodyIdleOverride) == 0x000010, "Member 'FRoNMovementStyle::UpperBodyIdleOverride' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, ItemOverrideRule) == 0x000018, "Member 'FRoNMovementStyle::ItemOverrideRule' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, IdleData) == 0x000020, "Member 'FRoNMovementStyle::IdleData' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, TurnData) == 0x000030, "Member 'FRoNMovementStyle::TurnData' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, GaitEntries) == 0x000080, "Member 'FRoNMovementStyle::GaitEntries' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, StrafeBS) == 0x000090, "Member 'FRoNMovementStyle::StrafeBS' has a wrong offset!");
static_assert(offsetof(FRoNMovementStyle, NonStrafeBS) == 0x000098, "Member 'FRoNMovementStyle::NonStrafeBS' has a wrong offset!");
...
{
public:
	TSubclassOf<class UObject>                    WeaponClass;                                       // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class USkeletalMesh*                          CustomWeaponMesh;                                  // 0x0018(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                MeshSpace_ADS_SecondaryPos;                        // 0x0030(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               MeshSpace_ADS_SecondaryRot;                        // 0x0048(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FScopeModifications) == 0x000008, "Wrong alignment on FScopeModifications");
static_assert(sizeof(FScopeModifications) == 0x000060, "Wrong size on FScopeModifications");
...
static_assert(offsetof(FScopeModifications, MeshSpace_ADS_SecondaryPos) == 0x000030, "Member 'FScopeModifications::MeshSpace_ADS_SecondaryPos' has a wrong offset!");
static_assert(offsetof(FScopeModifications, MeshSpace_ADS_SecondaryRot) == 0x000048, "Member 'FScopeModifications::MeshSpace_ADS_SecondaryRot' has a wrong offset!");
...
static_assert(sizeof(FScoreGroup) == 0x000038, "Wrong size on FScoreGroup");
...
static_assert(offsetof(FScoreGroup, bKeepScoreActiveAfterGroupChange) == 0x000010, "Member 'FScoreGroup::bKeepScoreActiveAfterGroupChange' has a wrong offset!");
static_assert(offsetof(FScoreGroup, Scores) == 0x000018, "Member 'FScoreGroup::Scores' has a wrong offset!");
static_assert(offsetof(FScoreGroup, InactiveScores) == 0x000028, "Member 'FScoreGroup::InactiveScores' has a wrong offset!");
...
static_assert(sizeof(FScoringDataTable) == 0x000058, "Wrong size on FScoringDataTable");
...
static_assert(offsetof(FScoringDataTable, bKeepScoreActiveAfterGroupChange) == 0x000050, "Member 'FScoringDataTable::bKeepScoreActiveAfterGroupChange' has a wrong offset!");
...
static_assert(sizeof(FTutorialMissionData) == 0x000300, "Wrong size on FTutorialMissionData");
...
static_assert(offsetof(FTutorialMissionData, SpawnTag) == 0x0002F0, "Member 'FTutorialMissionData::SpawnTag' has a wrong offset!");
...
static_assert(alignof(FRonKey) == 0x000010, "Wrong alignment on FRonKey");
static_assert(sizeof(FRonKey) == 0x0000F0, "Wrong size on FRonKey");
...
static_assert(alignof(FRoomGroup) == 0x000008, "Wrong alignment on FRoomGroup");
static_assert(sizeof(FRoomGroup) == 0x000010, "Wrong size on FRoomGroup");
...
static_assert(alignof(FLooseRoomGroup) == 0x000008, "Wrong alignment on FLooseRoomGroup");
static_assert(sizeof(FLooseRoomGroup) == 0x000010, "Wrong size on FLooseRoomGroup");
...
static_assert(alignof(FSquadActivityData) == 0x000008, "Wrong alignment on FSquadActivityData");
static_assert(sizeof(FSquadActivityData) == 0x000008, "Wrong size on FSquadActivityData");
static_assert(offsetof(FSquadActivityData, SquadsActivity) == 0x000000, "Member 'FSquadActivityData::SquadsActivity' has a wrong offset!");
...
static_assert(alignof(FPotentialRoleData) == 0x000008, "Wrong alignment on FPotentialRoleData");
static_assert(sizeof(FPotentialRoleData) == 0x000018, "Wrong size on FPotentialRoleData");
static_assert(offsetof(FPotentialRoleData, SquadMember) == 0x000000, "Member 'FPotentialRoleData::SquadMember' has a wrong offset!");
static_assert(offsetof(FPotentialRoleData, RoleConditionals) == 0x000008, "Member 'FPotentialRoleData::RoleConditionals' has a wrong offset!");
...
static_assert(alignof(FPossibleActivitySetup) == 0x000001, "Wrong alignment on FPossibleActivitySetup");
static_assert(sizeof(FPossibleActivitySetup) == 0x000001, "Wrong size on FPossibleActivitySetup");
...
static_assert(alignof(FSquadActivityRules) == 0x000008, "Wrong alignment on FSquadActivityRules");
static_assert(sizeof(FSquadActivityRules) == 0x000030, "Wrong size on FSquadActivityRules");
static_assert(offsetof(FSquadActivityRules, ActivityTag) == 0x000000, "Member 'FSquadActivityRules::ActivityTag' has a wrong offset!");
static_assert(offsetof(FSquadActivityRules, Cooldown) == 0x000008, "Member 'FSquadActivityRules::Cooldown' has a wrong offset!");
static_assert(offsetof(FSquadActivityRules, MaxRunTime) == 0x00000C, "Member 'FSquadActivityRules::MaxRunTime' has a wrong offset!");
static_assert(offsetof(FSquadActivityRules, Gates) == 0x000010, "Member 'FSquadActivityRules::Gates' has a wrong offset!");
static_assert(offsetof(FSquadActivityRules, SquadRolesData) == 0x000020, "Member 'FSquadActivityRules::SquadRolesData' has a wrong offset!");
...
static_assert(alignof(FRonInputKeyTable) == 0x000010, "Wrong alignment on FRonInputKeyTable");
static_assert(sizeof(FRonInputKeyTable) == 0x000100, "Wrong size on FRonInputKeyTable");
static_assert(offsetof(FRonInputKeyTable, Key) == 0x000010, "Member 'FRonInputKeyTable::Key' has a wrong offset!");
...
static_assert(alignof(FCommandWheelIconMapping) == 0x000010, "Wrong alignment on FCommandWheelIconMapping");
static_assert(sizeof(FCommandWheelIconMapping) == 0x0000E0, "Wrong size on FCommandWheelIconMapping");
static_assert(offsetof(FCommandWheelIconMapping, SwatCommand) == 0x000008, "Member 'FCommandWheelIconMapping::SwatCommand' has a wrong offset!");
static_assert(offsetof(FCommandWheelIconMapping, Icon) == 0x000010, "Member 'FCommandWheelIconMapping::Icon' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   OptionName;                                        // 0x000C(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EItemWheelCategory                            SubOptionCategory;                                 // 0x0014(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EItemWheelCategory                            SubOptionOf;                                       // 0x0015(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FItemWheelOptionTable) == 0x000010, "Wrong alignment on FItemWheelOptionTable");
static_assert(sizeof(FItemWheelOptionTable) == 0x0000F0, "Wrong size on FItemWheelOptionTable");
static_assert(offsetof(FItemWheelOptionTable, ItemID) == 0x000008, "Member 'FItemWheelOptionTable::ItemID' has a wrong offset!");
static_assert(offsetof(FItemWheelOptionTable, OptionID) == 0x000009, "Member 'FItemWheelOptionTable::OptionID' has a wrong offset!");
static_assert(offsetof(FItemWheelOptionTable, OptionName) == 0x00000C, "Member 'FItemWheelOptionTable::OptionName' has a wrong offset!");
static_assert(offsetof(FItemWheelOptionTable, SubOptionCategory) == 0x000014, "Member 'FItemWheelOptionTable::SubOptionCategory' has a wrong offset!");
static_assert(offsetof(FItemWheelOptionTable, SubOptionOf) == 0x000015, "Member 'FItemWheelOptionTable::SubOptionOf' has a wrong offset!");
static_assert(offsetof(FItemWheelOptionTable, Icon) == 0x000020, "Member 'FItemWheelOptionTable::Icon' has a wrong offset!");
...
static_assert(alignof(FSharedFallInData) == 0x000008, "Wrong alignment on FSharedFallInData");
static_assert(sizeof(FSharedFallInData) == 0x000050, "Wrong size on FSharedFallInData");
...
static_assert(sizeof(FSharedBreachData) == 0x000130, "Wrong size on FSharedBreachData");
static_assert(offsetof(FSharedBreachData, DoorUser) == 0x0000B8, "Member 'FSharedBreachData::DoorUser' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, DoorBreacher) == 0x0000C0, "Member 'FSharedBreachData::DoorBreacher' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, DoorScanner) == 0x0000C8, "Member 'FSharedBreachData::DoorScanner' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, ShieldUser) == 0x0000D0, "Member 'FSharedBreachData::ShieldUser' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, BreachCaller) == 0x0000D8, "Member 'FSharedBreachData::BreachCaller' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, DoorBreachItemClass) == 0x0000E0, "Member 'FSharedBreachData::DoorBreachItemClass' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, DoorUseItemClass) == 0x0000E8, "Member 'FSharedBreachData::DoorUseItemClass' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, DoorUseActivity) == 0x0000F0, "Member 'FSharedBreachData::DoorUseActivity' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, DoorBreachActivity) == 0x0000F8, "Member 'FSharedBreachData::DoorBreachActivity' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, DoorScanActivity) == 0x000100, "Member 'FSharedBreachData::DoorScanActivity' has a wrong offset!");
static_assert(offsetof(FSharedBreachData, ClearingSortedSwat) == 0x000108, "Member 'FSharedBreachData::ClearingSortedSwat' has a wrong offset!");
...
static_assert(alignof(FGamepadHoldTimes) == 0x000008, "Wrong alignment on FGamepadHoldTimes");
static_assert(sizeof(FGamepadHoldTimes) == 0x000010, "Wrong size on FGamepadHoldTimes");
static_assert(offsetof(FGamepadHoldTimes, GamepadAction) == 0x000008, "Member 'FGamepadHoldTimes::GamepadAction' has a wrong offset!");
static_assert(offsetof(FGamepadHoldTimes, HoldTime) == 0x00000C, "Member 'FGamepadHoldTimes::HoldTime' has a wrong offset!");
...
static_assert(sizeof(FSubtitleParameters) == 0x000060, "Wrong size on FSubtitleParameters");
...
public:
	...
	ETrackingSpotlightMode                        Mode;                                              // 0x0001(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTrackingSpotlightInitStruct) == 0x000001, "Wrong alignment on FTrackingSpotlightInitStruct");
static_assert(sizeof(FTrackingSpotlightInitStruct) == 0x000002, "Wrong size on FTrackingSpotlightInitStruct");
static_assert(offsetof(FTrackingSpotlightInitStruct, bSpotlightEnabled) == 0x000000, "Member 'FTrackingSpotlightInitStruct::bSpotlightEnabled' has a wrong offset!");
static_assert(offsetof(FTrackingSpotlightInitStruct, Mode) == 0x000001, "Member 'FTrackingSpotlightInitStruct::Mode' has a wrong offset!");
...
static_assert(sizeof(FSavedRoomData) == 0x000060, "Wrong size on FSavedRoomData");
...
static_assert(offsetof(FSavedRoomData, RootDoorID) == 0x000018, "Member 'FSavedRoomData::RootDoorID' has a wrong offset!");
static_assert(offsetof(FSavedRoomData, Threats) == 0x000030, "Member 'FSavedRoomData::Threats' has a wrong offset!");
static_assert(offsetof(FSavedRoomData, AdditionalRootDoors) == 0x000040, "Member 'FSavedRoomData::AdditionalRootDoors' has a wrong offset!");
static_assert(offsetof(FSavedRoomData, ConnectingRooms) == 0x000050, "Member 'FSavedRoomData::ConnectingRooms' has a wrong offset!");

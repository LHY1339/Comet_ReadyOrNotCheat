...
{
public:
	struct FItemWheelOption                       ItemWheelOption;                                   // 0x0000(0x00F0)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	int32                                         OptionIndex;                                       // 0x00F0(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         SelectedIndex;                                     // 0x00F4(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UW_WheelIcon_C*                         WheelIcon;                                         // 0x00F8(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UTexture2D*                             CallFunc_GetBrushResourceAsTexture2D_ReturnValue;  // 0x0108(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetItemAmount_ItemAmount;                 // 0x0110(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetShowCounter_ShowCounter;               // 0x0114(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UW_WheelIcon_C*                         CallFunc_Create_ReturnValue;                       // 0x0120(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(W_ItemWheel_C_CreateItemWheelIcon) == 0x000010, "Wrong alignment on W_ItemWheel_C_CreateItemWheelIcon");
static_assert(sizeof(W_ItemWheel_C_CreateItemWheelIcon) == 0x000130, "Wrong size on W_ItemWheel_C_CreateItemWheelIcon");
...
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, OptionIndex) == 0x0000F0, "Member 'W_ItemWheel_C_CreateItemWheelIcon::OptionIndex' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, SelectedIndex) == 0x0000F4, "Member 'W_ItemWheel_C_CreateItemWheelIcon::SelectedIndex' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, WheelIcon) == 0x0000F8, "Member 'W_ItemWheel_C_CreateItemWheelIcon::WheelIcon' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000100, "Member 'W_ItemWheel_C_CreateItemWheelIcon::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, CallFunc_GetBrushResourceAsTexture2D_ReturnValue) == 0x000108, "Member 'W_ItemWheel_C_CreateItemWheelIcon::CallFunc_GetBrushResourceAsTexture2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, CallFunc_GetItemAmount_ItemAmount) == 0x000110, "Member 'W_ItemWheel_C_CreateItemWheelIcon::CallFunc_GetItemAmount_ItemAmount' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, CallFunc_GetShowCounter_ShowCounter) == 0x000114, "Member 'W_ItemWheel_C_CreateItemWheelIcon::CallFunc_GetShowCounter_ShowCounter' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, CallFunc_GetOwningPlayer_ReturnValue) == 0x000118, "Member 'W_ItemWheel_C_CreateItemWheelIcon::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_CreateItemWheelIcon, CallFunc_Create_ReturnValue) == 0x000120, "Member 'W_ItemWheel_C_CreateItemWheelIcon::CallFunc_Create_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FItemWheelOption                       CallFunc_Array_Get_Item;                           // 0x0050(0x00F0)()
	...
	class UW_WheelIcon_C*                         CallFunc_CreateItemWheelIcon_WheelIcon;            // 0x0158(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue;                    // 0x0160(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_AddChildToRadialMenu_Success;             // 0x0164(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x016E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_16F[0x1];                                      // 0x016F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMG_RadialMenu_C*                      K2Node_DynamicCast_AsUMG_Radial_Menu;              // 0x0170(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_ItemWheel_C_UpdateRadialMenu) == 0x000180, "Wrong size on W_ItemWheel_C_UpdateRadialMenu");
...
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_Array_Length_ReturnValue_1) == 0x000140, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, Temp_int_Loop_Counter_Variable) == 0x000144, "Member 'W_ItemWheel_C_UpdateRadialMenu::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_Less_IntInt_ReturnValue) == 0x000148, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_Add_IntInt_ReturnValue) == 0x00014C, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000150, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_CreateItemWheelIcon_WheelIcon) == 0x000158, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_CreateItemWheelIcon_WheelIcon' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_Array_Add_ReturnValue) == 0x000160, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_AddChildToRadialMenu_Success) == 0x000164, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_AddChildToRadialMenu_Success' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_Array_Add_ReturnValue_1) == 0x000168, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_Not_PreBool_ReturnValue) == 0x00016C, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_BooleanAND_ReturnValue) == 0x00016D, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x00016E, "Member 'W_ItemWheel_C_UpdateRadialMenu::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, K2Node_DynamicCast_AsUMG_Radial_Menu) == 0x000170, "Member 'W_ItemWheel_C_UpdateRadialMenu::K2Node_DynamicCast_AsUMG_Radial_Menu' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateRadialMenu, K2Node_DynamicCast_bSuccess) == 0x000178, "Member 'W_ItemWheel_C_UpdateRadialMenu::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_ValidWithoutSubOptions_ReturnValue;       // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x0075(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x0076(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_77[0x1];                                       // 0x0077(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_GetCurrentIndex_Index;                    // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetCurrentIndex_Valid;                    // 0x007C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsSegmentEnabled_ReturnValue;             // 0x007D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UW_WheelIcon_C*                         CallFunc_Array_Get_Item_1;                         // 0x00A0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_ItemWheel_C_UpdateWheelSelection) == 0x0000B0, "Wrong size on W_ItemWheel_C_UpdateWheelSelection");
...
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, Temp_int_Loop_Counter_Variable) == 0x00005C, "Member 'W_ItemWheel_C_UpdateWheelSelection::Temp_int_Loop_Counter_Variable' has a wrong offset!");
...
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_Less_IntInt_ReturnValue) == 0x00006C, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_Add_IntInt_ReturnValue) == 0x000070, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_ValidWithoutSubOptions_ReturnValue) == 0x000074, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_ValidWithoutSubOptions_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_Not_PreBool_ReturnValue) == 0x000075, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x000076, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_GetCurrentIndex_Index) == 0x000078, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_GetCurrentIndex_Index' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_GetCurrentIndex_Valid) == 0x00007C, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_GetCurrentIndex_Valid' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_IsSegmentEnabled_ReturnValue) == 0x00007D, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_IsSegmentEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_Not_PreBool_ReturnValue_1) == 0x00007E, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_BooleanOR_ReturnValue) == 0x00007F, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_BooleanAND_ReturnValue) == 0x000080, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_GetEmptyText_ReturnValue) == 0x000088, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_GetEmptyText_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_Array_Get_Item_1) == 0x0000A0, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(W_ItemWheel_C_UpdateWheelSelection, CallFunc_Array_IsValidIndex_ReturnValue) == 0x0000A8, "Member 'W_ItemWheel_C_UpdateWheelSelection::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");

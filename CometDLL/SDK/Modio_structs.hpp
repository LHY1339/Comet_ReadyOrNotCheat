...
public:
	...
	int32                                         Price;                                             // 0x01D4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FModioModInfo, Price) == 0x0001D4, "Member 'FModioModInfo::Price' has a wrong offset!");
...
static_assert(sizeof(FModioModCollectionEntry) == 0x000210, "Wrong size on FModioModCollectionEntry");

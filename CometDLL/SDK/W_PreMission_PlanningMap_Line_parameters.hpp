...
public:
	...
	double                                        K2Node_Event_CurrentZoom;                          // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, K2Node_Event_CurrentZoom) == 0x000008, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::K2Node_Event_CurrentZoom' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, CallFunc_Subtract_DoubleDouble_ReturnValue) == 0x000010, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::CallFunc_Subtract_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, CallFunc_LessEqual_DoubleDouble_ReturnValue) == 0x000018, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::CallFunc_LessEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000020, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, K2Node_Event_IsDesignTime) == 0x000028, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, K2Node_Event_MyGeometry) == 0x00002C, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, K2Node_Event_InDeltaTime) == 0x000064, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast) == 0x000068, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, CallFunc_SetWidthOverride_InWidthOverride_ImplicitCast) == 0x00006C, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::CallFunc_SetWidthOverride_InWidthOverride_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line, CallFunc_SetRenderTransformAngle_Angle_ImplicitCast) == 0x000070, "Member 'W_PreMission_PlanningMap_Line_C_ExecuteUbergraph_W_PreMission_PlanningMap_Line::CallFunc_SetRenderTransformAngle_Angle_ImplicitCast' has a wrong offset!");

...
void UW_Customization_C::FocusNewItemList()
{
	static class UFunction* Func = nullptr;
...
// Function W_Customization.W_Customization_C.UpdatePreview
// (BlueprintCallable, BlueprintEvent)

void UW_Customization_C::UpdatePreview()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("W_Customization_C", "UpdatePreview");
...
void UW_Customization_C::ViewCategoryItems(ECustomizationType Category)
{
	static class UFunction* Func = nullptr;

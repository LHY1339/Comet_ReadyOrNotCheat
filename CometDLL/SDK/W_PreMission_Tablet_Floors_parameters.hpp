...
public:
	...
	struct FLevelDataLookupTable                  CallFunc_GetMapDetailsFromName_ReturnValue;        // 0x00B0(0x0818)()
	...
	class FText                                   K2Node_Select_Default;                             // 0x0930(0x0018)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData_1;            // 0x0948(0x0050)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array;                            // 0x0998(0x0010)(ReferenceParm)
	class FText                                   CallFunc_Format_ReturnValue;                       // 0x09A8(0x0018)()
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationReverse_ReturnValue;         // 0x09C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_IntInt_ReturnValue_1;             // 0x09C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_9C9[0x3];                                      // 0x09C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x09CC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x09D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_9D1[0x7];                                      // 0x09D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_IntToText_ReturnValue;               // 0x09D8(0x0018)()
	int32                                         CallFunc_Array_Find_ReturnValue;                   // 0x09F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_9F4[0x4];                                      // 0x09F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonInputSubsystem*                  CallFunc_GetLocalPlayerSubsystem_ReturnValue;      // 0x09F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_StrStr_ReturnValue;            // 0x0A00(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              CallFunc_GetCurrentInputType_ReturnValue;          // 0x0A01(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo) == 0x000A08, "Wrong size on W_PreMission_Tablet_Floors_C_UpdateFloorInfo");
...
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Array_Length_ReturnValue) == 0x0008C8, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Array_Length_ReturnValue_1) == 0x0008CC, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Conv_IntToInt64_ReturnValue) == 0x0008D0, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0008D8, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, K2Node_MakeStruct_FormatArgumentData) == 0x0008E0, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, K2Node_Select_Default) == 0x000930, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, K2Node_MakeStruct_FormatArgumentData_1) == 0x000948, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, K2Node_MakeArray_Array) == 0x000998, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Format_ReturnValue) == 0x0009A8, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_PlayAnimationReverse_ReturnValue) == 0x0009C0, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_PlayAnimationReverse_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Greater_IntInt_ReturnValue_1) == 0x0009C8, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Greater_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Add_IntInt_ReturnValue) == 0x0009CC, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Less_IntInt_ReturnValue) == 0x0009D0, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Conv_IntToText_ReturnValue) == 0x0009D8, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_Array_Find_ReturnValue) == 0x0009F0, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_Array_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_GetLocalPlayerSubsystem_ReturnValue) == 0x0009F8, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_GetLocalPlayerSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_EqualEqual_StrStr_ReturnValue) == 0x000A00, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_EqualEqual_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_Tablet_Floors_C_UpdateFloorInfo, CallFunc_GetCurrentInputType_ReturnValue) == 0x000A01, "Member 'W_PreMission_Tablet_Floors_C_UpdateFloorInfo::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");

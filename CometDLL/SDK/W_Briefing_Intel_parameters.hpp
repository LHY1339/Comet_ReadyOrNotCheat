...
static_assert(sizeof(W_Briefing_Intel_C_AddToList) == 0x000028, "Wrong size on W_Briefing_Intel_C_AddToList");
...
static_assert(offsetof(W_Briefing_Intel_C_AddToList, K2Node_MakeStruct_Bottom_ImplicitCast) == 0x000020, "Member 'W_Briefing_Intel_C_AddToList::K2Node_MakeStruct_Bottom_ImplicitCast' has a wrong offset!");
...
{
public:
	TDelegate<void(const struct FCharacterBio& Bio)> K2Node_CreateDelegate_OutputDelegate;           // 0x0000(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FCharacterBio& Bio)> K2Node_CreateDelegate_OutputDelegate_1;         // 0x0010(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_Briefing_IntelList_Entry_C*          CallFunc_Create_ReturnValue;                       // 0x0020(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_Briefing_IntelList_Entry_C*          CallFunc_Create_ReturnValue_1;                     // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FST_Briefing_Evidence& Media)> K2Node_CreateDelegate_OutputDelegate_2; // 0x0030(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_Briefing_IntelList_Entry_C*          CallFunc_Create_ReturnValue_2;                     // 0x0040(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TDelegate<void(const struct FCharacterBio& Bio)> K2Node_CreateDelegate_OutputDelegate;           // 0x0014(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	bool                                          CallFunc_Array_IsValidIndex_ReturnValue;           // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const struct FST_Briefing_Evidence& Media)> K2Node_CreateDelegate_OutputDelegate; // 0x0014(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	struct FST_Briefing_Evidence                  Media;                                             // 0x0000(0x00F0)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};
static_assert(alignof(W_Briefing_Intel_C_UpdateMediaIntel) == 0x000010, "Wrong alignment on W_Briefing_Intel_C_UpdateMediaIntel");
static_assert(sizeof(W_Briefing_Intel_C_UpdateMediaIntel) == 0x0000F0, "Wrong size on W_Briefing_Intel_C_UpdateMediaIntel");

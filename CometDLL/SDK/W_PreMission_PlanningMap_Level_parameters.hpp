...
public:
	...
	class UW_OfficerMarker_C*                     CallFunc_Create_ReturnValue;                       // 0x0090(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UW_PreMission_Tablet_PlayerNode_C*      CallFunc_Create_ReturnValue_1;                     // 0x00A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UW_PreMission_PlanningMap_Line_C*       CallFunc_Create_ReturnValue_2;                     // 0x00B8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           CallFunc_Get_Player_State_Team_Color_LinearColor;  // 0x00D4(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateColor                            CallFunc_Get_Player_State_Team_Color_SlateColor;   // 0x00E4(0x0014)()
	TDelegate<void(class UW_OfficerMarker_C* TriggeringMarker)> K2Node_CreateDelegate_OutputDelegate; // 0x00F8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FAnchorData                            K2Node_MakeStruct_AnchorData;                      // 0x0138(0x0040)(NoDestructor)
	...
	double                                        CallFunc_GetLineAngle_Angle;                       // 0x0180(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_GetLineLength_Length;                     // 0x0188(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FAnchors                               K2Node_MakeStruct_Anchors_1;                       // 0x0190(0x0020)(NoDestructor)
	struct FAnchorData                            K2Node_MakeStruct_AnchorData_1;                    // 0x01B0(0x0040)(NoDestructor)
	class UCanvasPanelSlot*                       CallFunc_AddChildToCanvas_ReturnValue_1;           // 0x01F0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UCanvasPanel*                           CallFunc_SpawnObject_ReturnValue;                  // 0x01F8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FAnchors                               K2Node_MakeStruct_Anchors_2;                       // 0x0200(0x0020)(NoDestructor)
	class UCanvasPanelSlot*                       CallFunc_AddChildToCanvas_ReturnValue_2;           // 0x0220(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FAnchorData                            K2Node_MakeStruct_AnchorData_2;                    // 0x0228(0x0040)(NoDestructor)
};
...
static_assert(sizeof(W_PreMission_PlanningMap_Level_C_DrawLine) == 0x000268, "Wrong size on W_PreMission_PlanningMap_Level_C_DrawLine");
...
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_Create_ReturnValue_1) == 0x0000A8, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_Create_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, Temp_int_Array_Index_Variable) == 0x0000B0, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_Create_ReturnValue_2) == 0x0000B8, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_Create_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_Array_Get_Item) == 0x0000C0, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0000D0, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_EqualEqual_IntInt_ReturnValue_1) == 0x0000D1, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_EqualEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_Get_Player_State_Team_Color_LinearColor) == 0x0000D4, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_Get_Player_State_Team_Color_LinearColor' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_Get_Player_State_Team_Color_SlateColor) == 0x0000E4, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_Get_Player_State_Team_Color_SlateColor' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, K2Node_CreateDelegate_OutputDelegate) == 0x0000F8, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_AddChildToCanvas_ReturnValue) == 0x000108, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_AddChildToCanvas_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, K2Node_MakeStruct_Anchors) == 0x000110, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::K2Node_MakeStruct_Anchors' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, Temp_int_Loop_Counter_Variable) == 0x000130, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, K2Node_MakeStruct_AnchorData) == 0x000138, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::K2Node_MakeStruct_AnchorData' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_Less_IntInt_ReturnValue) == 0x000178, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_Add_IntInt_ReturnValue) == 0x00017C, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_GetLineAngle_Angle) == 0x000180, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_GetLineAngle_Angle' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_GetLineLength_Length) == 0x000188, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_GetLineLength_Length' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, K2Node_MakeStruct_Anchors_1) == 0x000190, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::K2Node_MakeStruct_Anchors_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, K2Node_MakeStruct_AnchorData_1) == 0x0001B0, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::K2Node_MakeStruct_AnchorData_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_AddChildToCanvas_ReturnValue_1) == 0x0001F0, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_AddChildToCanvas_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_SpawnObject_ReturnValue) == 0x0001F8, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, K2Node_MakeStruct_Anchors_2) == 0x000200, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::K2Node_MakeStruct_Anchors_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, CallFunc_AddChildToCanvas_ReturnValue_2) == 0x000220, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::CallFunc_AddChildToCanvas_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_Level_C_DrawLine, K2Node_MakeStruct_AnchorData_2) == 0x000228, "Member 'W_PreMission_PlanningMap_Level_C_DrawLine::K2Node_MakeStruct_AnchorData_2' has a wrong offset!");
...
static_assert(sizeof(W_PreMission_PlanningMap_Level_C_ExecuteUbergraph_W_PreMission_PlanningMap_Level) == 0x0001D0, "Wrong size on W_PreMission_PlanningMap_Level_C_ExecuteUbergraph_W_PreMission_PlanningMap_Level");

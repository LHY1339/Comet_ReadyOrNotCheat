...
static_assert(sizeof(FModioCommonCodeInputTextBoxInputStyle) == 0x0005F0, "Wrong size on FModioCommonCodeInputTextBoxInputStyle");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, CharacterBorderBrushBase) == 0x000340, "Member 'FModioCommonCodeInputTextBoxInputStyle::CharacterBorderBrushBase' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, CharacterBorderBrushFocused) == 0x000410, "Member 'FModioCommonCodeInputTextBoxInputStyle::CharacterBorderBrushFocused' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, CharacterBorderPadding) == 0x0004E0, "Member 'FModioCommonCodeInputTextBoxInputStyle::CharacterBorderPadding' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, FakeCaretBrush) == 0x0004F0, "Member 'FModioCommonCodeInputTextBoxInputStyle::FakeCaretBrush' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, FakeCaretHorizontalAlignment) == 0x0005C0, "Member 'FModioCommonCodeInputTextBoxInputStyle::FakeCaretHorizontalAlignment' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, FakeCaretVerticalAlignment) == 0x0005C1, "Member 'FModioCommonCodeInputTextBoxInputStyle::FakeCaretVerticalAlignment' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, CharacterPadding) == 0x0005C4, "Member 'FModioCommonCodeInputTextBoxInputStyle::CharacterPadding' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, CharacterSpacing) == 0x0005D4, "Member 'FModioCommonCodeInputTextBoxInputStyle::CharacterSpacing' has a wrong offset!");
static_assert(offsetof(FModioCommonCodeInputTextBoxInputStyle, MinimumCharacterWidth) == 0x0005E4, "Member 'FModioCommonCodeInputTextBoxInputStyle::MinimumCharacterWidth' has a wrong offset!");

...
static_assert(sizeof(APrimary_AK103_C) == 0x001750, "Wrong size on APrimary_AK103_C");
static_assert(offsetof(APrimary_AK103_C, UberGraphFrame) == 0x001740, "Member 'APrimary_AK103_C::UberGraphFrame' has a wrong offset!");

...
public:
	static class UJoinSessionCallbackProxyAdvanced* JoinSession(class UWorld* WorldContextObject, class APlayerController* PlayerController, const struct FBlueprintSessionResult& SearchResult);
...
static_assert(sizeof(UJoinSessionCallbackProxyAdvanced) == 0x000198, "Wrong size on UJoinSessionCallbackProxyAdvanced");

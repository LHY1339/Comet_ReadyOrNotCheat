...
public:
	...
	TMulticastInlineDelegate<void(class UW_RosterSelection_MiniCard_C* Card)> OnHovered;             // 0x1698(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UW_RosterSelection_MiniCard_C* Card)> OnUnhovered;           // 0x16A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class URosterCharacter*                       RosterCharacter;                                   // 0x16B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMulticastInlineDelegate<void(class UW_RosterSelection_MiniCard_C* Card)> OnClicked;             // 0x16C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FSlateColor                            UnavailableTint;                                   // 0x16D0(0x0014)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateColor                            AvailableTint;                                     // 0x16E4(0x0014)(Edit, BlueprintVisible, DisableEditOnInstance)
	ERosterSquadPosition                          DebugPosition;                                     // 0x16F8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ERosterCharacterState                         DebugState;                                        // 0x16F9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Empty;                                             // 0x16FA(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Locked;                                            // 0x16FB(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_16FC[0x4];                                     // 0x16FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UW_RosterSelection_MiniCard_C* Card)> OnEmptyClicked;        // 0x1700(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UW_RosterSelection_MiniCard_C* Card)> OnFocused;             // 0x1710(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UW_RosterSelection_MiniCard_C* Card)> OnUnfocused;           // 0x1720(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UW_RosterSelection_MiniCard_C) == 0x001730, "Wrong size on UW_RosterSelection_MiniCard_C");
...
static_assert(offsetof(UW_RosterSelection_MiniCard_C, OnHovered) == 0x001698, "Member 'UW_RosterSelection_MiniCard_C::OnHovered' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, OnUnhovered) == 0x0016A8, "Member 'UW_RosterSelection_MiniCard_C::OnUnhovered' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, RosterCharacter) == 0x0016B8, "Member 'UW_RosterSelection_MiniCard_C::RosterCharacter' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, OnClicked) == 0x0016C0, "Member 'UW_RosterSelection_MiniCard_C::OnClicked' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, UnavailableTint) == 0x0016D0, "Member 'UW_RosterSelection_MiniCard_C::UnavailableTint' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, AvailableTint) == 0x0016E4, "Member 'UW_RosterSelection_MiniCard_C::AvailableTint' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, DebugPosition) == 0x0016F8, "Member 'UW_RosterSelection_MiniCard_C::DebugPosition' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, DebugState) == 0x0016F9, "Member 'UW_RosterSelection_MiniCard_C::DebugState' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, Empty) == 0x0016FA, "Member 'UW_RosterSelection_MiniCard_C::Empty' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, Locked) == 0x0016FB, "Member 'UW_RosterSelection_MiniCard_C::Locked' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, OnEmptyClicked) == 0x001700, "Member 'UW_RosterSelection_MiniCard_C::OnEmptyClicked' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, OnFocused) == 0x001710, "Member 'UW_RosterSelection_MiniCard_C::OnFocused' has a wrong offset!");
static_assert(offsetof(UW_RosterSelection_MiniCard_C, OnUnfocused) == 0x001720, "Member 'UW_RosterSelection_MiniCard_C::OnUnfocused' has a wrong offset!");

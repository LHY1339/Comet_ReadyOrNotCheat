...
{
public:
	struct FLevelDataLookupTable                  LevelDataLookupTable;                              // 0x0000(0x0818)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	TDelegate<void(class UW_PreMission_Tablet_EntryPoint_C* Clicked)> OnEntryPointSelected;          // 0x0818(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash)
	class FName                                   PointTag;                                          // 0x0828(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                   PointName;                                         // 0x0830(0x0018)(Edit, BlueprintVisible)
	TArray<struct FEntryPoint>                    EntryPoints;                                       // 0x0848(0x0010)(Edit, BlueprintVisible)
	class UW_PreMission_Tablet_EntryPoint_C*      NewEntryPoint;                                     // 0x0858(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_PreMission_PlanningMap_C_CreateEntryPoints) == 0x000860, "Wrong size on W_PreMission_PlanningMap_C_CreateEntryPoints");
...
static_assert(offsetof(W_PreMission_PlanningMap_C_CreateEntryPoints, OnEntryPointSelected) == 0x000818, "Member 'W_PreMission_PlanningMap_C_CreateEntryPoints::OnEntryPointSelected' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_CreateEntryPoints, PointTag) == 0x000828, "Member 'W_PreMission_PlanningMap_C_CreateEntryPoints::PointTag' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_CreateEntryPoints, PointName) == 0x000830, "Member 'W_PreMission_PlanningMap_C_CreateEntryPoints::PointName' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_CreateEntryPoints, EntryPoints) == 0x000848, "Member 'W_PreMission_PlanningMap_C_CreateEntryPoints::EntryPoints' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_CreateEntryPoints, NewEntryPoint) == 0x000858, "Member 'W_PreMission_PlanningMap_C_CreateEntryPoints::NewEntryPoint' has a wrong offset!");
...
public:
	...
	class UW_PreMission_PlanningMap_Line_C*       CallFunc_Create_ReturnValue;                       // 0x0090(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UW_OfficerMarker_C*                     CallFunc_Create_ReturnValue_1;                     // 0x00A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_PreMission_Tablet_PlayerNode_C*      CallFunc_Create_ReturnValue_2;                     // 0x00B0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_Array_Get_Item;                           // 0x00C0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UW_OfficerMarker_C* TriggeringMarker)> K2Node_CreateDelegate_OutputDelegate; // 0x00D4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_GetPlayerTeamColor_LinearColor;           // 0x00E4(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateColor                            CallFunc_GetPlayerTeamColor_SlateColor;            // 0x00F4(0x0014)()
	TDelegate<void(class UW_OfficerMarker_C* TriggeringMarker)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0108(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FAnchors                               K2Node_MakeStruct_Anchors;                         // 0x0120(0x0020)(NoDestructor)
	...
	struct FAnchorData                            K2Node_MakeStruct_AnchorData;                      // 0x0148(0x0040)(NoDestructor)
	...
	double                                        CallFunc_GetLineAngle_Angle;                       // 0x0190(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_GetLineLength_Length;                     // 0x0198(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FAnchors                               K2Node_MakeStruct_Anchors_1;                       // 0x01A0(0x0020)(NoDestructor)
	struct FAnchorData                            K2Node_MakeStruct_AnchorData_1;                    // 0x01C0(0x0040)(NoDestructor)
	class UCanvasPanelSlot*                       CallFunc_AddChildToCanvas_ReturnValue_1;           // 0x0200(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UCanvasPanel*                           CallFunc_SpawnObject_ReturnValue;                  // 0x0208(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FAnchors                               K2Node_MakeStruct_Anchors_2;                       // 0x0210(0x0020)(NoDestructor)
	class UCanvasPanelSlot*                       CallFunc_AddChildToCanvas_ReturnValue_2;           // 0x0230(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FAnchorData                            K2Node_MakeStruct_AnchorData_2;                    // 0x0238(0x0040)(NoDestructor)
};
...
static_assert(sizeof(W_PreMission_PlanningMap_C_DrawLine) == 0x000278, "Wrong size on W_PreMission_PlanningMap_C_DrawLine");
...
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, EndOffset) == 0x000050, "Member 'W_PreMission_PlanningMap_C_DrawLine::EndOffset' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, StartOffset) == 0x000058, "Member 'W_PreMission_PlanningMap_C_DrawLine::StartOffset' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, PreviousPoint) == 0x000060, "Member 'W_PreMission_PlanningMap_C_DrawLine::PreviousPoint' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, Coordinates) == 0x000070, "Member 'W_PreMission_PlanningMap_C_DrawLine::Coordinates' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, NodeWidget) == 0x000080, "Member 'W_PreMission_PlanningMap_C_DrawLine::NodeWidget' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, FirstNode) == 0x000088, "Member 'W_PreMission_PlanningMap_C_DrawLine::FirstNode' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Create_ReturnValue) == 0x000090, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Array_Length_ReturnValue) == 0x000098, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Array_LastIndex_ReturnValue) == 0x00009C, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Array_LastIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_GetPlayerStateFromPlanningNumber_ReturnValue) == 0x0000A0, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_GetPlayerStateFromPlanningNumber_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Create_ReturnValue_1) == 0x0000A8, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Create_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Create_ReturnValue_2) == 0x0000B0, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Create_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, Temp_int_Array_Index_Variable) == 0x0000B8, "Member 'W_PreMission_PlanningMap_C_DrawLine::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Array_Get_Item) == 0x0000C0, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0000D0, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_EqualEqual_IntInt_ReturnValue_1) == 0x0000D1, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_EqualEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_CreateDelegate_OutputDelegate) == 0x0000D4, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_GetPlayerTeamColor_LinearColor) == 0x0000E4, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_GetPlayerTeamColor_LinearColor' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_GetPlayerTeamColor_SlateColor) == 0x0000F4, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_GetPlayerTeamColor_SlateColor' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_CreateDelegate_OutputDelegate_1) == 0x000108, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_AddChildToCanvas_ReturnValue) == 0x000118, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_AddChildToCanvas_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_MakeStruct_Anchors) == 0x000120, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_MakeStruct_Anchors' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, Temp_int_Loop_Counter_Variable) == 0x000140, "Member 'W_PreMission_PlanningMap_C_DrawLine::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_MakeStruct_AnchorData) == 0x000148, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_MakeStruct_AnchorData' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Less_IntInt_ReturnValue) == 0x000188, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_Add_IntInt_ReturnValue) == 0x00018C, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_GetLineAngle_Angle) == 0x000190, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_GetLineAngle_Angle' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_GetLineLength_Length) == 0x000198, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_GetLineLength_Length' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_MakeStruct_Anchors_1) == 0x0001A0, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_MakeStruct_Anchors_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_MakeStruct_AnchorData_1) == 0x0001C0, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_MakeStruct_AnchorData_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_AddChildToCanvas_ReturnValue_1) == 0x000200, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_AddChildToCanvas_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_SpawnObject_ReturnValue) == 0x000208, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_MakeStruct_Anchors_2) == 0x000210, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_MakeStruct_Anchors_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, CallFunc_AddChildToCanvas_ReturnValue_2) == 0x000230, "Member 'W_PreMission_PlanningMap_C_DrawLine::CallFunc_AddChildToCanvas_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_DrawLine, K2Node_MakeStruct_AnchorData_2) == 0x000238, "Member 'W_PreMission_PlanningMap_C_DrawLine::K2Node_MakeStruct_AnchorData_2' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UW_PremissionTablet_Button_C*           K2Node_ComponentBoundEvent_TriggeringButton;       // 0x0008(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FLevelDataLookupTable                  K2Node_Event_LevelData_1;                          // 0x00C0(0x0818)()
	double                                        K2Node_Event_Delay;                                // 0x08D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_Collapse;                             // 0x08E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FEntryPoint                            K2Node_Event_NewEntryPoint;                        // 0x08F0(0x00A8)()
	...
	int32                                         K2Node_CustomEvent_LineID;                         // 0x099C(0x0004)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	const class UCanvasPanel*                     K2Node_CustomEvent_LineCanvas;                     // 0x09A0(0x0008)(ConstParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UW_PreMission_Tablet_EntryPoint_C* Clicked)> K2Node_CreateDelegate_OutputDelegate; // 0x09A8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UCommonInputSubsystem*                  CallFunc_GetLocalPlayerSubsystem_ReturnValue;      // 0x09B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              CallFunc_GetCurrentInputType_ReturnValue;          // 0x09C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x09C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_NotEqual_ObjectObject_ReturnValue;        // 0x09C2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_9C3[0x1];                                      // 0x09C3(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_InGeometry;                           // 0x09C4(0x0038)(ConstParm, IsPlainOldData, NoDestructor)
	uint8                                         Pad_9FC[0x4];                                      // 0x09FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPointerEvent                          K2Node_Event_InMouseEvent;                         // 0x0A00(0x0078)(ConstParm)
	double                                        K2Node_Event_CurrentZoom;                          // 0x0A78(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_ID_2;                                 // 0x0A80(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_ID_1;                                 // 0x0A84(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FPlanningLine                          K2Node_Event_Line;                                 // 0x0A88(0x0028)(ConstParm)
	int32                                         K2Node_Event_ID;                                   // 0x0AB0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_AB4[0x4];                                      // 0x0AB4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 K2Node_Event_URL;                                  // 0x0AB8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	struct FLevelDataLookupTable                  K2Node_Event_LevelData;                            // 0x0AC8(0x0818)(ConstParm)
	struct FFocusEvent                            K2Node_Event_InFocusEvent;                         // 0x12E0(0x0008)(NoDestructor)
	class UW_PreMission_PlanningMap_Level_C*      CallFunc_Map_Find_Value;                           // 0x12E8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue;                     // 0x12F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_12F1[0x7];                                     // 0x12F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UW_PreMission_PlanningMap_Level_C*      CallFunc_Map_Find_Value_1;                         // 0x12F8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue_1;                   // 0x1300(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1301[0x3];                                     // 0x1301(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(ECommonInputType bNewInputType)> K2Node_CreateDelegate_OutputDelegate_1;          // 0x1304(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1314[0x4];                                     // 0x1314(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UW_PreMission_Tablet_MapMarker_C*       CallFunc_Map_Find_Value_2;                         // 0x1318(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue_2;                   // 0x1320(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x1321(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              K2Node_CustomEvent_bNewInputType;                  // 0x1322(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x1323(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FMissionPlanLineColors                 CallFunc_GetPlanLineColors_Colors;                 // 0x1324(0x0030)(NoDestructor)
	float                                         CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast; // 0x1354(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Gamepad_Zoom_Map_DeltaTime_ImplicitCast;  // 0x1358(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap) == 0x001360, "Wrong size on W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap");
...
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_ComponentBoundEvent_TriggeringButton) == 0x000008, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_ComponentBoundEvent_TriggeringButton' has a wrong offset!");
...
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_Delay) == 0x0008D8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_Delay' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_Collapse) == 0x0008E0, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_Collapse' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_GetOwningPlayer_ReturnValue) == 0x0008E8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_NewEntryPoint) == 0x0008F0, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_NewEntryPoint' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_HasAuthority_ReturnValue) == 0x000998, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_CustomEvent_LineID) == 0x00099C, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_CustomEvent_LineID' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_CustomEvent_LineCanvas) == 0x0009A0, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_CustomEvent_LineCanvas' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_CreateDelegate_OutputDelegate) == 0x0009A8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_GetLocalPlayerSubsystem_ReturnValue) == 0x0009B8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_GetLocalPlayerSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_GetCurrentInputType_ReturnValue) == 0x0009C0, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_IsValid_ReturnValue) == 0x0009C1, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_NotEqual_ObjectObject_ReturnValue) == 0x0009C2, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_NotEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_InGeometry) == 0x0009C4, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_InGeometry' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_InMouseEvent) == 0x000A00, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_InMouseEvent' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_CurrentZoom) == 0x000A78, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_CurrentZoom' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_ID_2) == 0x000A80, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_ID_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_ID_1) == 0x000A84, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_ID_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_Line) == 0x000A88, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_Line' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_ID) == 0x000AB0, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_ID' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_URL) == 0x000AB8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_URL' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_LevelData) == 0x000AC8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_LevelData' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_Event_InFocusEvent) == 0x0012E0, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_Event_InFocusEvent' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_Map_Find_Value) == 0x0012E8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_Map_Find_ReturnValue) == 0x0012F0, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_Map_Find_Value_1) == 0x0012F8, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_Map_Find_ReturnValue_1) == 0x001300, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_CreateDelegate_OutputDelegate_1) == 0x001304, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_Map_Find_Value_2) == 0x001318, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_Map_Find_Value_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_Map_Find_ReturnValue_2) == 0x001320, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_Map_Find_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_IsValid_ReturnValue_1) == 0x001321, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, K2Node_CustomEvent_bNewInputType) == 0x001322, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::K2Node_CustomEvent_bNewInputType' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x001323, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_GetPlanLineColors_Colors) == 0x001324, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_GetPlanLineColors_Colors' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast) == 0x001354, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap, CallFunc_Gamepad_Zoom_Map_DeltaTime_ImplicitCast) == 0x001358, "Member 'W_PreMission_PlanningMap_C_ExecuteUbergraph_W_PreMission_PlanningMap::CallFunc_Gamepad_Zoom_Map_DeltaTime_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(W_PreMission_PlanningMap_C_MissionChanged) == 0x000828, "Wrong size on W_PreMission_PlanningMap_C_MissionChanged");
...
public:
	...
	struct FLevelDataLookupTable                  LevelData;                                         // 0x0010(0x0818)(BlueprintVisible, BlueprintReadOnly, Parm)
	bool                                          CallFunc_Array_IsValidIndex_ReturnValue;           // 0x0828(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_829[0x3];                                      // 0x0829(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x082C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsEmpty_ReturnValue;                      // 0x0835(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_836[0x2];                                      // 0x0836(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Temp_int_Array_Index_Variable;                     // 0x0838(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Loop_Counter_Variable;                    // 0x083C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLevelFloor                            CallFunc_Array_Get_Item;                           // 0x0840(0x0068)()
	...
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x08AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCanvasPanelSlot*                       CallFunc_SlotAsCanvasSlot_ReturnValue;             // 0x08B0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast; // 0x08BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_PreMission_PlanningMap_C_MissionSetup) == 0x0008C0, "Wrong size on W_PreMission_PlanningMap_C_MissionSetup");
...
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000828, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_Array_Length_ReturnValue) == 0x00082C, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_Array_Length_ReturnValue_1) == 0x000830, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_Greater_IntInt_ReturnValue) == 0x000834, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_IsEmpty_ReturnValue) == 0x000835, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, Temp_int_Array_Index_Variable) == 0x000838, "Member 'W_PreMission_PlanningMap_C_MissionSetup::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, Temp_int_Loop_Counter_Variable) == 0x00083C, "Member 'W_PreMission_PlanningMap_C_MissionSetup::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_Array_Get_Item) == 0x000840, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_Less_IntInt_ReturnValue) == 0x0008A8, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_Add_IntInt_ReturnValue) == 0x0008AC, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_SlotAsCanvasSlot_ReturnValue) == 0x0008B0, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_SlotAsCanvasSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_NotEqual_StrStr_ReturnValue) == 0x0008B8, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_NotEqual_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_MissionSetup, CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast) == 0x0008BC, "Member 'W_PreMission_PlanningMap_C_MissionSetup::CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(W_PreMission_PlanningMap_C_OnKeyUp, CallFunc_Not_PreBool_ReturnValue) == 0x00017A, "Member 'W_PreMission_PlanningMap_C_OnKeyUp::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_OnKeyUp, CallFunc_BooleanAND_ReturnValue_1) == 0x00017B, "Member 'W_PreMission_PlanningMap_C_OnKeyUp::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_PreMission_PlanningMap_C_OnKeyUp, CallFunc_BooleanAND_ReturnValue_2) == 0x00017C, "Member 'W_PreMission_PlanningMap_C_OnKeyUp::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
...
static_assert(sizeof(W_PreMission_PlanningMap_C_OnMissionChanged) == 0x000828, "Wrong size on W_PreMission_PlanningMap_C_OnMissionChanged");

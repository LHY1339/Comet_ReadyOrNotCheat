...
public:
	...
	class AObjective*                             Objective;                                         // 0x02E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class UClass*                                 ObjectiveClass;                                    // 0x02F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class FText                                   ObjectiveName;                                     // 0x02F8(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                   ObjectiveDescription;                              // 0x0310(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
	EObjectiveStatus                              ObjectiveStatus;                                   // 0x0328(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bIsBombDefusal;                                    // 0x0329(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UW_PreMission_Tablet_Objectives_Entry_C) == 0x000330, "Wrong size on UW_PreMission_Tablet_Objectives_Entry_C");
...
static_assert(offsetof(UW_PreMission_Tablet_Objectives_Entry_C, Objective) == 0x0002E8, "Member 'UW_PreMission_Tablet_Objectives_Entry_C::Objective' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_Objectives_Entry_C, ObjectiveClass) == 0x0002F0, "Member 'UW_PreMission_Tablet_Objectives_Entry_C::ObjectiveClass' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_Objectives_Entry_C, ObjectiveName) == 0x0002F8, "Member 'UW_PreMission_Tablet_Objectives_Entry_C::ObjectiveName' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_Objectives_Entry_C, ObjectiveDescription) == 0x000310, "Member 'UW_PreMission_Tablet_Objectives_Entry_C::ObjectiveDescription' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_Objectives_Entry_C, ObjectiveStatus) == 0x000328, "Member 'UW_PreMission_Tablet_Objectives_Entry_C::ObjectiveStatus' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_Objectives_Entry_C, bIsBombDefusal) == 0x000329, "Member 'UW_PreMission_Tablet_Objectives_Entry_C::bIsBombDefusal' has a wrong offset!");

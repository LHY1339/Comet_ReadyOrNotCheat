...
public:
	...
	class UW_Text_C*                              txt_TextInputError;                                // 0x0528(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UW_Text_C*                              txt_TextInputLabel;                                // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UW_Text_C*                              txt_Title;                                         // 0x0538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           VB_TextInput;                                      // 0x0540(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           VerticalBox_103;                                   // 0x0548(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UW_PageWrapper_C*                       W_PageWrapper;                                     // 0x0550(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TMulticastInlineDelegate<void(class UW_StandardModal_C* CallingModal, class FText TextEntry)> OnOkClicked; // 0x0558(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UW_StandardModal_C* CallingModal, class FText TextEntry)> OnApplyClicked; // 0x0568(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                          ScrolledToBottom;                                  // 0x0578(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          TextEntryModal;                                    // 0x0579(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_57A[0x6];                                      // 0x057A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   TextEntryLabel;                                    // 0x0580(0x0018)(Edit, BlueprintVisible, ExposeOnSpawn)
	class FText                                   TextEntryHint;                                     // 0x0598(0x0018)(Edit, BlueprintVisible, ExposeOnSpawn)
	class FText                                   TextEntryText;                                     // 0x05B0(0x0018)(Edit, BlueprintVisible, ExposeOnSpawn)
	TMulticastInlineDelegate<void(class UW_StandardModal_C* CallingModal, class FText TextEntry)> OnTextCommitted; // 0x05C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                          IsTextConfirm;                                     // 0x05D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          ShowDescriptionBox;                                // 0x05D9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_5DA[0x2];                                      // 0x05DA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TextEntryMaxCharacters;                            // 0x05DC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	int32                                         TextEntryMinCharacters;                            // 0x05E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_5E4[0x4];                                      // 0x05E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UW_Button_C*                            FocusTarget;                                       // 0x05E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UW_StandardModal_C) == 0x0005F0, "Wrong size on UW_StandardModal_C");
...
static_assert(offsetof(UW_StandardModal_C, txt_TextInputError) == 0x000528, "Member 'UW_StandardModal_C::txt_TextInputError' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, txt_TextInputLabel) == 0x000530, "Member 'UW_StandardModal_C::txt_TextInputLabel' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, txt_Title) == 0x000538, "Member 'UW_StandardModal_C::txt_Title' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, VB_TextInput) == 0x000540, "Member 'UW_StandardModal_C::VB_TextInput' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, VerticalBox_103) == 0x000548, "Member 'UW_StandardModal_C::VerticalBox_103' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, W_PageWrapper) == 0x000550, "Member 'UW_StandardModal_C::W_PageWrapper' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, OnOkClicked) == 0x000558, "Member 'UW_StandardModal_C::OnOkClicked' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, OnApplyClicked) == 0x000568, "Member 'UW_StandardModal_C::OnApplyClicked' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, ScrolledToBottom) == 0x000578, "Member 'UW_StandardModal_C::ScrolledToBottom' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, TextEntryModal) == 0x000579, "Member 'UW_StandardModal_C::TextEntryModal' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, TextEntryLabel) == 0x000580, "Member 'UW_StandardModal_C::TextEntryLabel' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, TextEntryHint) == 0x000598, "Member 'UW_StandardModal_C::TextEntryHint' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, TextEntryText) == 0x0005B0, "Member 'UW_StandardModal_C::TextEntryText' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, OnTextCommitted) == 0x0005C8, "Member 'UW_StandardModal_C::OnTextCommitted' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, IsTextConfirm) == 0x0005D8, "Member 'UW_StandardModal_C::IsTextConfirm' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, ShowDescriptionBox) == 0x0005D9, "Member 'UW_StandardModal_C::ShowDescriptionBox' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, TextEntryMaxCharacters) == 0x0005DC, "Member 'UW_StandardModal_C::TextEntryMaxCharacters' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, TextEntryMinCharacters) == 0x0005E0, "Member 'UW_StandardModal_C::TextEntryMinCharacters' has a wrong offset!");
static_assert(offsetof(UW_StandardModal_C, FocusTarget) == 0x0005E8, "Member 'UW_StandardModal_C::FocusTarget' has a wrong offset!");

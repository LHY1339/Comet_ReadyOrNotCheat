...
void UW_Options_Graphics_UE5_C::BndEvt__SimpleGraphics_Slider_FieldOfView_K2Node_ComponentBoundEvent_21_OnIntegralValueChanged__DelegateSignature(int32 NewIntegerValue, double NewSliderValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("W_Options_Graphics_UE5_C", "BndEvt__SimpleGraphics_Slider_FieldOfView_K2Node_ComponentBoundEvent_21_OnIntegralValueChanged__DelegateSignature");

	Params::W_Options_Graphics_UE5_C_BndEvt__SimpleGraphics_Slider_FieldOfView_K2Node_ComponentBoundEvent_21_OnIntegralValueChanged__DelegateSignature Parms{};
...
void UW_Options_Graphics_UE5_C::BndEvt__W_SettingsMenuGamepad_Options_Gamepad_FOV_K2Node_ComponentBoundEvent_33_OnIntegralValueChanged__DelegateSignature(int32 NewIntegerValue, double NewSliderValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("W_Options_Graphics_UE5_C", "BndEvt__W_SettingsMenuGamepad_Options_Gamepad_FOV_K2Node_ComponentBoundEvent_33_OnIntegralValueChanged__DelegateSignature");

	Params::W_Options_Graphics_UE5_C_BndEvt__W_SettingsMenuGamepad_Options_Gamepad_FOV_K2Node_ComponentBoundEvent_33_OnIntegralValueChanged__DelegateSignature Parms{};

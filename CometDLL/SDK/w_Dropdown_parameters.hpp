...
static_assert(sizeof(w_Dropdown_C_CloseMenu) == 0x000018, "Wrong size on w_Dropdown_C_CloseMenu");
...
static_assert(offsetof(w_Dropdown_C_CloseMenu, CallFunc_IsOpen_ReturnValue) == 0x000010, "Member 'w_Dropdown_C_CloseMenu::CallFunc_IsOpen_ReturnValue' has a wrong offset!");

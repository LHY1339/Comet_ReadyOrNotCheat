...
void UW_Loadout_V2_C::EquipItem(class UClass* ItemData_0)
{
	static class UFunction* Func = nullptr;
...
// class UW_Loadout_ItemList_Vertical_C*   Itemlist                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UW_Loadout_V2_C::OpenItemList(bool VerticalList, const EItemCategory LoadoutSlot, const TArray<struct LoadoutCategory::FLoadoutCategory>& GearCategoryClasses, class UW_Loadout_ItemList_Vertical_C* Itemlist)
{
	static class UFunction* Func = nullptr;

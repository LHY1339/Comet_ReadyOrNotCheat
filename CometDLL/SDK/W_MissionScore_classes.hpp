...
public:
	...
	class UVerticalBox*                           VB_BestGrade;                                      // 0x0458(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UW_Briefing_Objectives_List_C*          W_Briefing_Objectives_List;                        // 0x0460(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UW_MissionScore_Progress_C*             W_MissionEnd_Rating_Progress_C_1;                  // 0x0468(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UButton*                                WidgetFocusButton;                                 // 0x0470(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UObject*>                        AllPenalties;                                      // 0x0478(0x0010)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
	int32                                         CurrentScore;                                      // 0x0488(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_48C[0x4];                                      // 0x048C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   RatingFormat;                                      // 0x0490(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
	class APlayerController*                      OwningPlayer;                                      // 0x04A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          NewBestRating;                                     // 0x04B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          NewBestTime;                                       // 0x04B1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B2[0x6];                                      // 0x04B2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        TimeElapsed;                                       // 0x04B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TMulticastInlineDelegate<void()>              OnScoringComplete;                                 // 0x04C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UW_MissionScore_C) == 0x0004D0, "Wrong size on UW_MissionScore_C");
...
static_assert(offsetof(UW_MissionScore_C, VB_BestGrade) == 0x000458, "Member 'UW_MissionScore_C::VB_BestGrade' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, W_Briefing_Objectives_List) == 0x000460, "Member 'UW_MissionScore_C::W_Briefing_Objectives_List' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, W_MissionEnd_Rating_Progress_C_1) == 0x000468, "Member 'UW_MissionScore_C::W_MissionEnd_Rating_Progress_C_1' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, WidgetFocusButton) == 0x000470, "Member 'UW_MissionScore_C::WidgetFocusButton' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, AllPenalties) == 0x000478, "Member 'UW_MissionScore_C::AllPenalties' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, CurrentScore) == 0x000488, "Member 'UW_MissionScore_C::CurrentScore' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, RatingFormat) == 0x000490, "Member 'UW_MissionScore_C::RatingFormat' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, OwningPlayer) == 0x0004A8, "Member 'UW_MissionScore_C::OwningPlayer' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, NewBestRating) == 0x0004B0, "Member 'UW_MissionScore_C::NewBestRating' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, NewBestTime) == 0x0004B1, "Member 'UW_MissionScore_C::NewBestTime' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, TimeElapsed) == 0x0004B8, "Member 'UW_MissionScore_C::TimeElapsed' has a wrong offset!");
static_assert(offsetof(UW_MissionScore_C, OnScoringComplete) == 0x0004C0, "Member 'UW_MissionScore_C::OnScoringComplete' has a wrong offset!");

...
// Parameters:
// const class FString&                    MissionURL                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// const struct FLevelDataLookupTable&     MissionData                                            (BlueprintVisible, BlueprintReadOnly, Parm)

void UW_PreMission_Tablet_Brief_C::UpdateMission(const class FString& MissionURL, const struct FLevelDataLookupTable& MissionData)
{
	static class UFunction* Func = nullptr;

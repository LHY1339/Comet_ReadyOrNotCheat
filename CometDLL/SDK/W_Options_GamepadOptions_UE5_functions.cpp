...
// Function W_Options_GamepadOptions_UE5.W_Options_GamepadOptions_UE5_C.BndEvt__W_Options_GamepadOptions_UE5_Controls_OnOff_StickLayout_1_K2Node_ComponentBoundEvent_0_OnValueStateChange__DelegateSignature
// (BlueprintEvent)
// Parameters:
// bool                                    bNewCheckState                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_Options_GamepadOptions_UE5_C::BndEvt__W_Options_GamepadOptions_UE5_Controls_OnOff_StickLayout_1_K2Node_ComponentBoundEvent_0_OnValueStateChange__DelegateSignature(bool bNewCheckState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("W_Options_GamepadOptions_UE5_C", "BndEvt__W_Options_GamepadOptions_UE5_Controls_OnOff_StickLayout_1_K2Node_ComponentBoundEvent_0_OnValueStateChange__DelegateSignature");

	Params::W_Options_GamepadOptions_UE5_C_BndEvt__W_Options_GamepadOptions_UE5_Controls_OnOff_StickLayout_1_K2Node_ComponentBoundEvent_0_OnValueStateChange__DelegateSignature Parms{};

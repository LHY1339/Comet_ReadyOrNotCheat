...
static_assert(sizeof(UAIAction_Startle_C) == 0x0000A8, "Wrong size on UAIAction_Startle_C");
...
static_assert(offsetof(UAIAction_Startle_C, bTrackingTarget) == 0x000090, "Member 'UAIAction_Startle_C::bTrackingTarget' has a wrong offset!");
static_assert(offsetof(UAIAction_Startle_C, Cooldown) == 0x000098, "Member 'UAIAction_Startle_C::Cooldown' has a wrong offset!");
static_assert(offsetof(UAIAction_Startle_C, bIsCoolingDown) == 0x0000A0, "Member 'UAIAction_Startle_C::bIsCoolingDown' has a wrong offset!");
static_assert(offsetof(UAIAction_Startle_C, bEverShotBefore) == 0x0000A1, "Member 'UAIAction_Startle_C::bEverShotBefore' has a wrong offset!");

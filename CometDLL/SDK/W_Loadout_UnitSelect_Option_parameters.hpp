...
public:
	...
	bool                                          K2Node_CustomEvent_IsSelected;                     // 0x0378(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_379[0x7];                                      // 0x0379(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        K2Node_Event_Delay_1;                              // 0x0380(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        K2Node_Event_Delay;                                // 0x0390(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_Collapse;                             // 0x0398(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_399[0x3];                                      // 0x0399(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFocusEvent                            K2Node_Event_InFocusEvent;                         // 0x039C(0x0008)(NoDestructor)
	...
	bool                                          CallFunc_HasUserFocus_ReturnValue;                 // 0x03B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Delay_Duration_ImplicitCast_1;            // 0x03B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option) == 0x0003C0, "Wrong size on W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option");
...
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_CurrentSlot) == 0x0002F8, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_CurrentSlot' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_ItemCategory) == 0x000300, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_ItemCategory' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_LoadoutWidget) == 0x000350, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_LoadoutWidget' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_OptionNameID) == 0x000358, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_OptionNameID' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_ComponentBoundEvent_Button) == 0x000360, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, CallFunc_PlayAnimationForward_ReturnValue) == 0x000368, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, CallFunc_PlayAnimationReverse_ReturnValue) == 0x000370, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::CallFunc_PlayAnimationReverse_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_CustomEvent_IsSelected) == 0x000378, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_CustomEvent_IsSelected' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_Delay_1) == 0x000380, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_Delay_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Select_Default) == 0x000388, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_Delay) == 0x000390, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_Delay' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_Collapse) == 0x000398, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_Collapse' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, K2Node_Event_InFocusEvent) == 0x00039C, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::K2Node_Event_InFocusEvent' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, CallFunc_GetOwningPlayer_ReturnValue) == 0x0003A8, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, CallFunc_HasUserFocus_ReturnValue) == 0x0003B0, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::CallFunc_HasUserFocus_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, CallFunc_Delay_Duration_ImplicitCast) == 0x0003B4, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option, CallFunc_Delay_Duration_ImplicitCast_1) == 0x0003B8, "Member 'W_Loadout_UnitSelect_Option_C_ExecuteUbergraph_W_Loadout_UnitSelect_Option::CallFunc_Delay_Duration_ImplicitCast_1' has a wrong offset!");

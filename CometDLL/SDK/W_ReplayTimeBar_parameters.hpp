...
public:
	...
	float                                         CallFunc_GetCurrentReplayCurrentTimeInSeconds_ReturnValue; // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        K2Node_CustomEvent_BarPercentage;                  // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FReplayEvent                           K2Node_CustomEvent_ReplayEvent;                    // 0x0088(0x0038)()
	double                                        K2Node_CallDelegate_NewCurrentTimeInSeconds_ImplicitCast; // 0x00C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar) == 0x0000C8, "Wrong size on W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar");
...
static_assert(offsetof(W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar, CallFunc_GetCurrentReplayCurrentTimeInSeconds_ReturnValue) == 0x00003C, "Member 'W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar::CallFunc_GetCurrentReplayCurrentTimeInSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar, K2Node_Event_MyGeometry) == 0x000040, "Member 'W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar, K2Node_Event_InDeltaTime) == 0x000078, "Member 'W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar, K2Node_CustomEvent_BarPercentage) == 0x000080, "Member 'W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar::K2Node_CustomEvent_BarPercentage' has a wrong offset!");
static_assert(offsetof(W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar, K2Node_CustomEvent_ReplayEvent) == 0x000088, "Member 'W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar::K2Node_CustomEvent_ReplayEvent' has a wrong offset!");
static_assert(offsetof(W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar, K2Node_CallDelegate_NewCurrentTimeInSeconds_ImplicitCast) == 0x0000C0, "Member 'W_ReplayTimeBar_C_ExecuteUbergraph_W_ReplayTimeBar::K2Node_CallDelegate_NewCurrentTimeInSeconds_ImplicitCast' has a wrong offset!");

...
static_assert(sizeof(APrimary_SawnOff_C) == 0x0017D0, "Wrong size on APrimary_SawnOff_C");
static_assert(offsetof(APrimary_SawnOff_C, UberGraphFrame) == 0x0017B0, "Member 'APrimary_SawnOff_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(APrimary_SawnOff_C, PointLight) == 0x0017B8, "Member 'APrimary_SawnOff_C::PointLight' has a wrong offset!");
static_assert(offsetof(APrimary_SawnOff_C, PointLight1) == 0x0017C0, "Member 'APrimary_SawnOff_C::PointLight1' has a wrong offset!");
static_assert(offsetof(APrimary_SawnOff_C, LightToggle1P) == 0x0017C8, "Member 'APrimary_SawnOff_C::LightToggle1P' has a wrong offset!");

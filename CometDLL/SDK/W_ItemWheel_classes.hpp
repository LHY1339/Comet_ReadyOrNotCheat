...
public:
	...
	class UCanvasPanel*                           ItemWheelCanvasPanel;                              // 0x0500(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UW_WheelIcon_C*>                 MainWheelIcons;                                    // 0x0508(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	double                                        IconSize;                                          // 0x0518(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UW_WheelIcon_C*>                 SubWheelIcons;                                     // 0x0520(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	bool                                          InDeadZone;                                        // 0x0530(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UW_ItemWheel_C) == 0x000540, "Wrong size on UW_ItemWheel_C");
...
static_assert(offsetof(UW_ItemWheel_C, ItemWheelCanvasPanel) == 0x000500, "Member 'UW_ItemWheel_C::ItemWheelCanvasPanel' has a wrong offset!");
static_assert(offsetof(UW_ItemWheel_C, MainWheelIcons) == 0x000508, "Member 'UW_ItemWheel_C::MainWheelIcons' has a wrong offset!");
static_assert(offsetof(UW_ItemWheel_C, IconSize) == 0x000518, "Member 'UW_ItemWheel_C::IconSize' has a wrong offset!");
static_assert(offsetof(UW_ItemWheel_C, SubWheelIcons) == 0x000520, "Member 'UW_ItemWheel_C::SubWheelIcons' has a wrong offset!");
static_assert(offsetof(UW_ItemWheel_C, InDeadZone) == 0x000530, "Member 'UW_ItemWheel_C::InDeadZone' has a wrong offset!");

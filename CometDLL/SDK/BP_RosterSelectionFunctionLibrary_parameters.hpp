...
public:
	...
	class FText                                   CallFunc_TextTrimPrecedingAndTrailing_ReturnValue; // 0x00F0(0x0018)()
};
...
static_assert(sizeof(BP_RosterSelectionFunctionLibrary_C_FormatName) == 0x000108, "Wrong size on BP_RosterSelectionFunctionLibrary_C_FormatName");
...
static_assert(offsetof(BP_RosterSelectionFunctionLibrary_C_FormatName, K2Node_MakeStruct_FormatArgumentData_1) == 0x000078, "Member 'BP_RosterSelectionFunctionLibrary_C_FormatName::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(BP_RosterSelectionFunctionLibrary_C_FormatName, K2Node_MakeArray_Array) == 0x0000C8, "Member 'BP_RosterSelectionFunctionLibrary_C_FormatName::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(BP_RosterSelectionFunctionLibrary_C_FormatName, CallFunc_Format_ReturnValue) == 0x0000D8, "Member 'BP_RosterSelectionFunctionLibrary_C_FormatName::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RosterSelectionFunctionLibrary_C_FormatName, CallFunc_TextTrimPrecedingAndTrailing_ReturnValue) == 0x0000F0, "Member 'BP_RosterSelectionFunctionLibrary_C_FormatName::CallFunc_TextTrimPrecedingAndTrailing_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_RosterSelectionFunctionLibrary_C_FormatBio) == 0x0000F8, "Wrong size on BP_RosterSelectionFunctionLibrary_C_FormatBio");
...
static_assert(offsetof(BP_RosterSelectionFunctionLibrary_C_FormatBio, K2Node_MakeStruct_FormatArgumentData_1) == 0x000080, "Member 'BP_RosterSelectionFunctionLibrary_C_FormatBio::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(BP_RosterSelectionFunctionLibrary_C_FormatBio, K2Node_MakeArray_Array) == 0x0000D0, "Member 'BP_RosterSelectionFunctionLibrary_C_FormatBio::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(BP_RosterSelectionFunctionLibrary_C_FormatBio, CallFunc_Format_ReturnValue) == 0x0000E0, "Member 'BP_RosterSelectionFunctionLibrary_C_FormatBio::CallFunc_Format_ReturnValue' has a wrong offset!");

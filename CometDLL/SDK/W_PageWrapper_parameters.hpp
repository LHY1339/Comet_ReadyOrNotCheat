...
static_assert(sizeof(W_PageWrapper_C_ShowFooter) == 0x000010, "Wrong size on W_PageWrapper_C_ShowFooter");
static_assert(offsetof(W_PageWrapper_C_ShowFooter, CallFunc_SelectFloat_ReturnValue) == 0x000000, "Member 'W_PageWrapper_C_ShowFooter::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PageWrapper_C_ShowFooter, CallFunc_SetRenderOpacity_InOpacity_ImplicitCast) == 0x000008, "Member 'W_PageWrapper_C_ShowFooter::CallFunc_SetRenderOpacity_InOpacity_ImplicitCast' has a wrong offset!");

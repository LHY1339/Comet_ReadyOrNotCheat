...
public:
	...
	bool                                          K2Node_Event_IsGamepad;                            // 0x0370(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_371[0x7];                                      // 0x0371(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        K2Node_Event_Delay_1;                              // 0x0378(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UW_LoadoutSlot_v2_C*                    K2Node_ComponentBoundEvent_TriggeringSlot_1;       // 0x03A0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_LoadoutSlot_v2_C*                    K2Node_ComponentBoundEvent_TriggeringSlot;         // 0x03A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   K2Node_Event_PageName;                             // 0x03C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              K2Node_CustomEvent_bNewInputType;                  // 0x03D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x03D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3D2[0x6];                                      // 0x03D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonInputSubsystem*                  CallFunc_GetLocalPlayerSubsystem_ReturnValue;      // 0x03D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              CallFunc_GetCurrentInputType_ReturnValue;          // 0x03E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear) == 0x0003F8, "Wrong size on W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear");
...
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_CurrentSlot) == 0x000308, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_CurrentSlot' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_ItemCategory) == 0x000310, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_ItemCategory' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_LoadoutWidget) == 0x000360, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_LoadoutWidget' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_OptionNameID) == 0x000368, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_OptionNameID' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_IsGamepad) == 0x000370, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_IsGamepad' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_Delay_1) == 0x000378, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_Delay_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_Collapse) == 0x000380, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_Collapse' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_Delay) == 0x000388, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_Delay' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_GetLoadoutWidget_AsW_Loadout_V2_1) == 0x000390, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_GetLoadoutWidget_AsW_Loadout_V2_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_GetLoadoutWidget_AsW_Loadout_V2_2) == 0x000398, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_GetLoadoutWidget_AsW_Loadout_V2_2' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_ComponentBoundEvent_TriggeringSlot_1) == 0x0003A0, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_ComponentBoundEvent_TriggeringSlot_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_ComponentBoundEvent_TriggeringSlot) == 0x0003A8, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_ComponentBoundEvent_TriggeringSlot' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_GetObjectClass_ReturnValue) == 0x0003B0, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_IsValid_ReturnValue) == 0x0003B8, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_GetReadyOrNotGameState_ReturnValue) == 0x0003C0, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_GetReadyOrNotGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_Event_PageName) == 0x0003C8, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_Event_PageName' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, K2Node_CustomEvent_bNewInputType) == 0x0003D0, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::K2Node_CustomEvent_bNewInputType' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0003D1, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_GetLocalPlayerSubsystem_ReturnValue) == 0x0003D8, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_GetLocalPlayerSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_GetCurrentInputType_ReturnValue) == 0x0003E0, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_GetLoadoutWidget_AsW_Loadout_V2_3) == 0x0003E8, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_GetLoadoutWidget_AsW_Loadout_V2_3' has a wrong offset!");
static_assert(offsetof(W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear, CallFunc_PlayEvent2D_ReturnValue) == 0x0003F0, "Member 'W_Loadout_Page_Gear_C_ExecuteUbergraph_W_Loadout_Page_Gear::CallFunc_PlayEvent2D_ReturnValue' has a wrong offset!");

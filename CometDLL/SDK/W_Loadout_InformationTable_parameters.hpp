...
{
public:
	class UW_LoadoutInfo_AttachmentListEntry_C*   AttachmentListItem;                                // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	struct FSavedLoadout                          K2Node_CustomEvent_ActiveLoadout_1;                // 0x0008(0x02E8)()
	class UClass*                                 K2Node_CustomEvent_ItemClass;                      // 0x02F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EItemCategory                                 K2Node_CustomEvent_LoadoutSlot;                    // 0x02F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_CustomEvent_Restricted;                     // 0x02F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2FA[0x2];                                      // 0x02FA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   K2Node_Event_PageName;                             // 0x02FC(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_IsGamepad;                            // 0x0304(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_305[0x3];                                      // 0x0305(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UClass*                                 K2Node_CustomEvent_ItemToModify;                   // 0x0308(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FSavedLoadout                          K2Node_CustomEvent_ActiveLoadout;                  // 0x0310(0x02E8)()
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x05F8(0x0038)(IsPlainOldData, NoDestructor)
	...
	class FName                                   K2Node_Event_OptionNameID;                         // 0x0638(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UW_Loadout_C*                           K2Node_Event_LoadoutWidget;                        // 0x0640(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FSavedLoadout                          K2Node_Event_ActiveLoadout;                        // 0x0648(0x02E8)()
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0948(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_LoadoutInfo_AttachmentListEntry_C*   K2Node_CustomEvent_AttachmentListItem_1;           // 0x0950(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue_1;              // 0x0958(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FName                                   K2Node_CustomEvent_AmmoType;                       // 0x0960(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 K2Node_CustomEvent_WeaponData;                     // 0x0968(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<EItemCategory, class UClass*>            K2Node_Event_ItemCategory;                         // 0x0970(0x0050)()
	class UArmourMaterial*                        K2Node_CustomEvent_ArmourMaterial;                 // 0x09C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 K2Node_CustomEvent_Attachment;                     // 0x09C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 K2Node_CustomEvent_AttachingWeapon;                // 0x09D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_LoadoutSlot_C*                       K2Node_Event_CurrentSlot;                          // 0x09D8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_LoadoutInfo_AttachmentListEntry_C*   K2Node_CustomEvent_AttachmentListItem;             // 0x09E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FLoadoutPreset                         K2Node_CustomEvent_LoadoutPreset;                  // 0x09E8(0x02F0)()
	float                                         CallFunc_Delay_Duration_ImplicitCast;              // 0x0CD8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Delay_Duration_ImplicitCast_1;            // 0x0CDC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable) == 0x000CE0, "Wrong size on W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable");
...
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_ItemClass) == 0x0002F0, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_ItemClass' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_LoadoutSlot) == 0x0002F8, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_LoadoutSlot' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_Restricted) == 0x0002F9, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_Restricted' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_PageName) == 0x0002FC, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_PageName' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_IsGamepad) == 0x000304, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_IsGamepad' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_ItemToModify) == 0x000308, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_ItemToModify' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_ActiveLoadout) == 0x000310, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_ActiveLoadout' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_MyGeometry) == 0x0005F8, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_InDeltaTime) == 0x000630, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_IsDesignTime) == 0x000634, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_OptionNameID) == 0x000638, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_OptionNameID' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_LoadoutWidget) == 0x000640, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_LoadoutWidget' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_ActiveLoadout) == 0x000648, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_ActiveLoadout' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_Delay_1) == 0x000930, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_Delay_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_Delay) == 0x000938, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_Delay' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_Collapse) == 0x000940, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_Collapse' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, CallFunc_PlayAnimation_ReturnValue) == 0x000948, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_AttachmentListItem_1) == 0x000950, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_AttachmentListItem_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, CallFunc_PlayAnimation_ReturnValue_1) == 0x000958, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_AmmoType) == 0x000960, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_AmmoType' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_WeaponData) == 0x000968, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_WeaponData' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_ItemCategory) == 0x000970, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_ItemCategory' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_ArmourMaterial) == 0x0009C0, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_ArmourMaterial' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_Attachment) == 0x0009C8, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_Attachment' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_AttachingWeapon) == 0x0009D0, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_AttachingWeapon' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_Event_CurrentSlot) == 0x0009D8, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_Event_CurrentSlot' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_AttachmentListItem) == 0x0009E0, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_AttachmentListItem' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, K2Node_CustomEvent_LoadoutPreset) == 0x0009E8, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::K2Node_CustomEvent_LoadoutPreset' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, CallFunc_Delay_Duration_ImplicitCast) == 0x000CD8, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable, CallFunc_Delay_Duration_ImplicitCast_1) == 0x000CDC, "Member 'W_Loadout_InformationTable_C_ExecuteUbergraph_W_Loadout_InformationTable::CallFunc_Delay_Duration_ImplicitCast_1' has a wrong offset!");
...
{
public:
	class FText                                   WeaponClass_0;                                     // 0x0000(0x0018)(Parm, OutParm)
...
static_assert(offsetof(W_Loadout_InformationTable_C_GetWeaponClassText, WeaponClass_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_GetWeaponClassText::WeaponClass_0' has a wrong offset!");
...
static_assert(alignof(W_Loadout_InformationTable_C_Hide) == 0x000008, "Wrong alignment on W_Loadout_InformationTable_C_Hide");
static_assert(sizeof(W_Loadout_InformationTable_C_Hide) == 0x000010, "Wrong size on W_Loadout_InformationTable_C_Hide");
...
static_assert(offsetof(W_Loadout_InformationTable_C_Hide, Collapse) == 0x000008, "Member 'W_Loadout_InformationTable_C_Hide::Collapse' has a wrong offset!");
...
static_assert(sizeof(W_Loadout_InformationTable_C_InitializePanel) == 0x0002E8, "Wrong size on W_Loadout_InformationTable_C_InitializePanel");
static_assert(offsetof(W_Loadout_InformationTable_C_InitializePanel, ActiveLoadout_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_InitializePanel::ActiveLoadout_0' has a wrong offset!");
...
{
public:
	class FName                                   AmmoType_0;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 WeaponData;                                        // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(W_Loadout_InformationTable_C_RefreshPanelAmmoInfo, AmmoType_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_RefreshPanelAmmoInfo::AmmoType_0' has a wrong offset!");
...
{
public:
	class UArmourMaterial*                        ArmourMaterial_0;                                  // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(W_Loadout_InformationTable_C_RefreshPanelArmourMaterial, ArmourMaterial_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_RefreshPanelArmourMaterial::ArmourMaterial_0' has a wrong offset!");
...
{
public:
	class UClass*                                 Attachment_0;                                      // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 AttachingWeapon;                                   // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(W_Loadout_InformationTable_C_RefreshPanelAttachment, Attachment_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_RefreshPanelAttachment::Attachment_0' has a wrong offset!");
...
public:
	...
	EItemCategory                                 LoadoutSlot_0;                                     // 0x02F0(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Restricted_0;                                      // 0x02F1(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_Loadout_InformationTable_C_RefreshPanelItemInfo) == 0x0002F8, "Wrong size on W_Loadout_InformationTable_C_RefreshPanelItemInfo");
static_assert(offsetof(W_Loadout_InformationTable_C_RefreshPanelItemInfo, ActiveLoadout_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_RefreshPanelItemInfo::ActiveLoadout_0' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_RefreshPanelItemInfo, ItemClass_0) == 0x0002E8, "Member 'W_Loadout_InformationTable_C_RefreshPanelItemInfo::ItemClass_0' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_RefreshPanelItemInfo, LoadoutSlot_0) == 0x0002F0, "Member 'W_Loadout_InformationTable_C_RefreshPanelItemInfo::LoadoutSlot_0' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_RefreshPanelItemInfo, Restricted_0) == 0x0002F1, "Member 'W_Loadout_InformationTable_C_RefreshPanelItemInfo::Restricted_0' has a wrong offset!");
...
static_assert(sizeof(W_Loadout_InformationTable_C_RefreshPanelLoadoutPreset) == 0x0002F0, "Wrong size on W_Loadout_InformationTable_C_RefreshPanelLoadoutPreset");
...
static_assert(alignof(W_Loadout_InformationTable_C_Reveal) == 0x000008, "Wrong alignment on W_Loadout_InformationTable_C_Reveal");
static_assert(sizeof(W_Loadout_InformationTable_C_Reveal) == 0x000008, "Wrong size on W_Loadout_InformationTable_C_Reveal");
...
public:
	...
	bool                                          Temp_bool_Variable_6;                              // 0x00CB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_CC[0x4];                                       // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   Temp_text_Variable_6;                              // 0x00D0(0x0018)()
	class FText                                   Temp_text_Variable_7;                              // 0x00E8(0x0018)()
	bool                                          Temp_bool_Variable_7;                              // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_Variable_8;                              // 0x0103(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_104[0x4];                                      // 0x0104(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   Temp_text_Variable_8;                              // 0x0108(0x0018)()
	class FText                                   Temp_text_Variable_9;                              // 0x0120(0x0018)()
	bool                                          Temp_bool_Variable_9;                              // 0x0138(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_DoubleDouble_ReturnValue_1;    // 0x01C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Less_DoubleDouble_ReturnValue_2;          // 0x0244(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_DoubleDouble_ReturnValue_3;          // 0x0245(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_DoubleDouble_ReturnValue_2;    // 0x0279(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_DoubleDouble_ReturnValue_3;    // 0x02A4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_DoubleDouble_ReturnValue_4;    // 0x02CC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_DoubleDouble_ReturnValue_4;          // 0x02CD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_1; // 0x0328(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Less_DoubleDouble_A_ImplicitCast_1;       // 0x0330(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_2; // 0x0338(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_3; // 0x0348(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Less_DoubleDouble_A_ImplicitCast_3;       // 0x0350(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_4; // 0x0358(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Less_DoubleDouble_A_ImplicitCast_4;       // 0x0360(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_Loadout_InformationTable_C_SetAttachmentEffects) == 0x000368, "Wrong size on W_Loadout_InformationTable_C_SetAttachmentEffects");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_ReturnValue) == 0x000160, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_ReturnValue) == 0x000161, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_ReturnValue_1) == 0x0001A8, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_ReturnValue_1) == 0x0001C9, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_ReturnValue_2) == 0x000244, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_ReturnValue_3) == 0x000245, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_ReturnValue_3' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_ReturnValue_2) == 0x000279, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_ReturnValue_3) == 0x0002A4, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_ReturnValue_3' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_ReturnValue_4) == 0x0002CC, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_ReturnValue_4) == 0x0002CD, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_ReturnValue_4' has a wrong offset!");
...
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast) == 0x000318, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_A_ImplicitCast) == 0x000320, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_1) == 0x000328, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_A_ImplicitCast_1) == 0x000330, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_2) == 0x000338, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_2' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_A_ImplicitCast_2) == 0x000340, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_A_ImplicitCast_2' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_3) == 0x000348, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_3' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_A_ImplicitCast_3) == 0x000350, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_A_ImplicitCast_3' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_4) == 0x000358, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_4' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_SetAttachmentEffects, CallFunc_Less_DoubleDouble_A_ImplicitCast_4) == 0x000360, "Member 'W_Loadout_InformationTable_C_SetAttachmentEffects::CallFunc_Less_DoubleDouble_A_ImplicitCast_4' has a wrong offset!");
...
static_assert(sizeof(W_Loadout_InformationTable_C_UpdateActiveLoadout) == 0x0002E8, "Wrong size on W_Loadout_InformationTable_C_UpdateActiveLoadout");
static_assert(offsetof(W_Loadout_InformationTable_C_UpdateActiveLoadout, ActiveLoadout_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_UpdateActiveLoadout::ActiveLoadout_0' has a wrong offset!");
...
public:
	...
	class UDataTable*                             CallFunc_GetAmmoLookupDataTable_ReturnValue;       // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FAmmoTypeData                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0030(0x0170)()
...
static_assert(sizeof(W_Loadout_InformationTable_C_UpdateAmmoInfo) == 0x000270, "Wrong size on W_Loadout_InformationTable_C_UpdateAmmoInfo");
...
static_assert(offsetof(W_Loadout_InformationTable_C_UpdateAmmoInfo, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0001A0, "Member 'W_Loadout_InformationTable_C_UpdateAmmoInfo::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_UpdateAmmoInfo, K2Node_MakeStruct_FormatArgumentData) == 0x0001A8, "Member 'W_Loadout_InformationTable_C_UpdateAmmoInfo::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_UpdateAmmoInfo, K2Node_MakeStruct_FormatArgumentData_1) == 0x0001F8, "Member 'W_Loadout_InformationTable_C_UpdateAmmoInfo::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_UpdateAmmoInfo, K2Node_MakeArray_Array) == 0x000248, "Member 'W_Loadout_InformationTable_C_UpdateAmmoInfo::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(W_Loadout_InformationTable_C_UpdateAmmoInfo, CallFunc_Format_ReturnValue) == 0x000258, "Member 'W_Loadout_InformationTable_C_UpdateAmmoInfo::CallFunc_Format_ReturnValue' has a wrong offset!");
...
public:
	...
	class UW_LoadoutInfo_EffectsList_C*           CallFunc_Create_ReturnValue;                       // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
{
public:
	TMap<EItemCategory, class UClass*>            ItemCategory_0;                                    // 0x0000(0x0050)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(offsetof(W_Loadout_InformationTable_C_UpdateCurrentItemMap, ItemCategory_0) == 0x000000, "Member 'W_Loadout_InformationTable_C_UpdateCurrentItemMap::ItemCategory_0' has a wrong offset!");
...
{
public:
	class UW_Loadout_Overview_C*                  CallFunc_Create_ReturnValue;                       // 0x0000(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

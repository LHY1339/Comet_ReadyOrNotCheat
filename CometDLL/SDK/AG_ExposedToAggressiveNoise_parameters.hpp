...
static_assert(sizeof(AG_ExposedToAggressiveNoise_C_CanOpen) == 0x000040, "Wrong size on AG_ExposedToAggressiveNoise_C_CanOpen");
...
static_assert(offsetof(AG_ExposedToAggressiveNoise_C_CanOpen, CallFunc_HasBeenExposedToAggressiveNoise_MaxDistance_ImplicitCast) == 0x00002C, "Member 'AG_ExposedToAggressiveNoise_C_CanOpen::CallFunc_HasBeenExposedToAggressiveNoise_MaxDistance_ImplicitCast' has a wrong offset!");
static_assert(offsetof(AG_ExposedToAggressiveNoise_C_CanOpen, CallFunc_HasBeenExposedToAggressiveNoise_SinceSeconds_ImplicitCast) == 0x000030, "Member 'AG_ExposedToAggressiveNoise_C_CanOpen::CallFunc_HasBeenExposedToAggressiveNoise_SinceSeconds_ImplicitCast' has a wrong offset!");
static_assert(offsetof(AG_ExposedToAggressiveNoise_C_CanOpen, CallFunc_HasBeenExposedToAggressiveNoise_Tag_MaxDistance_ImplicitCast) == 0x000034, "Member 'AG_ExposedToAggressiveNoise_C_CanOpen::CallFunc_HasBeenExposedToAggressiveNoise_Tag_MaxDistance_ImplicitCast' has a wrong offset!");
static_assert(offsetof(AG_ExposedToAggressiveNoise_C_CanOpen, CallFunc_HasBeenExposedToAggressiveNoise_Tag_SinceSeconds_ImplicitCast) == 0x000038, "Member 'AG_ExposedToAggressiveNoise_C_CanOpen::CallFunc_HasBeenExposedToAggressiveNoise_Tag_SinceSeconds_ImplicitCast' has a wrong offset!");

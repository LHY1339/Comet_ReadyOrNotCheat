...
public:
	...
	class UCommonInputSubsystem*                  CallFunc_GetLocalPlayerSubsystem_ReturnValue_3;    // 0x0038(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              CallFunc_GetCurrentInputType_ReturnValue_2;        // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              CallFunc_GetCurrentInputType_ReturnValue_3;        // 0x0041(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCommonInputSubsystem*                  CallFunc_GetLocalPlayerSubsystem_ReturnValue_4;    // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              CallFunc_GetCurrentInputType_ReturnValue_4;        // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess_4;                    // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_52[0x6];                                       // 0x0052(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                K2Node_CustomEvent_Loaded;                         // 0x0058(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	ERosterCharacterState                         Temp_byte_Variable;                                // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class URosterCharacter*                       K2Node_CustomEvent_Character;                      // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              Temp_byte_Variable_2;                              // 0x0253(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ERosterCharacterState                         Temp_byte_Variable_5;                              // 0x02B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsPressed_ReturnValue;                    // 0x02BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsPressed_ReturnValue_1;                  // 0x02BD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_WidgetOrChildHasFocus_HasFocus;           // 0x02BE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanAND_ReturnValue_1;                 // 0x02BF(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_NearlyEqual_FloatFloat_B_ImplicitCast;    // 0x02D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard) == 0x0002E0, "Wrong size on W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard");
...
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetLocalPlayerSubsystem_ReturnValue) == 0x000018, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetLocalPlayerSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetLocalPlayerSubsystem_ReturnValue_1) == 0x000020, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetLocalPlayerSubsystem_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetCurrentInputType_ReturnValue) == 0x000028, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetCurrentInputType_ReturnValue_1) == 0x000029, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetCurrentInputType_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_SwitchEnum_CmpSuccess) == 0x00002A, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_SwitchEnum_CmpSuccess_1) == 0x00002B, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_SwitchEnum_CmpSuccess_1' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetLocalPlayerSubsystem_ReturnValue_2) == 0x000030, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetLocalPlayerSubsystem_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetLocalPlayerSubsystem_ReturnValue_3) == 0x000038, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetLocalPlayerSubsystem_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetCurrentInputType_ReturnValue_2) == 0x000040, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetCurrentInputType_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetCurrentInputType_ReturnValue_3) == 0x000041, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetCurrentInputType_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_SwitchEnum_CmpSuccess_2) == 0x000042, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_SwitchEnum_CmpSuccess_2' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_SwitchEnum_CmpSuccess_3) == 0x000043, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_SwitchEnum_CmpSuccess_3' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetLocalPlayerSubsystem_ReturnValue_4) == 0x000048, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetLocalPlayerSubsystem_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_GetCurrentInputType_ReturnValue_4) == 0x000050, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_GetCurrentInputType_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_SwitchEnum_CmpSuccess_4) == 0x000051, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_SwitchEnum_CmpSuccess_4' has a wrong offset!");
...
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, Temp_byte_Variable) == 0x000060, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_CustomEvent_Character) == 0x000068, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_CustomEvent_Character' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, Temp_byte_Variable_1) == 0x000070, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_CustomEvent_Text) == 0x000078, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_CustomEvent_Text' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_Select_Default) == 0x000090, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_IsValid_ReturnValue) == 0x0000A4, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x0000A5, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, Temp_byte_Variable_2) == 0x000253, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_IsValid_ReturnValue_1) == 0x000254, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, Temp_byte_Variable_5) == 0x0002B9, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::Temp_byte_Variable_5' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_IsPressed_ReturnValue) == 0x0002BA, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_IsPressed_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, K2Node_Select_Default_1) == 0x0002BC, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_IsPressed_ReturnValue_1) == 0x0002BD, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_IsPressed_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_WidgetOrChildHasFocus_HasFocus) == 0x0002BE, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_WidgetOrChildHasFocus_HasFocus' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_BooleanAND_ReturnValue_1) == 0x0002BF, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_Greater_DoubleDouble_B_ImplicitCast) == 0x0002C0, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_Greater_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_Greater_DoubleDouble_A_ImplicitCast) == 0x0002C8, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_Greater_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_NearlyEqual_FloatFloat_B_ImplicitCast) == 0x0002D0, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_NearlyEqual_FloatFloat_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard, CallFunc_NearlyEqual_FloatFloat_A_ImplicitCast) == 0x0002D8, "Member 'W_RosterSelection_MiniCard_C_ExecuteUbergraph_W_RosterSelection_MiniCard::CallFunc_NearlyEqual_FloatFloat_A_ImplicitCast' has a wrong offset!");

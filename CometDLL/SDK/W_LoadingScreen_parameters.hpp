...
static_assert(offsetof(W_LoadingScreen_C_ExecuteUbergraph_W_LoadingScreen, CallFunc_IsConsole_ReturnValue) == 0x000004, "Member 'W_LoadingScreen_C_ExecuteUbergraph_W_LoadingScreen::CallFunc_IsConsole_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(W_LoadingScreen_C_GetLoadingProgressText) == 0x000070, "Wrong size on W_LoadingScreen_C_GetLoadingProgressText");
...
static_assert(offsetof(W_LoadingScreen_C_GetLoadingProgressText, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000020, "Member 'W_LoadingScreen_C_GetLoadingProgressText::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_LoadingScreen_C_GetLoadingProgressText, CallFunc_FCeil_ReturnValue) == 0x000028, "Member 'W_LoadingScreen_C_GetLoadingProgressText::CallFunc_FCeil_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_LoadingScreen_C_GetLoadingProgressText, CallFunc_Conv_IntToString_ReturnValue) == 0x000030, "Member 'W_LoadingScreen_C_GetLoadingProgressText::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_LoadingScreen_C_GetLoadingProgressText, CallFunc_Concat_StrStr_ReturnValue) == 0x000040, "Member 'W_LoadingScreen_C_GetLoadingProgressText::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_LoadingScreen_C_GetLoadingProgressText, CallFunc_Conv_StringToText_ReturnValue) == 0x000050, "Member 'W_LoadingScreen_C_GetLoadingProgressText::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_LoadingScreen_C_GetLoadingProgressText, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000068, "Member 'W_LoadingScreen_C_GetLoadingProgressText::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(W_LoadingScreen_C_UpdateHeaderText, CallFunc_MakeLiteralText_ReturnValue) == 0x000000, "Member 'W_LoadingScreen_C_UpdateHeaderText::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_LoadingScreen_C_UpdateHeaderText, CallFunc_Conv_StringToText_ReturnValue) == 0x000018, "Member 'W_LoadingScreen_C_UpdateHeaderText::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
